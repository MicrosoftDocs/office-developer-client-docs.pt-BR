...
ms.locfileid: "28706217"
---
# <a name="move-method-example-vb"></a><span data-ttu-id="9f351-102">Exemplo do método Move (VB)</span><span class="sxs-lookup"><span data-stu-id="9f351-102">Move method example (VB)</span></span>


<span data-ttu-id="9f351-103">**Aplica-se a**: Access 2013, o Office 2013</span><span class="sxs-lookup"><span data-stu-id="9f351-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="9f351-104">Este exemplo usa o método [Move](move-method-ado.md) para posicionar o ponteiro do registro com base na entrada do usuário.</span><span class="sxs-lookup"><span data-stu-id="9f351-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>
