...
ms.locfileid: "32288852"
---
# <a name="move-method-example-vb"></a><span data-ttu-id="6d269-102">Exemplo do método Move (VB)</span><span class="sxs-lookup"><span data-stu-id="6d269-102">Move method example (VB)</span></span>


<span data-ttu-id="6d269-103">**Aplica-se ao:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="6d269-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="6d269-104">Este exemplo usa o método [Move](move-method-ado.md) para posicionar o ponteiro do registro com base na entrada do usuário.</span><span class="sxs-lookup"><span data-stu-id="6d269-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>
