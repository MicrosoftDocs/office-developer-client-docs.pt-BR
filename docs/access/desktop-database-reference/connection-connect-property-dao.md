...
Você pode definir a **propriedade Connect** para um **objeto Database** fornecendo um argumento de origem para o **método OpenDatabase.** Você pode verificar a configuração para determinar o tipo, o caminho, a identificação do usuário, a senha ou a fonte de dados ODBC do banco de dados.
