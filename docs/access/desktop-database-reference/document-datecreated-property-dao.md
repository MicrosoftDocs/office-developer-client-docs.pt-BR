...
---
# <a name="documentdatecreated-property-dao"></a>Propriedade Document. DateCreated (DAO)


**Aplica-se ao:** Access 2013, Office 2013

Retorna a data e a hora que um objeto foi criado. **Variant** somente leitura.
