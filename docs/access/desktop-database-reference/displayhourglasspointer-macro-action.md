...
Normalmente você usa esta ação se desativou o eco usando a ação **Eco**. Quando o eco está desligado, o Access suspende as atualizações de tela até que a macro seja concluída.
