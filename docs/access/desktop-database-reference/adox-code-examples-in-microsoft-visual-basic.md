...
- [Método Append de chaves, tipo de chave, exemplo das propriedades RelatedColumn, RELATEDTABLE e UpdateRule (VB)](keys-append-method-key-type-relatedcolumn-relatedtable-and-updaterule-properties-example-vb.md)
...
- [Exemplo da propriedade Name, dos métodos Append de colunas e tabelas (VB)](columns-and-tables-append-methods-name-property-example-vb.md)
...
- [Propriedade tipo de tabela, exemplo do método Close de conexão (VB)](connection-close-method-table-type-property-example-vb.md)
