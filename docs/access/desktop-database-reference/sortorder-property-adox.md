---
title: Propriedade SortOrder (ADOX)
...
Esta propriedade se aplica somente aos objetos [Column](column-object-adox.md) da coleção [Columns](columns-collection-adox.md) de um [Index](index-object-adox.md).
