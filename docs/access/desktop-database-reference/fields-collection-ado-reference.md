...
---
# <a name="fields-collection-ado-reference"></a>Referência a campos coleção (ADO)

**Aplica-se a**: Access 2013, o Office 2013

- [Coleção Fields (ADO)](fields-collection-ado.md)
- [Eventos, métodos e propriedades de conjunto de campos](fields-collection-properties-methods-and-events.md)
