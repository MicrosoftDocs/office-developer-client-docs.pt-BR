...
=== título: ActiveConnection, CommandText, CommandTimeout exemplo das propriedades (JScript) TOCTitle: ms:assetid example(JScript) de propriedades ActiveConnection, CommandText, CommandTimeout, CommandType, tamanho e direção: 2a79222c-4dba-9C5A-fff7-c8dd2711801f ms:mtpsurl: https://msdn.microsoft.com/library/JJ249056(v=office.15) ms:contentKeyID: ms.date 48543909: 10/17/2018 mtps_version: v=office.15
---

# <a name="activeconnection-commandtext-commandtimeout-commandtype-size-and-direction-properties-example-jscript"></a>Exemplo das propriedades ActiveConnection, CommandText, CommandTimeout, CommandType, tamanho e Direction (JScript)
>>>>>>> mestre
