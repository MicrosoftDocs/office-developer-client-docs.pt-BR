...
|*SkipRows* |Opcional. Um valor **Long** , cujo valor padrão é zero, que especifica o deslocamento de linha a partir da linha atual ou bookmark *Iniciar* para iniciar a pesquisa. Por padrão, a pesquisa iniciará na linha atual.|
