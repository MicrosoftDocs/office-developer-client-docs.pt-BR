...
---
# <a name="table-object-adox-reference"></a>Referência de objeto (ADOX) da tabela
...
**Aplica-se a**: Access 2013, o Office 2013
  ...
  - [Tabela propriedades, métodos e eventos (ADOX)](table-properties-methods-and-events-adox.md)
