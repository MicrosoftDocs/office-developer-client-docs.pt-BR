---
<<<<<<< Título cabeça: Converter tabelas do Microsoft Access, formulários e relatórios TOCTitle: Converter tabelas do Microsoft Access, formulários e relatórios ms:assetid: cc170e62-a663-60e8-4446-07a7a874b747 ms:mtpsurl: https://msdn.microsoft.com/library/Ff834413(v=office.15) ms:contentKeyID: ms.date 48547731: 18/09/2015 === título: converter o Microsoft Access tabelas, formulários e relatórios TOCTitle: converter o Microsoft Access tabelas, formulários e relatórios Descrição: alterações introduzidas pelo Microsoft Access 2002 podem afetar o comportamento da sua versão 1. x ou 2.0 aplicativos.
...
Para tornar a funcionalidade adicional disponível para você durante a ativação de objetos OLE in-loco, alguns comandos de menu podem ter sido movidos para um menu que não é substituído quando você ativa um servidor OLE.
...
<<<<<<< Cabeça
## <a name="cant-use-the-format-property-to-distinguish-null-values-and-zero-length-strings"></a>Não é possível utilizar a propriedade Format para distinguir valores nulos e sequências de comprimento zero
...
<a name="iifisnullmycontrol-null-formatmycontrol-zls"></a>\=SeImed (ÉNulo (\[MeuControle\]), "Nulo", formato (\[MeuControle\], "@; SCZ"))
=======
