...
---
# <a name="indexes-collection-adox-reference"></a>Referência sobre a coleção Indexes (ADOX)

**Aplica-se ao:** Access 2013, Office 2013

- [Coleção Indexes (ADOX)](indexes-collection-adox.md)
- [Propriedades, métodos e eventos da coleção Indexes (ADOX)](indexes-collection-properties-methods-and-events-adox.md)
