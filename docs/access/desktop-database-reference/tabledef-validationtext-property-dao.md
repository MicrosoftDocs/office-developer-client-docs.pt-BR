...
ms.locfileid: "25461970"
---
# <a name="tabledefvalidationtext-property-dao"></a>Propriedade TableDef.ValidationText (DAO)
...
Para um objeto **[TableDef](tabledef-object-dao.md)**, essa definição de propriedade é somente leitura para uma tabela vinculada e somente leitura para uma tabela base.
