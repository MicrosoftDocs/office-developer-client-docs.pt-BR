...
---
# <a name="dimension-object-ado-md-reference"></a>Objeto Dimension (referência do ADO MD)

**Aplica-se ao:** Access 2013, Office 2013

- [Objeto Dimension (ADO MD)](dimension-object-ado-md.md)
- [Propriedades, métodos e eventos de dimensão (ADO MD)](dimension-properties-methods-and-events-ado-md.md)
