...
---
# <a name="command-properties-methods-and-events-ado"></a>Command propriedades, métodos e eventos (ADO)
...
- [Propriedade CommandText](commandtext-property-ado.md)
- [Propriedade CommandTimeout](commandtimeout-property-ado.md)
- [Propriedade CommandType](commandtype-property-ado.md)
- [Propriedade Name](name-property-ado.md)
- [Coleção Parameters](parameters-collection-ado.md)
- [Propriedade preparado](prepared-property-ado.md)
...
- [Método Execute (comando ADO)](https://msdn.microsoft.com/library/jj248785\(v=office.15\))
