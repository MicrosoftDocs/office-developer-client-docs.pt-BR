...
<span data-ttu-id="85af1-107">Depois que o **Recordset** for fabricado, ele pode ser preenchido, manipulado ou persistido para um arquivo.</span><span class="sxs-lookup"><span data-stu-id="85af1-107">After the **Recordset** has been fabricated, it can be populated, manipulated, or persisted to a file.</span></span>
