...
---
# <a name="attributes-and-name-properties-example-vj"></a><span data-ttu-id="2fafc-102">Exemplo das propriedades Attributes e Name (VJ++)</span><span class="sxs-lookup"><span data-stu-id="2fafc-102">Attributes and Name properties example (VJ++)</span></span>


<span data-ttu-id="2fafc-103">**Aplica-se ao:** Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="2fafc-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="2fafc-p101">Este exemplo exibe o valor da propriedade [Attributes](attributes-property-ado.md) para os objetos [Connection](connection-object-ado.md), [Field](field-object-ado.md) e [Property](property-object-ado.md). Ele usa a propriedade [Name](name-property-ado.md) para exibir o nome de cada objeto **Field** e **Property**.</span><span class="sxs-lookup"><span data-stu-id="2fafc-p101">This example displays the value of the [Attributes](attributes-property-ado.md) property for [Connection](connection-object-ado.md), [Field](field-object-ado.md), and [Property](property-object-ado.md) objects. It uses the [Name](name-property-ado.md) property to display the name of each **Field** and **Property** object.</span></span>
