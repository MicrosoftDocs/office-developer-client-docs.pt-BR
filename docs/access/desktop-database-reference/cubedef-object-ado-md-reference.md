...
---
# <a name="cubedef-object-ado-md-reference"></a>Objeto CubeDef (ADO MD referência)
...
**Aplica-se a**: Access 2013 | Office 2013
  ...
  - [CubeDef propriedades, métodos e eventos (ADO MD)](cubedef-properties-methods-and-events-ado-md.md)
