...
---
# <a name="begintranscomplete-committranscomplete-and-rollbacktranscomplete-events-ado"></a>Eventos eventos begintranscomplete, CommitTransComplete e RollbackTransComplete (ADO)
...
Eventos begintranscomplete*TransactionLevel*, *perror*, *adStatus*, *pConnection*
...
|*pError* |Um objeto [Error](error-object-ado.md). Descreve o erro que ocorreu se o valor de EventStatusEnum for **adStatusErrorsOccurred**; caso contrário, ele não será definido.|
