...
ms.locfileid: "28702135"
---
# <a name="user-object-adox-reference"></a>Referência de objeto (ADOX) do usuário

**Aplica-se a**: Access 2013, o Office 2013

- [Objeto User (ADOX)](user-object-adox.md)
- [Usuário propriedades, métodos e eventos (ADOX)](user-properties-methods-and-events-adox.md)
