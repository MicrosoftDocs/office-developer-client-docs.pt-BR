...
- [Etapa 1: Especificar um programa de servidor](step-1-specify-a-server-program-rds-tutorial.md)
- [Etapa 2: Chamar o programa do servidor](step-2-invoke-the-server-program-rds-tutorial.md)
- [Etapa 3: O servidor obtém um Recordset](step-3-server-obtains-a-recordset-rds-tutorial.md)
- [Etapa 4: Servidor retorna o Recordset](step-4-server-returns-the-recordset-rds-tutorial.md)
- [Etapa 5: DataControl torna-se disponível](step-5-datacontrol-is-made-usable-rds-tutorial.md)
- [Etapa 6: As alterações são enviadas ao servidor](step-6-changes-are-sent-to-the-server-rds-tutorial.md)
- [Tutorial do RDS (VBScript)](rds-tutorial-vbscript.md)
- [Tutorial do RDS (Visual J++)](rds-tutorial-visual-j.md)