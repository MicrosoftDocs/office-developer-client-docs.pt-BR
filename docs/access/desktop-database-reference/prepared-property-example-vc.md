...
ms.locfileid: "28718963"
---
# <a name="prepared-property-example-vc"></a><span data-ttu-id="b1cdf-102">Exemplo da propriedade Prepared (VC++)</span><span class="sxs-lookup"><span data-stu-id="b1cdf-102">Prepared property example (VC++)</span></span>


<span data-ttu-id="b1cdf-103">**Aplica-se a**: Access 2013, o Office 2013</span><span class="sxs-lookup"><span data-stu-id="b1cdf-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="b1cdf-104">Este exemplo demonstra a propriedade [Prepared](prepared-property-ado.md) ao abrir dois objetos [Command](command-object-ado.md)  um preparado e um não preparado.</span><span class="sxs-lookup"><span data-stu-id="b1cdf-104">This example demonstrates the [Prepared](prepared-property-ado.md) property by opening two [Command](command-object-ado.md) objects — one prepared and one not prepared.</span></span>
