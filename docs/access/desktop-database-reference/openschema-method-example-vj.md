...
ms.locfileid: "25462870"
---
# <a name="openschema-method-example-vj"></a><span data-ttu-id="d57ca-102">Exemplo do Método OpenSchema (VJ++)</span><span class="sxs-lookup"><span data-stu-id="d57ca-102">OpenSchema Method Example (VJ++)</span></span>


<span data-ttu-id="d57ca-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="d57ca-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="d57ca-104">Este exemplo utiliza o método [OpenSchema](openschema-method-ado.md) para exibir o nome e o tipo de cada tabela no banco de dados ***Pubs***.</span><span class="sxs-lookup"><span data-stu-id="d57ca-104">This example uses the [OpenSchema](openschema-method-ado.md) method to display the name and type of each table in the ***Pubs*** database.</span></span>
