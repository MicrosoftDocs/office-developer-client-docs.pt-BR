...
---
# <a name="absolutepage-pagecount-and-pagesize-properties-example-jscript"></a><span data-ttu-id="e1150-102">Exemplo das propriedades AbsolutePage, PageCount e PageSize (JScript)</span><span class="sxs-lookup"><span data-stu-id="e1150-102">AbsolutePage, PageCount, and PageSize Properties Example (JScript)</span></span>

<span data-ttu-id="e1150-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="e1150-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="e1150-104">Este exemplo demonstra as propriedades AbsolutePage, PageCount e PageSize.</span><span class="sxs-lookup"><span data-stu-id="e1150-104">This example demonstrates the AbsolutePage, PageCount, and PageSize properties.</span></span> <span data-ttu-id="e1150-105">Recorte e cole o código a seguir no Bloco de Notas ou em outro editor de textos e salve-o como **AbsolutePageJS.asp**.</span><span class="sxs-lookup"><span data-stu-id="e1150-105">Cut and paste the following code to Notepad or another text editor, and save it as **AbsolutePageJS.asp**.</span></span>
