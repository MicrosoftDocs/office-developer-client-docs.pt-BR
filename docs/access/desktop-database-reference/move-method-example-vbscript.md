...
ms.locfileid: "25881998"
---
# <a name="move-method-example-vbscript"></a><span data-ttu-id="d2e43-102">Exemplo do método Move (VBScript)</span><span class="sxs-lookup"><span data-stu-id="d2e43-102">Move method example (VBScript)</span></span>


<span data-ttu-id="d2e43-103">**Aplica-se a**: Access 2013, o Office 2013</span><span class="sxs-lookup"><span data-stu-id="d2e43-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="d2e43-104">Este exemplo utiliza o método [Move](move-method-ado.md) para posicionar o ponteiro do registro, com base na entrada do usuário.</span><span class="sxs-lookup"><span data-stu-id="d2e43-104">This example uses the [Move](move-method-ado.md) method to position the record pointer, based on user input.</span></span>

<span data-ttu-id="d2e43-105">Utilize o exemplo a seguir em um Active Server Page (ASP).</span><span class="sxs-lookup"><span data-stu-id="d2e43-105">Use the following example in an Active Server Page (ASP).</span></span>

<span data-ttu-id="d2e43-p101">Utilize **Find** para localizar o arquivo Adovbs.inc e coloque-o no diretório que planeja utilizar. Recorte e cole o código a seguir no Bloco de Notas ou em outro editor de texto e salve-o como **MoveVBS.asp**. É possível ver o resultado em qualquer navegador.</span><span class="sxs-lookup"><span data-stu-id="d2e43-p101">Use **Find** to locate the file Adovbs.inc and place it in the directory you plan to use. Cut and paste the following code to Notepad or another text editor, and save it as **MoveVBS.asp**. You can view the result in any browser.</span></span>

<span data-ttu-id="d2e43-109">Tente digitar uma letra ou um não-inteiro para ver o tratamento de erros funcionar.</span><span class="sxs-lookup"><span data-stu-id="d2e43-109">Try entering a letter or noninteger to see the error handling work.</span></span>
