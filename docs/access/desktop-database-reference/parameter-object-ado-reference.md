...
---
# <a name="parameter-object-ado-reference"></a>Referência do objeto Parameter (ADO)

**Aplica-se ao:** Access 2013, Office 2013

- [Objeto Parameter (ADO)](parameter-object-ado.md)
- [Propriedades, métodos e eventos de parâmetro (ADO)](parameter-properties-methods-and-events-ado.md)
