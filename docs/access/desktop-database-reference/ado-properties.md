...
<td><p>Indica em qual página reside o registro atual.</p></td>
</tr>
<tr class="even">
<td><p><a href="absoluteposition-property-ado.md">AbsolutePosition</a></p></td>
<td><p>Indica a posição original de um registro atual do objeto <strong>Recordset</strong>.</p></td>
</tr>
<tr class="odd">
...
<td><p>Indica a qual objeto <strong>Connection</strong>, o objeto <strong>Command</strong>, <strong>Recordset</strong> ou <strong>Record</strong> especificado pertence atualmente.</p></td>
</tr>
<tr class="odd">
<td><p><a href="actualsize-property-ado.md">ActualSize</a></p></td>
<td><p>Indica o tamanho real de um valor de campo.</p></td>
</tr>
<tr class="even">
...
<td><p><strong>BOF</strong> — indica que a posição de registro atual é anterior a do primeiro registro em um objeto <strong>Recordset</strong>. <strong>EOF</strong> — indica que a posição atual do registro é posterior a do último registro em um objeto <strong>Recordset</strong>.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica o quanto esperar pela execução de um comando antes de abortar a tentativa e gerar um erro.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica as informações utilizadas para estabelecer uma conexão com uma fonte de dados.</p></td>
</tr>
<tr class="even">
<td><p><a href="connectiontimeout-property-ado.md">ConnectionTimeout</a></p></td>
<td><p>Indica o quanto esperar pelo estabelecimento de uma conexão antes de abortar a tentativa e gerar um erro.</p></td>
</tr>
<tr class="odd">
...
<td><p>Indica o nome do membro de dados que será recuperado de um objeto referido pela propriedade <strong>DataSource</strong>.</p></td>
</tr>
<tr class="odd">
...
<td><p>Indica o banco de dados padrão de um objeto <strong>Connection</strong>.</p></td>
</tr>
<tr class="odd">
...
<td><p>Indica o arquivo de ajuda e o tópico associado a um objeto <strong>Error</strong>. <strong>HelpContextID</strong> — retorna uma ID de contexto, como um valor <strong>Long</strong>, para um tópico em um arquivo de Ajuda. <strong>HelpFile</strong> — retorna um valor <strong>String</strong> avaliado para um caminho completamente solucionado de um arquivo de Ajuda.</p></td>
</tr>
<tr class="even">
<td><p><a href="index-property-ado.md">Índice</a></p></td>
<td><p>Indica o nome do índice atualmente em vigor para um objeto <strong>Recordset</strong>.</p></td>
</tr>
<tr class="odd">
...
<td><p>Indica o caractere binário a ser utilizado como um separador de linha nos objetos <strong>Stream</strong> de texto.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica quais registros devem ser empacotados de volta para o servidor.</p></td>
</tr>
<tr class="even">
<td><p><a href="maxrecords-property-ado.md">MaxRecords</a></p></td>
<td><p>Indica o número máximo de registros a serem retornados para um <strong>Recordset</strong> a partir de uma consulta.</p></td>
</tr>
<tr class="odd">
<td><p><a href="mode-property-ado.md">Mode</a></p></td>
<td><p>Indica as permissões disponíveis para modificar dados em um objeto <strong>Connection</strong>, <strong>Record</strong> ou <strong>Stream</strong>.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica o número que identifica de forma exclusiva um objeto <strong>Error</strong>.</p></td>
</tr>
<tr class="odd">
...
<td><p>Indica o valor de um <strong>Field</strong> existente no registro antes das alterações.</p></td>
</tr>
<tr class="odd">
<td><p><a href="pagecount-property-ado.md">PageCount</a></p></td>
<td><p>Indica quantas páginas de dados contém o objeto <strong>Recordset</strong>.</p></td>
</tr>
<tr class="even">
<td><p><a href="pagesize-property-ado.md">PageSize</a></p></td>
<td><p>Indica quantos registros constituem uma página no <strong>Recordset</strong>.</p></td>
</tr>
<tr class="odd">
<td><p><a href="parentrow-property-ado.md">ParentRow</a></p></td>
<td><p>Define o contêiner de um objeto <strong>Row</strong> do OLE DB em um objeto <strong>ADORecordConstruction</strong>, de forma que o pai da linha torna-se um objeto <strong>Record</strong> do ADO.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica a posição atual dentro de um objeto <strong>Stream</strong>.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica o tipo do objeto <strong>Record</strong>.</p></td>
</tr>
<tr class="odd">
...
<td><p>Indica um ou mais nomes de campo onde o <strong>Recordset</strong> é classificado e se cada campo é classificado na ordem crescente ou decrescente.</p></td>
</tr>
<tr class="odd">
<td><p><a href="source-property-ado-error.md">Source (ADO Error)</a></p></td>
<td><p>Indica o nome do objeto ou aplicativo que originalmente gerou o erro.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica o estado SQL de um determinado objeto <strong>Error</strong>.</p></td>
</tr>
<tr class="odd">
<td><p><a href="state-property-ado.md">State</a></p></td>
<td><p>Indica para todos os objetos aplicáveis se o estado do objeto é aberto ou fechado. Indica para todos os objetos aplicáveis que estiverem executando um método assíncrono, se o estado atual do objeto é conectando-se, executando ou recuperando.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica o status do registro atual com relação à atualização em lotes ou outras operações em massa.</p></td>
</tr>
<tr class="even">
...
<td><p>Indica o tipo de dados contidos no <strong>Stream</strong> (binário ou texto).</p></td>
</tr>
<tr class="odd">
<td><p><a href="underlyingvalue-property-ado.md">UnderlyingValue</a></p></td>
<td><p>Indica o valor atual do objeto <strong>Field</strong> no banco de dados.</p></td>
</tr>
<tr class="even">
