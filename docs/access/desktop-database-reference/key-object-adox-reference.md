...
---
# <a name="key-object-adox-reference"></a>Referência de objeto Key (ADOX)
...
**Aplica-se a**: Access 2013 | Office 2013
  ...
  - [Principais propriedades, métodos e eventos (ADOX)](key-properties-methods-and-events-adox.md)
