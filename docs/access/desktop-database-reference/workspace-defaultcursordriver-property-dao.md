...
*expressão* . DefaultCursorDriver

*expressão* Uma variável que representa um objeto **Workspace** .

## <a name="remarks"></a>Comentários

A configuração ou o valor de retorno pode ser definido como uma das constantes **[CursorDriverEnum](cursordriverenum-enumeration-dao.md)**.

Essa configuração de propriedade afeta somente as conexões estabelecidas após a definição da propriedade. Alterar a propriedade **DefaultCursorDriver** não afeta as conexões existentes.
