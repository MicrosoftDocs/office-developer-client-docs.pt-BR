...
---
# <a name="updating-data-ado"></a>Atualizando dados (ADO)
...
**Aplica-se a**: Access 2013 | Office 2013
  ...
  - [Atualizando os dados](updating-data.md)

  - [Modo imediato](immediate-mode.md)

  - [Processamento de transação](transaction-processing.md)

  - [Modo de lotes (ADO)](batch-mode-ado.md)
