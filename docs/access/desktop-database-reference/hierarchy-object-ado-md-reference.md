...
---
# <a name="hierarchy-object-ado-md-reference"></a>Objeto Hierarchy (referência ADO MD)

**Aplica-se a**: Access 2013, o Office 2013

- [Objeto Hierarchy (ADO MD)](hierarchy-object-ado-md.md)
- [Hierarquia propriedades, métodos e eventos (ADO MD)](hierarchy-properties-methods-and-events-ado-md.md)
