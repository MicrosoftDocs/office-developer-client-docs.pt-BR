...
---
# <a name="move-method-example-vc"></a><span data-ttu-id="0b379-102">Exemplo do método Move (VC++)</span><span class="sxs-lookup"><span data-stu-id="0b379-102">Move method example (VC++)</span></span>

<span data-ttu-id="0b379-103">**Aplica-se a**: Access 2013, o Office 2013</span><span class="sxs-lookup"><span data-stu-id="0b379-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="0b379-104">Este exemplo utiliza o método [Move](move-method-ado.md) para posicionar o ponteiro do registro, com base na entrada do usuário.</span><span class="sxs-lookup"><span data-stu-id="0b379-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>
...
<span data-ttu-id="0b379-105">**MoveX.h**</span><span class="sxs-lookup"><span data-stu-id="0b379-105">**MoveX.h**</span></span>
