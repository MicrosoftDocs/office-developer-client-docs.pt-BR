...
ms.locfileid: "25463480"
---
# <a name="fieldsrefresh-method-dao"></a><span data-ttu-id="a7a4e-102">Método Fields.Refresh (DAO)</span><span class="sxs-lookup"><span data-stu-id="a7a4e-102">Fields.Refresh Method (DAO)</span></span>
...
<span data-ttu-id="a7a4e-104">Atualiza os objetos na coleção especificada para refletir o esquema atual do banco de dados.</span><span class="sxs-lookup"><span data-stu-id="a7a4e-104">Updates the objects in the specified colletion to reflect the database's current schema.</span></span>

## <a name="syntax"></a><span data-ttu-id="a7a4e-105">Sintaxe</span><span class="sxs-lookup"><span data-stu-id="a7a4e-105">Syntax</span></span>

<span data-ttu-id="a7a4e-106">*expressão* . Atualizar</span><span class="sxs-lookup"><span data-stu-id="a7a4e-106">*expression* .Refresh</span></span>

<span data-ttu-id="a7a4e-107">*expressão* Uma variável que representa um objeto **Fields** .</span><span class="sxs-lookup"><span data-stu-id="a7a4e-107">*expression* A variable that represents a **Fields** object.</span></span>
