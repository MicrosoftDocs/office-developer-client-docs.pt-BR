...
ms.locfileid: "25462487"
---
# <a name="status-property-example-vc"></a><span data-ttu-id="5d950-102">Exemplo da propriedade Status(VC++)</span><span class="sxs-lookup"><span data-stu-id="5d950-102">Status Property Example (VC++)</span></span>


<span data-ttu-id="5d950-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="5d950-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="5d950-104">Este exemplo utiliza a propriedade [Status](status-property-ado-recordset.md) para exibir quais registros foram modificados em uma operação em lote antes da ocorrência de uma atualização em lote.</span><span class="sxs-lookup"><span data-stu-id="5d950-104">This example uses the [Status](status-property-ado-recordset.md) property to display which records have been modified in a batch operation before a batch update has occurred.</span></span>
...
<span data-ttu-id="5d950-105">**StatusX.h**</span><span class="sxs-lookup"><span data-stu-id="5d950-105">**StatusX.h**</span></span>
