...
Cria uma consulta de exclusão que remove os registros de uma ou mais tabelas listadas na cláusula [FROM](https://msdn.microsoft.com/library/ff836674\(v=office.15\)) que atenda à cláusula [WHERE](https://msdn.microsoft.com/library/ff195245\(v=office.15\)).
