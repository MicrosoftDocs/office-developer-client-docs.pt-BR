...
<td><p>Vincula uma consulta de dados do <strong>Recordset</strong> a um ou vários controles (por exemplo, uma caixa de texto, um controle de grade ou uma caixa de combinação) para exibir os dados do <strong>Recordset</strong> em uma página da Web.</p></td>
</tr>
<tr class="even">
