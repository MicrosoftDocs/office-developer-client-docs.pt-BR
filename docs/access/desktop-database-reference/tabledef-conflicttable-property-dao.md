...
Todas as tabelas conflitantes são nomeadas conflito de tabela, onde tabela é o nome original da tabela, truncada para o \_ comprimento máximo do nome da tabela.
