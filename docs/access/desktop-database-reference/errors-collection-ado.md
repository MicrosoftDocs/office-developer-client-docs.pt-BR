...
> [!NOTE]
> <P>[!OBSERVAçãO] Consulte o tópico do objeto <STRONG>Error</STRONG> para obter uma explicação mais detalhada sobre como uma operação do ADO simples pode gerar erros múltiplos.</P>
