...
ms.locfileid: "25861376"
---
# <a name="dbenginecommittrans-method-dao"></a><span data-ttu-id="3de88-102">Método DBEngine.CommitTrans (DAO)</span><span class="sxs-lookup"><span data-stu-id="3de88-102">DBEngine.CommitTrans Method (DAO)</span></span>


<span data-ttu-id="3de88-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="3de88-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="3de88-104">Encerra a transação atual e salva as alterações.</span><span class="sxs-lookup"><span data-stu-id="3de88-104">Ends the current transaction and saves the changes.</span></span>

## <a name="syntax"></a><span data-ttu-id="3de88-105">Sintaxe</span><span class="sxs-lookup"><span data-stu-id="3de88-105">Syntax</span></span>

<span data-ttu-id="3de88-106">*expressão* . CommitTrans (***opção***)</span><span class="sxs-lookup"><span data-stu-id="3de88-106">*expression* .CommitTrans(***Option***)</span></span>

<span data-ttu-id="3de88-107">*expressão* Uma variável que representa um objeto **DBEngine** .</span><span class="sxs-lookup"><span data-stu-id="3de88-107">*expression* A variable that represents a **DBEngine** object.</span></span>

### <a name="parameters"></a><span data-ttu-id="3de88-108">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="3de88-108">Parameters</span></span>
