...
Muitos recursos do objeto **Recordset** do ADO são determinados pelo tipo e local do cursor, bem como pelo tipo de bloqueio.
...
- [Características do cursor e do bloqueio](cursor-and-lock-characteristics.md)
