...
---
# <a name="resync-method-example-vj"></a>Exemplo do método Resync (VJ++)


**Aplica-se a**: Access 2013, o Office 2013

Este exemplo demonstra a utilização do método [Resync](resync-method-ado.md) para atualizar dados em um recordset estático.
