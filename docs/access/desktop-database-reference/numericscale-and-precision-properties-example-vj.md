...
ms.locfileid: "25883215"
---
# <a name="numericscale-and-precision-properties-example-vj"></a><span data-ttu-id="3f851-102">Exemplo das propriedades NumericScale e Precision (VJ++)</span><span class="sxs-lookup"><span data-stu-id="3f851-102">NumericScale and Precision properties example (VJ++)</span></span>


<span data-ttu-id="3f851-103">**Aplica-se a**: Access 2013, o Office 2013</span><span class="sxs-lookup"><span data-stu-id="3f851-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="3f851-104">Este exemplo usa as propriedades [NumericScale](numericscale-property-ado.md) e [Precision](precision-property-ado.md) para exibir a escala numérica e a precisão de campos na tabela ***Discounts*** do banco de dados ***Pubs***.</span><span class="sxs-lookup"><span data-stu-id="3f851-104">This example uses the [NumericScale](numericscale-property-ado.md) and [Precision](precision-property-ado.md) properties to display the numeric scale and precision of fields in the ***Discounts*** table of the ***Pubs*** database.</span></span>
