...
---
# <a name="open-and-close-methods-example-vj"></a>Exemplo dos métodos Open e Close (VJ++)


**Aplica-se a**: Access 2013, o Office 2013

Este exemplo utiliza os métodos **Open** e [Close](close-method-ado.md) nos objetos [Recordset](recordset-object-ado.md) e [Connection](connection-object-ado.md) que foram abertos.
