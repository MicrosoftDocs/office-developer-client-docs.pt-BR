...
ms.locfileid: "28702695"
---
# <a name="workspacename-property-dao"></a>Propriedade Workspace.Name (DAO)
...
O comprimento máximo do nome de um objeto **Workspace** é de 20 caracteres.
