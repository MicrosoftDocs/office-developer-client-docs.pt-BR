...
Depois de usar o método **Edit**, as alterações feitas nos campos do registro atual são copiadas para o buffer de cópia. Após fazer as alterações desejadas no registro, use o método **[Update](recordset2-update-method-dao.md)** para salvar as alterações.
