...
<span data-ttu-id="9c9d9-128">Você pode usar a propriedade **Status** do **Registro** atual ou de um **Campo** específico para determinar o tipo de conflito que ocorreu.</span><span class="sxs-lookup"><span data-stu-id="9c9d9-128">You can use the **Status** property of the current **Record** or of a specific **Field** to determine what kind of a conflict has occurred.</span></span>

<span data-ttu-id="9c9d9-129">Para obter informações mais detalhadas sobre o tratamento de erros, consulte [Capítulo 6: Tratamento de erros](chapter-6-error-handling.md).</span><span class="sxs-lookup"><span data-stu-id="9c9d9-129">For more detailed information on error handling, see [Chapter 6: Error Handling](chapter-6-error-handling.md).</span></span>
