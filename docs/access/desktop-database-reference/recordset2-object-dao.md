...
Um objeto **Recordset2** contém as mesmas propriedades e os mesmo métodos que o objeto **[Recordset](recordset-object-dao.md)**. O objeto **Recordset2** contém uma nova propriedade, **[ParentRecordset](recordset2-parentrecordset-property-dao.md)**, que oferece suporte a tipos de campo de vários valores.
