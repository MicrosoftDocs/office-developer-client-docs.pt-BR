...
<<<<<<< A conta do servidor Web anônima de cabeçalho (IUSR\_*ComputerName*) devem ser adicionados para o grupo local convidados no computador do servidor Web para usar o RDS.

<a name="to-grant-guest-privileges-to-a-web-server-computer"></a>**Para conceder privilégios de convidados a um computador do servidor Web**
=======
