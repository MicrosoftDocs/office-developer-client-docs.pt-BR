...
|Campo|Descrição|
|:--------|:----------|
|*pwcsName* |Uma cadeia de caracteres que contém o nome do Stream, se houver um disponível e o valor\_StatFlag StatFlag NoName não foi especificado.|
...
Se STATFLAG\_NoName for especificado no parâmetro STATFLAG, o nome do Stream não será retornado.

Se STATFLAG\_NoName não foi especificado no parâmetro STATFLAG e não houver nenhum nome disponível para o fluxo atual, esse valor será E\_NOTIMPL.
