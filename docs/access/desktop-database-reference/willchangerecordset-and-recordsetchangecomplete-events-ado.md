...
WillChangeRecordset*adReason*, *adStatus*, ** precaboset

RecordsetChangeComplete*adReason*, *perror*, *adStatus*, ** precaboset
...
Um evento **WillChangeRecordset** ou **RecordsetChangeComplete** pode ocorrer devido aos métodos **Recordset** [](requery-method-ado.md) Requery ou [Open](open-method-ado-recordset.md) .
