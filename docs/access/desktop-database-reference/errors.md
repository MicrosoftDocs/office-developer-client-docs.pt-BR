...
Qualquer operação envolvendo os objetos ADO pode gerar um ou vários erros de provedor. À medida que cada erro ocorrer, um ou vários objetos **Error** serão colocados na coleção **Errors** do objeto **Connection**. Para obter detalhes sobre o tratamento de avisos e erros em seu aplicativo ADO, consulte o [capítulo 6: tratamento de erros](chapter-6-error-handling.md).
