...
ms.locfileid: "26026348"
---
# <a name="datacontrol-properties-methods-and-events-rds"></a>DataControl propriedades, métodos e eventos (RDS)
...
- [Propriedades Recordset, SourceRecordset (RDS)](recordset-sourcerecordset-properties-rds.md)
...
- [Propriedade SQL (RDS)](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/sql-property-ado)
...
- [Evento OnError](onerror-event-rds.md)
- [Evento OnReadyStateChange](onreadystatechange-event-rds.md)
