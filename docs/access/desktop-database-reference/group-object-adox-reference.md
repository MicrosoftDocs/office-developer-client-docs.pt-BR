...
---
# <a name="group-object-adox-reference"></a>Referência de objeto do grupo (ADOX)

**Aplica-se a**: Access 2013, o Office 2013

- [Objeto Group (ADOX)](group-object-adox.md)
- [Grupo Propriedades, métodos e eventos (ADOX)](group-properties-methods-and-events-adox.md)
