...
---
# <a name="group-object-adox-reference"></a>Referência do objeto Group (ADOX)

**Aplica-se ao:** Access 2013, Office 2013

- [Objeto Group (ADOX)](group-object-adox.md)
- [Propriedades, métodos e eventos do grupo (ADOX)](group-properties-methods-and-events-adox.md)
