...
ms.locfileid: "25462181"
---
# <a name="resync-method-example-vc"></a><span data-ttu-id="7fec9-102">Exemplo do Método Resync (VC++)</span><span class="sxs-lookup"><span data-stu-id="7fec9-102">Resync Method Example (VC++)</span></span>


<span data-ttu-id="7fec9-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="7fec9-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="7fec9-104">Este exemplo demonstra a utilização do método [Resync](resync-method-ado.md) para atualizar dados em um recordset estático.</span><span class="sxs-lookup"><span data-stu-id="7fec9-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>
