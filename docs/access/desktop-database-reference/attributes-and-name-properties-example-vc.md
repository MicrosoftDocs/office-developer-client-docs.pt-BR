...
ms.locfileid: "25465284"
---
# <a name="attributes-and-name-properties-example-vc"></a><span data-ttu-id="2fc35-102">Exemplo das propriedades Attributes e Name (VC++)</span><span class="sxs-lookup"><span data-stu-id="2fc35-102">Attributes and Name Properties Example (VC++)</span></span>


<span data-ttu-id="2fc35-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="2fc35-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="2fc35-p101">Este exemplo exibe o valor da propriedade [Attributes](attributes-property-ado.md) para os objetos [Connection](connection-object-ado.md), [Field](field-object-ado.md) e [Property](property-object-ado.md). Ele usa a propriedade [Name](name-property-ado.md) para exibir o nome de cada objeto **Field** e **Property**.</span><span class="sxs-lookup"><span data-stu-id="2fc35-p101">This example displays the value of the [Attributes](attributes-property-ado.md) property for [Connection](connection-object-ado.md), [Field](field-object-ado.md), and [Property](property-object-ado.md) objects. It uses the [Name](name-property-ado.md) property to display the name of each **Field** and **Property** object.</span></span>
...
<span data-ttu-id="2fc35-106">**AttributesX.h**</span><span class="sxs-lookup"><span data-stu-id="2fc35-106">**AttributesX.h**</span></span>
