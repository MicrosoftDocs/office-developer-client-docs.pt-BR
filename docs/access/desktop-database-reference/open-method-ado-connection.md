...
**Uso do Remote Data Service** Quando usado em um objeto **Connection** do lado do cliente, o método **Open** não estabelece uma conexão com o servidor até que um [Recordset](recordset-object-ado.md) seja aberto no **objeto Connection.**
