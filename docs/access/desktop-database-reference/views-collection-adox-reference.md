...
---
# <a name="views-collection-adox-reference"></a>Referência da coleção views (ADOX)

**Aplica-se ao:** Access 2013, Office 2013

- [Coleção views (ADOX)](views-collection-adox.md)
- [Propriedades, métodos e eventos da coleção views (ADOX)](views-collection-properties-methods-and-events-adox.md)
