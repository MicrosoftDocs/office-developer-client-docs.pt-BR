---
title: Exemplo da propriedade ActiveConnection de catálogo (VC++)
...
ms.locfileid: "25462692"
---
# <a name="catalog-activeconnection-property-example-vc"></a><span data-ttu-id="71d08-102">Exemplo da propriedade ActiveConnection de catálogo (VC++)</span><span class="sxs-lookup"><span data-stu-id="71d08-102">Catalog ActiveConnection Property Example (VC++)</span></span>


<span data-ttu-id="71d08-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="71d08-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="71d08-p101">A definição da propriedade [ActiveConnection](activeconnection-property-adox.md) para uma conexão aberta e válida "abre" o catálogo. Em um catálogo aberto, você pode acessar os objetos de esquema contidos nesse catálogo.</span><span class="sxs-lookup"><span data-stu-id="71d08-p101">Setting the [ActiveConnection](activeconnection-property-adox.md) property to a valid, open connection "opens" the catalog. From an open catalog, you can access the schema objects contained within that catalog.</span></span>
