...
---
# <a name="keys-collection-adox-reference"></a>Referência de conjunto de chaves (ADOX)

**Aplica-se ao:** Access 2013, Office 2013

- [Coleção Keys (ADOX)](keys-collection-adox.md)
- [Propriedades, métodos e eventos da coleção Keys (ADOX)](keys-collection-properties-methods-and-events-adox.md)
