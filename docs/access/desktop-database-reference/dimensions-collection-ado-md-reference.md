---
title: Coleção Dimensions (referência do ADO MD)
...
---
# <a name="dimensions-collection-ado-md-reference"></a>Coleção Dimensions (referência do ADO MD)

**Aplica-se ao:** Access 2013, Office 2013

- [Coleção Dimensions (ADO MD)](dimensions-collection-ado-md.md)
- [Propriedades, métodos e eventos da coleção Dimensions (ADO MD)](dimensions-collection-properties-methods-and-events-ado-md.md)
