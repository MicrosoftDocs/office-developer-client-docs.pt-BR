...
ms.locfileid: "25862580"
---
# <a name="addnew-method-example-vj"></a><span data-ttu-id="ce394-102">Exemplo do método AddNew (VJ++)</span><span class="sxs-lookup"><span data-stu-id="ce394-102">AddNew method example (VJ++)</span></span>


<span data-ttu-id="ce394-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="ce394-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="ce394-104">Este exemplo usa o método [AddNew](addnew-method-ado.md) para criar um novo registro com o nome especificado.</span><span class="sxs-lookup"><span data-stu-id="ce394-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
