...
---
# <a name="member-object-ado-md-reference"></a>Objeto Member (ADO MD referência)
...
**Aplica-se a**: Access 2013, o Office 2013
  ...
  - [Membro propriedades, métodos e eventos (ADO MD)](member-properties-methods-and-events-ado-md.md)
