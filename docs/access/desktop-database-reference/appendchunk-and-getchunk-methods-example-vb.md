...
ms.locfileid: "25876649"
---
# <a name="appendchunk-and-getchunk-methods-example-vb"></a><span data-ttu-id="7af1f-102">Exemplo dos métodos AppendChunk e GetChunk (VB)</span><span class="sxs-lookup"><span data-stu-id="7af1f-102">AppendChunk and GetChunk methods example (VB)</span></span>


<span data-ttu-id="7af1f-103">**Aplica-se a**: Access 2013, o Office 2013</span><span class="sxs-lookup"><span data-stu-id="7af1f-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="7af1f-104">Este exemplo usa os métodos [AppendChunk](appendchunk-method-ado.md) e [GetChunk](getchunk-method-ado.md) para preencher um campo de imagem com dados de outro registro.</span><span class="sxs-lookup"><span data-stu-id="7af1f-104">This example uses the [AppendChunk](appendchunk-method-ado.md) and [GetChunk](getchunk-method-ado.md) methods to fill an image field with data from another record.</span></span>
