...
*Tabelas*. Acrescentar*tabela*

## <a name="parameters"></a>Parâmetros

  - *Table*

  - Um valor **Variant** que contém uma referência à **Tabela** a ser anexada ou ao nome da tabela a ser criada e anexada.
