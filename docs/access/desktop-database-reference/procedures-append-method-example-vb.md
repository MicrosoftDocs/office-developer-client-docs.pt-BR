...
O código a seguir demonstra como usar um objeto [Command](command-object-ado.md) e o método [Append](procedures-collection-adox.md) da coleção [Procedures](append-method-adox-procedures.md) para criar um novo procedimento na fonte de dados subjacente.
