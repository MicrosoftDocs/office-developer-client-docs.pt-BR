...
Representa um campo de vários valores.
...
Use a propriedade **[Fields](complextype-fields-property-dao.md)** para retornar a coleção **[Fields](fields-collection-dao.md)** do objeto **ComplexType**.
