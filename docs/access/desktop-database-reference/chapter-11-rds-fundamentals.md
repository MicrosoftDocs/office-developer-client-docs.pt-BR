...
---
# <a name="chapter-11-rds-fundamentals"></a>Capítulo 11: Conceitos básicos do RDS

**Aplica-se ao:** Access 2013, Office 2013

Esta seção contém uma série de tópicos cuja leitura pode ser feita em uma determinada ordem. Os tópicos a seguir foram incluídos:

- [Soluções para o acesso remoto a dados](solutions-for-remote-data-access.md)
- [Modelo de programação básico do RDS](basic-rds-programming-model.md)
