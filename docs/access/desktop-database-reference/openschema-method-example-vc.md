...
ms.locfileid: "25462869"
---
# <a name="openschema-method-example-vc"></a><span data-ttu-id="35ff4-102">Exemplo do Método OpenSchema (VC++)</span><span class="sxs-lookup"><span data-stu-id="35ff4-102">OpenSchema Method Example (VC++)</span></span>


<span data-ttu-id="35ff4-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="35ff4-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="35ff4-104">Este exemplo utiliza o método [OpenSchema](openschema-method-ado.md) para exibir o nome e o tipo de cada tabela no banco de dados ***Pubs***.</span><span class="sxs-lookup"><span data-stu-id="35ff4-104">This example uses the [OpenSchema](openschema-method-ado.md) method to display the name and type of each table in the ***Pubs*** database.</span></span>
