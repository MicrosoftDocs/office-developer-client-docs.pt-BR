...
WillChangeRecord*adReason*, *cRecords*, *adStatus*, ** precaboset

RecordChangeComplete*adReason*, *cRecords*, *perror*, *adStatus*, ** precaboset
...
Durante o evento **WillChangeRecord** , a propriedade [Filter](filter-property-ado.md) do **Recordset** é definida como **adFilterAffectedRecords**. Você não poderá alterar essa propriedade enquanto estiver processando o evento.
