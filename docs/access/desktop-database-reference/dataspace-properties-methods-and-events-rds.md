---
title: Propriedades, métodos e eventos do DataSpace (RDS)
...
---
# <a name="dataspace-properties-methods-and-events-rds"></a>Propriedades, métodos e eventos do DataSpace (RDS)
