...
ms.locfileid: "25863973"
---
# <a name="ado-code-examples-in-microsoft-visual-c-access"></a>Exemplos de código ADO no Microsoft Visual C++ (Access)


**Aplica-se a**: Access 2013 | Office 2013

  - [Exemplos de código ADO no Microsoft Visual C++](ado-code-examples-in-microsoft-visual-c.md)

  - [Exemplo de modelo de eventos do ADO (VC + +)](ado-events-model-example-vc.md)
...
<<<<<<< HEAD
  ...
  - [Exemplo das propriedades ActiveConnection, CommandText, CommandTimeout, CommandType, Size e Direction (VC++)](activeconnection-commandtext-commandtimeout-commandtype-size-and-direction-properties-example-vc.md)

  - [ActualSize e DefinedSize exemplo das propriedades (VC + +)](actualsize-and-definedsize-properties-example-vc.md)
=======
  - [Exemplo das propriedades AbsolutePage, PageCount e PageSize (VC++)](absolutepage-pagecount-and-pagesize-properties-example-vc.md)
...
<<<<<<< HEAD
  - [Exemplo das propriedades Attributes e Name (VC++)](attributes-and-name-properties-example-vc.md)

  - [Exemplos dos métodos BeginTrans, CommitTrans e RollbackTrans (VC++)](begintrans-committrans-and-rollbacktrans-methods-example-vc.md)
...
<<<<<<< HEAD
  ...
  - [Exemplo das propriedades Description, HelpContext, HelpFile, NativeError, Number, Source e SQLState (VC++)](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vc.md)

  - [Exemplo dos Métodos Execute, Requery e Clear (VC++)](execute-requery-and-clear-methods-example-vc.md)

  - [Exemplo das propriedades RecordCount (VC + +) e filtro](filter-and-recordcount-properties-example-vc.md)
=======
  - [Exemplo das propriedades ConnectionString, ConnectionTimeout e State (VC++)](connectionstring-connectiontimeout-and-state-properties-example-vc.md)
...
<<<<<<< HEAD
  - [Exemplo das propriedades Precision (VC + +) e NumericScale do ADO](ado-numericscale-and-precision-properties-example-vc.md)
=======
  - [Exemplo das propriedades ADO NumericScale e Precision (VC + +)](ado-numericscale-and-precision-properties-example-vc.md)
>>>>>>> mestre
...
<<<<<<< HEAD
  ...
  - [Exemplo das propriedades OriginalValue e UnderlyingValue (VC++)](originalvalue-and-underlyingvalue-properties-example-vc.md)

  - [Exemplo da propriedade Prepared (VC++)](prepared-property-example-vc.md)

  - [Exemplo Provider e DefaultDatabase propriedades (VC + +)](provider-and-defaultdatabase-properties-example-vc.md)
=======
  - [Exemplo da propriedade Optimize (VC++)](optimize-property-example-vc.md)
...
<<<<<<< HEAD
  - [Exemplo do Método Seek e da Propriedade Index (VC++)](seek-method-and-index-property-example-vc.md)
  ...
  - [Exemplo da propriedade Type (Field) (VC++)](type-property-example-field-vc.md)

  - [Exemplo da propriedade Type (Property) (VC + +)](type-property-example-property-vc.md)
=======
  - [Método Seek e Index exemplo da propriedade (VC + +)](seek-method-and-index-property-example-vc.md)
