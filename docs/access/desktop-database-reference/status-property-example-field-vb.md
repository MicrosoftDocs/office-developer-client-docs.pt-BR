...
<span data-ttu-id="3d75e-p102">O exemplo a seguir exclui um **Field** conhecido de um **Record** aberto a partir de um documento. A propriedade **Status** será definida primeiramente como **adFieldOK** e, em seguida, como **adFieldPendingUnknown**.</span><span class="sxs-lookup"><span data-stu-id="3d75e-p102">The following example deletes a known **Field** from a **Record** opened from a document. The **Status** property will first be set to **adFieldOK**, then **adFieldPendingUnknown**.</span></span>
