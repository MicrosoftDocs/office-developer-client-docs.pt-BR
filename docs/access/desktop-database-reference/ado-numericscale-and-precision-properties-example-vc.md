...
ms.locfileid: "28720181"
---
# <a name="ado-numericscale-and-precision-properties-example-vc"></a><span data-ttu-id="171e8-102">Exemplo das propriedades ADO NumericScale e Precision (VC + +)</span><span class="sxs-lookup"><span data-stu-id="171e8-102">ADO NumericScale and Precision properties example (VC++)</span></span>


<span data-ttu-id="171e8-103">**Aplica-se a**: Access 2013, o Office 2013</span><span class="sxs-lookup"><span data-stu-id="171e8-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="171e8-104">Este exemplo usa as propriedades [NumericScale](numericscale-property-ado.md) e [Precision](precision-property-ado.md) para exibir a escala numérica e a precisão de campos na tabela ***Discounts*** do banco de dados ***Pubs***.</span><span class="sxs-lookup"><span data-stu-id="171e8-104">This example uses the [NumericScale](numericscale-property-ado.md) and [Precision](precision-property-ado.md) properties to display the numeric scale and precision of fields in the ***Discounts*** table of the ***Pubs*** database.</span></span>
