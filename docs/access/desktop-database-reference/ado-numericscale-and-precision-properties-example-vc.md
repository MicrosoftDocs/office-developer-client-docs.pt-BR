---
title: Exemplo das propriedades Precision (VC + +) e NumericScale do ADO
...
ms.locfileid: "25464903"
---
# <a name="ado-numericscale-and-precision-properties-example-vc"></a><span data-ttu-id="d6b32-102">Exemplo das propriedades Precision (VC + +) e NumericScale do ADO</span><span class="sxs-lookup"><span data-stu-id="d6b32-102">ADO NumericScale and Precision Properties Example (VC++)</span></span>


<span data-ttu-id="d6b32-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="d6b32-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="d6b32-104">Este exemplo usa as propriedades [NumericScale](numericscale-property-ado.md) e [Precision](precision-property-ado.md) para exibir a escala numérica e a precisão de campos na tabela ***Discounts*** do banco de dados ***Pubs***.</span><span class="sxs-lookup"><span data-stu-id="d6b32-104">This example uses the [NumericScale](numericscale-property-ado.md) and [Precision](precision-property-ado.md) properties to display the numeric scale and precision of fields in the ***Discounts*** table of the ***Pubs*** database.</span></span>
