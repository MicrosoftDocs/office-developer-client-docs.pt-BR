---
<<<<<<< Título cabeça: TOCTitle de exemplo da propriedade MaxRecords (VC + +): exemplo da propriedade MaxRecords (VC + +) === título: exemplo da propriedade MaxRecords (VC + +) TOCTitle: exemplo da propriedade MaxRecords (VC + +)
>>>>>>> ms:assetid de mestre: 007936cf-a91c-c447-69f2-8286f3f868e6 ms:mtpsurl: https://msdn.microsoft.com/library/JJ248778(v=office.15) ms:contentKeyID: ms.date 48542910: 18/09/2015 mtps_version: v=office.15
---
