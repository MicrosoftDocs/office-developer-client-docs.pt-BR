...
ms.locfileid: "25464918"
---
# <a name="move-method-example-vj"></a><span data-ttu-id="723b4-102">Exemplo do Método Move (VJ++)</span><span class="sxs-lookup"><span data-stu-id="723b4-102">Move Method Example (VJ++)</span></span>


<span data-ttu-id="723b4-103">**Aplica-se a**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="723b4-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="723b4-104">Este exemplo usa o método [Move](move-method-ado.md) para posicionar o ponteiro do registro com base na entrada do usuário.</span><span class="sxs-lookup"><span data-stu-id="723b4-104">This example uses the [Move](move-method-ado.md) method to position the record pointer based on user input.</span></span>
