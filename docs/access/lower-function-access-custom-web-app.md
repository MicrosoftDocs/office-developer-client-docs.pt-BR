...
description: Retorna uma expressão de caractere após converter dados de caracteres em maiúsculas em minúsculas.
...
Retorna uma expressão de caractere após converter dados de caracteres em maiúsculas em minúsculas.
