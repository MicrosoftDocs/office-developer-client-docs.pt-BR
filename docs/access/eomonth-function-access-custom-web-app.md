...
---
# <a name="eomonth-function-access-custom-web-app"></a>Função EOMonth (aplicativo Web personalizado do Access)

Retorna o último dia do mês antes ou o número especificado de meses.
...
O **EOMonth** contém os seguintes argumentos. 
  
|**Nome do argumento**|**Descrição**|
|:-----|:-----|
| *Date*  <br/> |A data de início no formato Data/Hora ou em uma representação de texto aceita de uma data.  <br/> |
| *NumberOfMonth*  <br/> |Um número que representa o número de meses antes ou depois da *Data.*  <br/> |
   
## <a name="remarks"></a>Comentários

Se  *Data*  não for uma data válida, **EOMonth** retornará um erro. 
  
Se  *Date*  mais  *NumberOfMonth*  gerar uma data inválida, **EOMonth** retornará um erro. 
