...
---
# <a name="access-custom-web-app-reference"></a>Referência de aplicativo Web personalizado do Access
...
- [Referência Access SQL e expressões (aplicativo da web personalizado do Access)](access-sql-and-expressions-reference-access-custom-web-app.md)
    
- [Referência de função de macro (aplicativo da web personalizado do Access)](macro-function-reference-access-custom-web-app.md)
