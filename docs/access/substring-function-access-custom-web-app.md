...
---
# <a name="substring-function-access-custom-web-app"></a>Função SubString (aplicativo da Web personalizado do Access)
 ...
 **Subcadeia de caracteres** (*TextExpression*, *Iniciar*, *comprimento*) 
