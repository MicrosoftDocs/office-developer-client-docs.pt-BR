...
A média calculada pela **média** é a média aritmética (a soma dos valores divididos pelo número de valores). Você poderia usar **Avg**, por exemplo, para calcular o custo médio de frete. 
