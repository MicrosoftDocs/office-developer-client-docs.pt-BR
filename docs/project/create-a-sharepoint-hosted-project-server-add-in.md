...
- [<span data-ttu-id="ca58f-514">Gerenciando atualizações de tarefas no Project Web App</span><span class="sxs-lookup"><span data-stu-id="ca58f-514">Managing task updates in Project Web App</span></span>](https://technet.microsoft.com/pt-br/library/hh767481%28v=office.14%29.aspx)
