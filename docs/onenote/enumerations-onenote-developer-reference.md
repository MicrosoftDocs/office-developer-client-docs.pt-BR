...
|**dlBottom** <br/> |quatro  <br/> |A janela do OneNote é encaixada na parte inferior da área de trabalho.  <br/> |
...
|**flWebContent** <br/> |quatro  <br/> |Define onde o conteúdo do Internet Explorer será arquivado.  <br/> |
|**flPrintOuts** <br/> |0,5  <br/> |Define onde as impressões da impressora do OneNote serão arquivadas.  <br/> |
...
|**fltNamedPage** <br/> |quatro  <br/> |Define o conteúdo a ser arquivado em uma página especificada.  <br/> |
...
|**heSections** <br/> |quatro  <br/> |Refere-se aos elementos da seção.  <br/> |
...
|**hsPages** <br/> |quatro  <br/> |Obtém todas as páginas abaixo do nó inicial, incluindo todas as páginas em grupos de seções e grupos de subseções.  <br/> |
...
|**nfoWeb** <br/> |quatro  <br/> |Permite blocos de anotações do OneDrive.  <br/> |
...
|**piFileType** <br/> |quatro  <br/> |Retorna o conteúdo da página com informações de tipo de arquivo para objetos de dados binários.  <br/> |
|**piBinaryDataFileType** <br/> |0,5  <br/> |Retorna o conteúdo da página com informações de tipo de arquivo para objetos de dados binários e objetos de dados binários  <br/> |
...
|**piAll** <br/> |178  <br/> |Retorna todo o conteúdo da página.  <br/> |
...
|**pfXPS** <br/> |quatro  <br/> |A página publicada está no formato. XPS.  <br/> |
|**pfWord** <br/> |0,5  <br/> |A página publicada está no formato. doc ou. docx.  <br/> |
|**pfEMF** <br/> |6  <br/> |A página publicada está no formato metarquivo avançado (. EMF).  <br/> |
|**pfHTML** <br/> |178  <br/> |A página publicada está no formato. html. Este membro é novo no OneNote 2013.  <br/> |
