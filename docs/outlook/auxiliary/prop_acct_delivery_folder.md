...
description: Representa a ID de entrada da pasta de entrega padrão da conta.
...
Representa a ID de entrada da pasta de entrega padrão da conta.
...
|Marca de propriedade:  <br/> |0x00190102  <br/> |
...
A pasta de entrega padrão é **a Caixa de Entrada.**
