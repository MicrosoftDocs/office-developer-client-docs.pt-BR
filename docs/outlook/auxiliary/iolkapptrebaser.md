...
Oferece suporte à alteração da base de compromissos em uma pasta de calendário.
...
|||
|:-----|:-----|
|**[BeginEnumerateAppointments](iolkapptrebaser-beginenumerateappointments.md)** <br/> |Inicia uma tarefa para enumeração de compromisso em uma pasta de calendário para encontrar os compromissos que precisam ser baseados.  <br/> |
...
|**[BeginRebaseAppointments](iolkapptrebaser-beginrebaseappointments.md)** <br/> |Inicia uma tarefa para a nova base de compromissos dada uma lista de compromissos, geralmente obtida de **EndEnumerateAppointments**.  <br/> |
|**[EndRebaseAppointments](iolkapptrebaser-endrebaseappointments.md)** <br/> |Aguarda a conclusão da base de compromissos e recupera os resultados.  <br/> |
