...
> [in] Uma interface [IOlkAccountNotify](iolkaccountnotify.md) que o gerente de conta usará para enviar notificações ao cliente. 
    
_pdwCookie_
  
> [out] Um cookie que [IOlkAccountManager::Unadvise](iolkaccountmanager-unadvise.md) usará ao remover o registro da conta. 
