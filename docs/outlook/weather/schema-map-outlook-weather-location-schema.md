---
title: Mapa de esquema (esquema de local de clima do Outlook)
manager: soliver
ms.date: 11/16/2014
...
description: Este tópico mostra a definição de esquema para o esquema XML do Outlook clima local.
ms.openlocfilehash: e3938385402d79d0ca2efbbd383a0726d1cf801f
ms.sourcegitcommit: 9d60cd82b5413446e5bc8ace2cd689f683fb41a7
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 06/11/2018
ms.locfileid: "19771030"
---
# <a name="schema-map-outlook-weather-location-schema"></a><span data-ttu-id="8f413-103">Mapa de esquema (esquema de local de clima do Outlook)</span><span class="sxs-lookup"><span data-stu-id="8f413-103">Schema map (Outlook Weather Location Schema)</span></span>

<span data-ttu-id="8f413-104">Este tópico mostra a definição de esquema para o esquema XML do Outlook clima local.</span><span class="sxs-lookup"><span data-stu-id="8f413-104">This topic shows the schema definition for the Outlook Weather Location XML Schema.</span></span>
