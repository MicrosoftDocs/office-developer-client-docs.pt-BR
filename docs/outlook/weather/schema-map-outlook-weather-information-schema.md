...
---
# <a name="schema-map-outlook-weather-information-schema"></a>Mapa de esquema (esquema de informações de clima do Outlook)

Este tópico mostra a definição de esquema para o esquema XML do Outlook clima informações.
