---
title: Mapa de esquema (esquema de informações de clima do Outlook)
manager: soliver
ms.date: 11/16/2014
...
description: Este tópico mostra a definição de esquema para o esquema XML do Outlook clima informações.
ms.openlocfilehash: 827aa051eae45e3caa99be5c8e7f8f16f8bbff13
ms.sourcegitcommit: 9d60cd82b5413446e5bc8ace2cd689f683fb41a7
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 06/11/2018
ms.locfileid: "19771055"
---
# <a name="schema-map-outlook-weather-information-schema"></a><span data-ttu-id="3b4fb-103">Mapa de esquema (esquema de informações de clima do Outlook)</span><span class="sxs-lookup"><span data-stu-id="3b4fb-103">Schema map (Outlook Weather Information Schema)</span></span>

<span data-ttu-id="3b4fb-104">Este tópico mostra a definição de esquema para o esquema XML do Outlook clima informações.</span><span class="sxs-lookup"><span data-stu-id="3b4fb-104">This topic shows the schema definition for the Outlook Weather Information XML Schema.</span></span>
