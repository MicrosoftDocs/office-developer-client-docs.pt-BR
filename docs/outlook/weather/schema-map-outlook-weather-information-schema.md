---
title: Mapa de esquema (Esquema de informações sobre o clima do Outlook)
manager: soliver
ms.date: 11/16/2014
...
---
# <a name="schema-map-outlook-weather-information-schema"></a>Mapa de esquema (Esquema de informações sobre o clima do Outlook)

Este tópico mostra a definição do esquema XML de informações sobre o clima do Outlook.
