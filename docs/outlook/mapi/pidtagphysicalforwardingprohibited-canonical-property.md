...
Contém TRUE se um remetente de mensagem proibir o encaminhamento de mensagem física para um destinatário específico.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_PHYSICAL_FORWARDING_PROHIBITED  <br/> |
|Identificador:  <br/> |0x0C0F  <br/> |
