...
Essa propriedade pode ser definida para autenticação básica ou autenticação NT LAN Manager (NTLM). Os valores possíveis para essa propriedade são os a seguir.
