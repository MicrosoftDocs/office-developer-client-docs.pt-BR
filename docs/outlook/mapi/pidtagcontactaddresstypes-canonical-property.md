...
Contém uma lista de tipos de endereços para um contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_CONTACT_ADDRTYPES, PR_CONTACT_ADDRTYPES_A, PR_CONTACT_ADDRTYPES_W  <br/> |
