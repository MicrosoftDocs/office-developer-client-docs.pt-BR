...
Contém a data e a hora de início de um compromisso, conforme gerenciado por um aplicativo de agendamento.
...
O agendamento de aplicativos deve definir essas propriedades de propriedade e **PR_END_DATE** ([PidTagEndDate](pidtagenddate-canonical-property.md)) ao enviar solicitações de reunião.
