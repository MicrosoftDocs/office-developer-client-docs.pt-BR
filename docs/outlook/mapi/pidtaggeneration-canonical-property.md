...
Contém uma abreviatura de geração que segue o nome completo do destinatário. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_GENERATION, PR_GENERATION_A, PR_GENERATION_W  <br/> |
...
Os valores comuns incluem Jr., Sr. e III.
