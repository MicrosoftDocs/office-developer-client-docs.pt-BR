...
Essas propriedades devem ser definidas para uma cadeia de caracteres não vazio para uma mensagem de informações de associar pasta (FAI) que contém definições de exibição.
