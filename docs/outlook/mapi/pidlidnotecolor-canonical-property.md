...
Especifica a cor de plano de fundo sugerida da nota. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidNoteColor  <br/> |
|Conjunto de propriedades:  <br/> |PSETID_Note  <br/> |
|Long ID (LID):  <br/> |0x00008B00  <br/> |
|Tipo de dados:  <br/> |PT_LONG  <br/> |
|Área:  <br/> |Observações Desaderentadas  <br/> |
   
## <a name="remarks"></a>Comentários

Essa propriedade deve ser uma das entradas da tabela a seguir:
  
|**Valor**|**Color**|
|:-----|:-----|
|0x00000000  <br/> |Azul  <br/> |
|0x00000001  <br/> |Verde  <br/> |
|0x00000002  <br/> |Rosa  <br/> |
|0x00000003  <br/> |Amarelo  <br/> |
|0x00000004  <br/> |Branco  <br/> |
...
> Especifica as propriedades e operações que são permitidas em anotações.
