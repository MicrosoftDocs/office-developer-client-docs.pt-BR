...
Indica a existência de um anexo de foto para um contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_ATTACHMENT_CONTACTPHOTO  <br/> |
|Identificador:  <br/> |0x7FFF  <br/> |
|Tipo de dados:  <br/> |PT_BOOLEAN  <br/> |
|Área:  <br/> |Anexo de mensagem  <br/> |
   
## <a name="remarks"></a>Comentários

O valor desta propriedade deve ser definido como TRUE e deve haver apenas um anexo em um determinado objeto Contact.
