...
Realiza a mesma função que [HrOpenABEntryWithExchangeContext](hropenabentrywithexchangecontext.md) , exceto pelo fato de usar o **emsmdbUID** herdado como o parâmetro _pEmsmdbUID_ . Não use essa função, a menos que não possa obter o **emsmdbUID** correto para a chamada para [HrOpenABEntryWithExchangeContext](hropenabentrywithexchangecontext.md).
