...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidFileUnderList  <br/> |
...
Cada valor na propriedade de vários valores deve ser um dos valores permitidos para **dispidFileUnderId** especificado em [[MS-OXOCNTC]](https://msdn.microsoft.com/library/9b636532-9150-4836-9635-9c9b756c9ccf%28Office.15%29.aspx).
