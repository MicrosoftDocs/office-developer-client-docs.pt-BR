...
Contém o título da base de conteúdo de um anexo de mensagem MIME (Multipurpose Internet Mail Extensions).
...
Essas propriedades são usadas para suporte a MHTML. Eles representam o título da base de conteúdo para a parte apropriada do corpo MIME. 
