...
ms.locfileid: "19768514"
---
# <a name="pidlidlocation-canonical-property"></a>Propriedade canônica PidLidLocation

  
  
**Aplica-se a**: Outlook 
  
Representa o local de um compromisso.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidLocation  <br/> |
|Propriedade definida:  <br/> |PSETID_Appointment  <br/> |
|ID de longo (LID):  <br/> |0x00008208  <br/> |
