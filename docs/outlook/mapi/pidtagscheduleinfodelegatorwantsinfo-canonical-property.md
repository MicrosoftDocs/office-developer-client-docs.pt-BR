...
ms.locfileid: "22594394"
---
# <a name="pidtagscheduleinfodelegatorwantsinfo-canonical-property"></a>Propriedade canônica PidTagScheduleInfoDelegatorWantsInfo

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém o representante que deseja receber atualizações informativas.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_SCHDINFO_BOSS_WANTS_INFO  <br/> |
|Identificador:  <br/> |0x684B  <br/> |
