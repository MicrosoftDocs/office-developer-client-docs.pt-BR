...
---
# <a name="pidtagprofession-canonical-property"></a>Propriedade canônica PidTagProfession

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém a profissional do usuário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_PROFESSION, PR_PROFESSION_A, PR_PROFESSION_W  <br/> |
|Identificador:  <br/> |0x3A46  <br/> |
