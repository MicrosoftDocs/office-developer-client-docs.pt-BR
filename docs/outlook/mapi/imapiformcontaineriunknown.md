...
Gerencia formulários em bibliotecas de formulários. Essa interface é usada para criar bibliotecas de formulário específicas do aplicativo. 
  
|||
|:-----|:-----|
|Arquivo de cabeçalho:  <br/> |Mapiform.h  <br/> |
|Exposto por:  <br/> |Objetos de contêiner de formulário  <br/> |
...
|[RemoveForm](imapiformcontainer-removeform.md) <br/> |Remove um formulário específico de um contêiner de formulário.  <br/> |
...
|[GetLastError](imapiformcontainer-getlasterror.md) <br/> |Retorna uma [estrutura MAPIERROR](mapierror.md) que contém informações sobre o erro anterior que ocorreu no objeto de contêiner de formulário.  <br/> |
