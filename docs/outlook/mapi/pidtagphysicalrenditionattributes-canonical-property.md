...
Contém um identificador de objeto ASN. 1 que é usado para processar anexos de mensagens.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_PHYSICAL_RENDITION_ATTRIBUTES  <br/> |
|Identificador:  <br/> |0x0C10  <br/> |
