...
Especifica a data e hora em que o padrão de recorrência que substituirá a exceção.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidExceptionReplaceTime  <br/> |
|Propriedade definida:  <br/> |PSETID_Appointment  <br/> |
|ID de longo (LID):  <br/> |0x00008228  <br/> |
