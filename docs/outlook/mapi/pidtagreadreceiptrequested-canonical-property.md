...
Se uma mensagem com **PR_READ_RECEIPT_REQUESTED** definida for excluída ou expirar antes que o sistema de mensagens possa gerar um relatório de leitura, um relatório não lido será gerado. 
