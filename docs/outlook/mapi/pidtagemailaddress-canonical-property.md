...
Essas propriedades são exemplos das propriedades de endereço base para todos os usuários de mensagens. É uma cadeia de caracteres terminada em nulo cujo formato indica apenas o sistema de mensagens subjacente. 
  
Essas propriedades são usadas em conjunto com as propriedades **PR_ADDRTYPE** ([PidTagAddressType](pidtagaddresstype-canonical-property.md)) e **PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md)) em mensagens de endereçamento. O formato da cadeia de caracteres é qualificado por **PR_ADDRTYPE**. 
