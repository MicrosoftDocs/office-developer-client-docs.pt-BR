...
Contém uma lista de identificadores para provedores do catálogo de endereços no perfil atual. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_AB_PROVIDERS  <br/> |
|Identificador:  <br/> |0x3D01  <br/> |
