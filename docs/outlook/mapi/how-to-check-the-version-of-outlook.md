...
## <a name="see-also"></a><span data-ttu-id="ab1d8-110">Ver tamb�m</span><span class="sxs-lookup"><span data-stu-id="ab1d8-110">See also</span></span>

- [<span data-ttu-id="ab1d8-111">Vis�o geral da programa��o MAPI</span><span class="sxs-lookup"><span data-stu-id="ab1d8-111">MAPI Programming Overview</span></span>](mapi-programming-overview.md)
