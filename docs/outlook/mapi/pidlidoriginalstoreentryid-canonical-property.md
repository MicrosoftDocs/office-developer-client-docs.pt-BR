...
Especifica a ID de entrada do armazenamento do delegante.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidOrigStoreEid  <br/> |
...
Essa propriedade deve ser definida em objetos de reunião que tenham sido criados ou atualizados por um representante.
