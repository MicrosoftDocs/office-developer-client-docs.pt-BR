...
|ID de longo (LID):  <br/> |0x00008237  <br/> |
|Tipo de dados:  <br/> |PT_BINARY  <br/> |
|Área:  <br/> |Reuniões  <br/> |
   
## <a name="remarks"></a>Comentários

Essa propriedade deve ser definida em objetos de reunião que foram criados ou atualizados por um representante.
