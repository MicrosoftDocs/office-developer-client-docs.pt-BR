...
Mapeia para o cabeçalho de distribuição MIME.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_INTERNET_DISTRIBUTION, PR_INTERNET_DISTRIBUTION_A, PR_INTERNET_DISTRIBUTION_W  <br/> |
|Identificador:  <br/> |0x1032  <br/> |
