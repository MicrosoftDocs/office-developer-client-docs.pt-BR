...
Especifica o que outro endereço de fax do formato rich text do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidFax3RTF  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x000080D6  <br/> |
