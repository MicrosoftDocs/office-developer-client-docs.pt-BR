...
Indica um horário em que um cliente gostaria de adiar o envio de uma mensagem.
...
Se **PR_DEFERRED_SEND_TIME** valor for anterior à hora atual (em UTC), a mensagem será enviada imediatamente. 
