...
Essas propriedades são exemplos das propriedades de endereço para o usuário de mensagens que recebe a mensagem. Devem ser definidas pelo provedor de transporte de entrada.
