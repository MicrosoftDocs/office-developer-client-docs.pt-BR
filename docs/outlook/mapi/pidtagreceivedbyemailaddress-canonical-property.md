...
Contém o endereço de email do usuário de mensagens que recebe a mensagem.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_RECEIVED_BY_EMAIL_ADDRESS, PR_RECEIVED_BY_EMAIL_ADDRESS_A, PR_RECEIVED_BY_EMAIL_ADDRESS_W  <br/> |
...
Essas propriedades são exemplos das propriedades de endereço para o usuário de mensagens que recebe a mensagem. Eles devem ser definidos pelo provedor de transporte de entrada.
