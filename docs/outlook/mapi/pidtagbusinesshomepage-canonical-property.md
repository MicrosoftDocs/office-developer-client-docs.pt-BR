...
Contém a URL da Home Page da empresa.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_BUSINESS_HOME_PAGE, PR_BUSINESS_HOME_PAGE_A, PR_BUSINESS_HOME_PAGE_W  <br/> |
|Identificador:  <br/> |0x3A51  <br/> |
|Tipo de dados:  <br/> |PT_UNICODE, PT_STRING8  <br/> |
|Área:  <br/> |Contato  <br/> |
   
## <a name="remarks"></a>Comentários

Essas propriedades são usadas como um link para a Home Page de negócios do contato.
