...
Especifica a distância, em pixels, da borda superior da tela em que uma interface do usuário exibe uma anotação.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidNoteY  <br/> |
