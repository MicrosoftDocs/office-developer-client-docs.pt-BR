...
2. Se **IMsgStore::GetReceiveFolder** for bem-sucedida, use a referência para **EntryID** da Caixa de Entrada e **IMsgStore::OpenEntry** para abrir a Caixa de Entrada e obter uma referência a um objeto **IMAPIFolder.** 
    
3. Se **IMsgStore::OpenEntry** for bem-sucedida, use a referência retornada para o objeto **IMAPIFolder** e **IMAPIProp::GetProps** para obter a propriedade desejada. 
