...
Contém informações adicionais para uso em um relatório.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_SUPPLEMENTARY_INFO, PR_SUPPLEMENTARY_INFO_A, PR_SUPPLEMENTARY_INFO_W  <br/> |
|Identificador:  <br/> |0x0C1B  <br/> |
