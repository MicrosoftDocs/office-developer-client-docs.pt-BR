...
Indica se a classificação de mensagem deve persistir com a mensagem se a mensagem for encaminhada ou respondida.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidClassKeep  <br/> |
