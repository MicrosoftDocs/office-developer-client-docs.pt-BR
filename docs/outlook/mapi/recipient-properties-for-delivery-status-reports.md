...
|**PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md))  <br/> |Contém uma cadeia de texto que identifica a classe de mensagem definida pelo remetente, como IPM.Note.  <br/> |
|**PR_NDR_REASON_CODE** ([PidTagNonDeliveryReportReasonCode](pidtagnondeliveryreportreasoncode-canonical-property.md))  <br/> |Contém um motivo codificado para não entrega que faz parte de um relatório de não entrega.  <br/> |
|**PR_ORIGINAL_DISPLAY_NAME** ([PidTagOriginalDisplayName](pidtagoriginaldisplayname-canonical-property.md))  <br/> |Contém o nome de exibição original de uma entrada copiada de um livro de endereços para um livro de endereços pessoal ou outro livro de endereços que pode ser escrito.  <br/> |
|**PR_ORIGINAL_ENTRYID** ([PidTagOriginalEntryId](pidtagoriginalentryid-canonical-property.md))  <br/> |Contém o identificador de entrada original de uma entrada copiada de um livro de endereços para um livro de endereços pessoal ou outro livro de endereços que pode ser escrito.  <br/> |
|**PR_ORIGINAL_SEARCH_KEY** ([PidTagOriginalSearchKey](pidtagoriginalsearchkey-canonical-property.md))  <br/> |Contém a chave de pesquisa original para uma entrada copiada de um livro de endereços para um livro de endereços pessoal ou outro livro de endereços que pode ser escrito.  <br/> |
|**PR_RECIPIENT_TYPE** ([PidTagRecipientType](pidtagrecipienttype-canonical-property.md))  <br/> |Contém o tipo de destinatário de um destinatário da mensagem.  <br/> |
...
|**PR_REPORT_TIME** ([PidTagReportTime](pidtagreporttime-canonical-property.md))  <br/> |Contém a data e a hora em que o sistema de mensagens gerou um relatório.  <br/> |
