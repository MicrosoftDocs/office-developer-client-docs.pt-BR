...
Contém a data e a hora de término de um compromisso, conforme gerenciado por um aplicativo de agendamento. 
...
O agendamento de aplicativos deve definir o **PR_START_DATE** ([PidTagStartDate](pidtagstartdate-canonical-property.md)) e essa propriedade ao enviar solicitações de reunião. 
