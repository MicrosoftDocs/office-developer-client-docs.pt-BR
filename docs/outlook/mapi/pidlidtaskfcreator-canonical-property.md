...
Indica que a tarefa foi originalmente criada pelo usuário ou agente do usuário atual, em vez de processar uma solicitação de tarefa.
...
O cliente define essa propriedade como TRUE quando o usuário cria a tarefa e como FALSE quando a tarefa é atribuída por outro usuário. Se essa propriedade for deixada desalinhada, será assumido um valor TRUE.
