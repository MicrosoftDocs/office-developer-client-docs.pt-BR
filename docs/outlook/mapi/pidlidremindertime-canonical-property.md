...
Especifica a hora do sinal inicial para um lembrete.
...
Para objetos de calendário, essa propriedade representa a hora em que o usuário se atrasaria, que é a hora de início do compromisso. Os clientes devem definir o valor em UTC (Tempo Universal Coordenado).
