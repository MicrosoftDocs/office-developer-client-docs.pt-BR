...
Essa propriedade também pode especificar o nível de categorização de uma linha em uma tabela de conteúdo ou a profundidade de hierarquia em uma tabela de hierarquia. A profundidade é baseada em zero, onde zero representa a categoria mais à esquerda. Em todos os casos, o valor da propriedade representa um valor relativo, em vez de um valor absoluto. Na tabela de hierarquia, por exemplo, o valor de profundidade é relativo ao contêiner a partir do qual a tabela de hierarquia foi recuperada. A profundidade não representa uma profundidade absoluta do contêiner raiz. 
