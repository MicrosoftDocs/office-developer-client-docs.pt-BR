...
Normalmente, o texto contido nessas propriedades é gerado em resposta a um relatório de entrega ou não entrega ou um relatório lido ou não lido recebido do sistema de mensagens subjacente, mas não é o próprio texto transferido por esse sistema. 
