...
---
# <a name="programmatically-create-a-profile-in-outlook"></a>Criar programaticamente um perfil no Outlook
...
- [Criar um perfil do Outlook usando MFCMAPI](https://msdn.microsoft.com/en-us/library/office/mt723322.aspx)
