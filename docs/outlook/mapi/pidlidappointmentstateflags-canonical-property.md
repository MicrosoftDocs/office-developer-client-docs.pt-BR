...
> Este sinalizador indica que o objeto é um objeto de reunião ou um objeto relacionado à reunião.
    
R (asfReceived, 0x00000002)
  
> Este sinalizador indica que o objeto representado foi recebido de outra pessoa.
    
C (asfCanceled, 0x00000004)
  
> Este sinalizador indica que o objeto de reunião representado pelo objeto foi cancelado.
