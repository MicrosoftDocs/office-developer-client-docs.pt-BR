...
Contém uma contagem dos caracteres ignoráveis que aparecem após os caracteres significativos da mensagem.
...
Essa propriedade é uma propriedade auxiliar RFT (Rich Text Format). Essas propriedades são usadas pela [função RTFSync](rtfsync.md) e não se destinam a ser usadas diretamente por aplicativos cliente. 
