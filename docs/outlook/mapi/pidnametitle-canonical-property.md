...
---
# <a name="pidnametitle-canonical-property"></a>Propriedade canônica PidNameTitle

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Especifica o título do arquivo anexado ao documento.
  
|||
|:-----|:-----|
|Nomes amigáveis:  <br/> |Nenhum  <br/> |
|Conjunto de propriedades:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Nome da propriedade:  <br/> |Título  <br/> |
