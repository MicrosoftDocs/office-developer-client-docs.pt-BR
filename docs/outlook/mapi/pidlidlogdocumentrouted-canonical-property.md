...
---
# <a name="pidlidlogdocumentrouted-canonical-property"></a>Propriedade canônico de PidLidLogDocumentRouted
...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidLogDocRouted  <br/> |
|Propriedade definida:  <br/> |PSETID_Log  <br/> |
|ID de longo (LID):  <br/> |0x00008710  <br/> |
