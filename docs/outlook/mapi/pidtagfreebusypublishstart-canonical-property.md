...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_FREEBUSY_PUBLISH_START  <br/> |
...
O valor dessa propriedade é o número de minutos desde a meia-noite de 1º de janeiro de 1601 em UTC (Tempo Universal Coordenado).
