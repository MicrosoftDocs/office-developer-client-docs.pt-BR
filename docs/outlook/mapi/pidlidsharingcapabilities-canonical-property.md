...
Essa propriedade deve ser definida como um dos seguintes valores:
  
|**Valor**|**Cenário**|
|:-----|:-----|
|0x00040290  <br/> |Este objeto Message de compartilhamento se relaciona a uma pasta especial.  <br/> |
|0x000402B0  <br/> |Este objeto Message de compartilhamento não está relacionado a uma pasta especial.  <br/> |
