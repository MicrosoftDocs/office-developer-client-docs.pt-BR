...
Contém uma lista de números de telefone secundários na casa do destinatário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_HOME2_TELEPHONE_NUMBER_A_MV  <br/> |
|Identificador:  <br/> |0x3A2F  <br/> |
|Tipo de dados:  <br/> |PT_MV_UNICODE8  <br/> |
