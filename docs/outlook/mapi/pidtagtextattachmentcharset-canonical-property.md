...
Os dados dessa propriedade são derivados de um campo de cabeçalho MIME do tipo de conteúdo que começa com "text/", se um parâmetro "charset" estiver presente.
