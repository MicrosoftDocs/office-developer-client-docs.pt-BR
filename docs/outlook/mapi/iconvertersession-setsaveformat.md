...
> [in] O formato de salvar a ser usado para um fluxo MIME. Para obter mais informações, consulte o tipo de enum [MIMESAVETYPE](https://msdn.microsoft.com/library/ms715128%28VS.85%29.aspx).
