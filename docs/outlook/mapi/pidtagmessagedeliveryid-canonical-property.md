...
Contém um identificador de sistema de transferência de mensagens (MTS) para uma mensagem entregue a um aplicativo cliente.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_MESSAGE_DELIVERY_ID  <br/> |
|Identificador:  <br/> |0x001B  <br/> |
