...
Contém os meses nos quais os dados de disponibilidade do tipo ocupado estão presentes na mensagem de disponibilidade.
...
O formato, a computação e as restrições dessa propriedade são os mesmos do **PR_SCHDINFO_MONTHS_TENTATIVE** ([PidTagScheduleInfoMonthsTentative](pidtagscheduleinfomonthstentative-canonical-property.md)), mas se referem aos compromissos marcados como ocupados no objeto Calendar associado.
