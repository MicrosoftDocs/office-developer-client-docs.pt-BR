...
Define o tempo de envio expirado em conjunto com a **propriedade PR_EXPIRY_UNITS** ([PidTagExpiryUnits](pidtagexpiryunits-canonical-property.md)).
...
O valor dessa propriedade deve ser definido entre 0 e 999, inclusive, se estiver presente.
