...
Contém o endereço de email do usuário de mensagens que é representado pelo usuário de recebimento.
...
Um aplicativo cliente que responde a uma mensagem recebida em nome de outro cliente deve copiar essas propriedades da mensagem recebida para a propriedade **PR_SENT_REPRESENTING_EMAIL_ADDRESS** ([PidTagSentRepresentingEmailAddress](pidtagsentrepresentingemailaddress-canonical-property.md)) para o resposta.
