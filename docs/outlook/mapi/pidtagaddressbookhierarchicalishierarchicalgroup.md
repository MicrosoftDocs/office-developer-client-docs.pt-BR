...
Conterá TRUE se a lista de distribuição também é um grupo departamental. Essa propriedade está disponível somente em listas de distribuição.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_EMS_AB_HAB_IS_HIERARCHICAL_GROUP  <br/> |
|Propriedade definida:  <br/> |Catálogo de Endereços  <br/> |
|ID de longo (LID):  <br/> |0x8CDD  <br/> |
