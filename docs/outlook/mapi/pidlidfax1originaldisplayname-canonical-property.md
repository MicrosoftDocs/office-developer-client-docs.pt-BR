...
---
# <a name="pidlidfax1originaldisplayname-canonical-property"></a>Propriedade canônico de PidLidFax1OriginalDisplayName

  
  
**Aplica-se a**: Outlook 
  
Especifica o nome para exibição original do endereço de fax comercial do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidFax1OriginalDisplayName  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x000080B4  <br/> |
