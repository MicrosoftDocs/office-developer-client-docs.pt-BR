...
Essas propriedades são um exemplo das propriedades de endereço do usuário que recebe a mensagem. Eles devem ser definidos pelo provedor de transporte de entrada.
