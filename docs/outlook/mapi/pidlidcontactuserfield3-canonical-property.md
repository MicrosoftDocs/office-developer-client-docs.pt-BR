...
Especifica o terceiro campo no contato destinado ao uso variado do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidContactUserField3  <br/> |
...
Esta propriedade contém texto que não está relacionado a qualquer outra propriedade específica de contato.
