...
ms.locfileid: "25384406"
---
# <a name="pidtagstateorprovince-canonical-property"></a>Propriedade canônica PidTagStateOrProvince

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém o nome do estado ou a província do destinatário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_STATE_OR_PROVINCE, PR_STATE_OR_PROVINCE_A, PR_STATE_OR_PROVINCE_W, PR_BUSINESS_ADDRESS_STATE_OR_PROVINCE, PR_BUSINESS_ADDRESS_STATE_OR_PROVINCE_A, PR_BUSINESS_ADDRESS_STATE_OR_PROVINCE_W  <br/> |
|Identificador:  <br/> |0x3A28  <br/> |
