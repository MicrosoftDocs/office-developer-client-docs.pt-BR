...
---
# <a name="pidlidfax3entryid-canonical-property"></a>Propriedade canônica PidLidFax3EntryId

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Especifica o que outro endereço de fax da EntryID do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidFax3EntryID  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x000080D1  <br/> |
