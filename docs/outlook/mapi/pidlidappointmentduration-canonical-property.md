...
Representa o período de tempo, em minutos, quando um compromisso está agendado.
...
O valor deve ser o número de minutos entre o valor das propriedades **dispidApptStartWhole** ([PidLidAppointmentStartWhole](pidlidappointmentstartwhole-canonical-property.md)) e **dispidApptEndWhole** ([PidLidAppointmentEndWhole](pidlidappointmentendwhole-canonical-property.md)).
