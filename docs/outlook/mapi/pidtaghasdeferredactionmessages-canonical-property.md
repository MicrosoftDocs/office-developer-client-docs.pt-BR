---
title: Propriedade canônica PidTagHasDeferredActionMessages
manager: soliver
ms.date: 03/09/2015
...
Contém TRUE se uma mensagem tiver pelo menos uma regra de ação adiada.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_HAS_DAMS  <br/> |
|Identificador:  <br/> |0x3FEA  <br/> |
