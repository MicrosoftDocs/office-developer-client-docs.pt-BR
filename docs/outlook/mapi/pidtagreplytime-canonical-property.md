...
---
# <a name="pidtagreplytime-canonical-property"></a>Propriedade canônica PidTagReplyTime

  
  
**Aplica-se a**: Outlook 
  
Contém o prazo final em uma mensagem. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_REPLY_TIME  <br/> |
|Identificador:  <br/> |0x0030  <br/> |
