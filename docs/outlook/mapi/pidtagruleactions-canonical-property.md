...
As ações são expressas como uma ação de regra e o buffer de valor da propriedade contém a estrutura de buffer de dados de ação de regra empacotada conforme especificado em [[MS-OXORULE]](https://msdn.microsoft.com/library/70ac9436-501e-43e2-9163-20d2b546b886%28Office.15%29.aspx).
