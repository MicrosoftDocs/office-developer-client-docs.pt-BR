...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_LANGUAGE, PR_LANGUAGE_A, PR_LANGUAGE_W  <br/> |
|Identificador:  <br/> |0x3A0C  <br/> |
...
[Propriedade canônica PidTagLanguages](pidtaglanguages-canonical-property.md)
