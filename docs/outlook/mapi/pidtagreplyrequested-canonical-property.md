...
Contém TRUE se um remetente de mensagem solicitar uma resposta de um destinatário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_REPLY_REQUESTED  <br/> |
|Identificador:  <br/> |0x0C17  <br/> |
