...
---
# <a name="pidlidemail3emailaddress-canonical-property"></a>Propriedade canônico de PidLidEmail3EmailAddress

  
  
**Aplica-se a**: Outlook 
  
Especifica o terceiro endereço de email do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidEmail3EmailAddress  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x000080A3  <br/> |
