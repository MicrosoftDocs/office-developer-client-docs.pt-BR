...
Contém o identificador de entrada do contêiner do livro de endereços a ser exibido primeiro. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_AB_DEFAULT_DIR  <br/> |
|Identificador:  <br/> |0x3D06  <br/> |
