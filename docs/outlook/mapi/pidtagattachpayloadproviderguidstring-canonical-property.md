...
Contém o valor de um campo de header MIME X-Payload-Provider-Guid.
...
Para definir o valor dessas propriedades, os clientes MIME devem gravar um campo de header X-Payload-Provider-Guid em uma entidade MIME que será analisada como um anexo.
