...
Ele deve estar presente em todos os objetos de livro de endereços em um servidor NSPI (Name Service Provider Interface) e deve ter o valor zero (0). Ele não deve ser definido para qualquer objeto em um Livro de Endereços Offline.
