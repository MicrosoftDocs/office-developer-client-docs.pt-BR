...
---
# <a name="pidtagprofiletype-canonical-property"></a>Propriedade canônica PidTagProfileType
...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_PROFILE_TYPE  <br/> |
|Identificador:  <br/> |0x660A  <br/> |
