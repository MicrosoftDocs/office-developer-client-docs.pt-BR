...
---
# <a name="content-retired-notice-mapi"></a>Notificação de retirada de conteúdo (MAPI)


  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
The content that you tried to view is no longer available. It may have been deleted or replaced with a more recent version. Explore este conjunto de links para acelerar o seu.
