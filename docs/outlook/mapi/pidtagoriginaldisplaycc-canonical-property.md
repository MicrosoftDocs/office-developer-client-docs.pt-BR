...
Contém os nomes de exibição de quaisquer destinatários com cópia carbono (CC) da mensagem original.
...
Essas propriedades contêm uma lista separada por ponto-e-vírgula. Ele é fornecido por MAPI e é copiado diretamente de **PR_DISPLAY_CC** ([PidTagDisplayCc](pidtagdisplaycc-canonical-property.md)) quando um relatório de entrega ou não entrega ou um relatório lido ou não lido é gerado. Essa propriedade pode estar presente em outras mensagens, conforme definido por suas classes de mensagens.
