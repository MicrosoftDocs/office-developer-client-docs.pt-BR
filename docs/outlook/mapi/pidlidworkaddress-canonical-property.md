...
Especifica o endereço de trabalho completo do contato.
...
Essa propriedade deve ser uma combinação de outras propriedades de endereço físico e baseia-se na localidade do cliente.
