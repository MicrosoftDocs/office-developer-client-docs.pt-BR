...
Contém sinalizadores que especificam os dados BLOB (objeto binário grande) que aparecem na propriedade **PR_WB_SF_DEFINITION** ([PidTagSearchFolderDefinition](pidtagsearchfolderdefinition-canonical-property.md)).
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_WB_SF_STORAGE_TYPE  <br/> |
|Identificador:  <br/> |0x6846  <br/> |
