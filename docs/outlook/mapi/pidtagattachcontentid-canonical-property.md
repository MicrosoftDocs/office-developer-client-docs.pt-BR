...
Contém o título de identificação de conteúdo de um anexo de mensagem MIME (Multipurpose Internet Mail Extensions). 
...
Essas propriedades são usadas para suporte a MHTML. Eles representam o título de identificação de conteúdo para a parte apropriada do corpo MIME. 
