...
---
# <a name="pidtaginitials-canonical-property"></a>Propriedade canônica PidTagInitials

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém as iniciais das partes do nome completo do destinatário. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_INITIALS, PR_INITIALS_A, PR_INITIALS_W  <br/> |
|Identificador:  <br/> |0x3A0A  <br/> |
