...
Contém TRUE se as conversões de mensagem são proibidas por padrão para o usuário de mensagens associado.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_CONVERSION_PROHIBITED  <br/> |
|Identificador:  <br/> |0x3A03  <br/> |
