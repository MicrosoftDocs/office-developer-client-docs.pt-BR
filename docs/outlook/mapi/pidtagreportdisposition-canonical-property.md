...
Indica o status do recibo para mensagens que solicitam recibos. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_REPORT_DISPOSITION, PR_REPORT_DISPOSITION_A, PR_REPORT_DISPOSITION_W  <br/> |
