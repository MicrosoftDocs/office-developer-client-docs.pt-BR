...
|||
|**PR_ENTRYID** ([PidTagEntryId](pidtagentryid-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
|**PR_LAST_MODIFICATION_TIME** ([PidTagLastModificationTime](pidtaglastmodificationtime-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
|**PR_MESSAGE_ATTACHMENTS** ([PidTagMessageAttachments](pidtagmessageattachments-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
|**PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md))  <br/> |Pode ser definido por clientes em mensagens de saída; deve ser definido por provedores de repositórios de mensagens se não for definido por clientes.  <br/> |
|**PR_MESSAGE_FLAGS** ([PidTagMessageFlags](pidtagmessageflags-canonical-property.md))  <br/> |Definidos por clientes nas mensagens de saída antes de serem salvos e provedores de repositórios de mensagens depois de serem salvos.  <br/> |
|**PR_MESSAGE_RECIPIENTS** ([PidTagMessageRecipients](pidtagmessagerecipients-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
|**PR_MESSAGE_SIZE** ([PidTagMessageSize](pidtagmessagesize-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
...
|||
|**PR_NORMALIZED_SUBJECT** ([PidTagNormalizedSubject](pidtagnormalizedsubject-canonical-property.md))  <br/> |Definir por provedores de repositório de mensagens em mensagens de saída  <br/> |
...
|**PR_PARENT_ENTRYID** ([PidTagParentEntryId](pidtagparententryid-canonical-property.md))  <br/> **PR_PARENT_DISPLAY** ([PidTagParentDisplay](pidtagparentdisplay-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
|||
...
|**PR_RECIPIENT_TYPE** ([PidTagRecipientType](pidtagrecipienttype-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de entrada.  <br/> |
|**PR_RECORD_KEY** ([PidTagRecordKey](pidtagrecordkey-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
|**PR_SEARCH_KEY** ([PidTagSearchKey](pidtagsearchkey-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
...
|**PR_STORE_ENTRYID** ([PidTagStoreEntryId](pidtagstoreentryid-canonical-property.md))  <br/> **PR_STORE_RECORD_KEY** ([PidTagStoreRecordKey](pidtagstorerecordkey-canonical-property.md))  <br/> |Definido por provedores de repositório de mensagens em mensagens de saída.  <br/> |
