...
---
# <a name="pidtagotheraddresspostalcode-canonical-property"></a>Propriedade canônica PidTagOtherAddressPostalCode

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém o código postal para o email outro endereço postal do usuário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_OTHER_ADDRESS_POSTAL_CODE, PR_OTHER_ADDRESS_POSTAL_CODE_A, PR_OTHER_ADDRESS_POSTAL_CODE_W  <br/> |
|Identificador:  <br/> |0x3A61  <br/> |
