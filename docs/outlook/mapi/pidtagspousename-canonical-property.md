...
---
# <a name="pidtagspousename-canonical-property"></a>Propriedade canônica PidTagSpouseName

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém o nome do cônjuge do usuário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_SPOUSE_NAME, PR_SPOUSE_NAME_A, PR_SPOUSE_NAME_W  <br/> |
|Identificador:  <br/> |0x3A48  <br/> |
