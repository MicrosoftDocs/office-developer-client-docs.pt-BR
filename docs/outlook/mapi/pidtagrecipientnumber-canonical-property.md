...
Representa o número do destinatário de um destinatário na mensagem.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_RECIPIENT_NUMBER  <br/> |
|Identificador:  <br/> |0x6662  <br/> |
|Tipo de dados:  <br/> |PT_LONG  <br/> |
|Área:  <br/> |Leitura/gravação de mensagens do Exchange  <br/> |
