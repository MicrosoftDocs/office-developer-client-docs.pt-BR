...
Essa propriedade é usada por aplicativos que utilizam a segurança de chave pública. Ele contém uma representação binária de um ou mais certificados de segurança X.509 versão 3. 
