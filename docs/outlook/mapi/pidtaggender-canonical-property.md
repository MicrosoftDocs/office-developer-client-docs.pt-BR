...
Essa propriedade fornece informações de identificação e acesso sobre um usuário de mensagens e o conteúdo. O conteúdo é definido pelo usuário de mensagens e pela organização do usuário de mensagens. 
  
Os valores possíveis para essa propriedade são definidos na enumeração de sexo. Eles são listados da seguinte forma:
  
|**Enumeração de gênero**|**Valor**|**Descrição**|
|:-----|:-----|:-----|
|genderUnspecified  <br/> |0x0000  <br/> |O gênero do contato não é especificado.  <br/> |
|genderFemale  <br/> |0x0001  <br/> |O contato é uma mulher.  <br/> |
|genderMale  <br/> |0x0002  <br/> |O contato é adulto.  <br/> |
