...
Contém o prefixo do nome de exibição (como Miss, Mr., Mrs.) para o usuário de mensagens. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_DISPLAY_NAME_PREFIX, PR_DISPLAY_NAME_PREFIX_A, PR_DISPLAY_NAME_PREFIX_W  <br/> |
|Identificador:  <br/> |0x3A45  <br/> |
