...
---
# <a name="pidlidfax2entryid-canonical-property"></a>Propriedade canônica PidLidFax2EntryId

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Especifica a identificação de entrada de endereço de fax residencial do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidFax2EntryID  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x000080C1  <br/> |
