...
Contém a página de código que é usada para a mensagem.
...
A página de código do objeto de pasta é usada se essa propriedade for definida como zero (0).
