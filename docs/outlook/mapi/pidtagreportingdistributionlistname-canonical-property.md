...
Contém o nome de exibição de uma lista de distribuição onde o sistema de mensagens fornece um relatório.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_REPORTING_DL_NAME  <br/> |
|Identificador:  <br/> |0x1003  <br/> |
