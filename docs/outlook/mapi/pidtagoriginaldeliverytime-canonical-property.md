...
Essa propriedade é copiada da propriedade original **PR_MESSAGE_DELIVERY_TIME** ([PidTagMessageDeliveryTime](pidtagmessagedeliverytime-canonical-property.md)) em operações subsequentes de resposta ou encaminhamento e usada em relatórios lidos e não lidos. Relatórios de entrega usam a **PR_DELIVER_TIME** ([PidTagDeliverTime](pidtagdelivertime-canonical-property.md)) em vez disso.
