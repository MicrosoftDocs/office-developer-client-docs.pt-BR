...
Essa propriedade é definida com base no valor **PR_SENSITIVITY** ([PidTagSensitivity](pidtagsensitivity-canonical-property.md)) da mensagem de email. Se **PR_SENSITIVITY** estiver definido como "0x00000000" (normal) ou "0x00000003" (confidencial), essa propriedade deverá ser definida como "0x00" ou ausente, o que significa que a adição de destinatários adicionais ou diferentes à mensagem de email é permitida. Se o **PR_SENSITIVITY** do objeto de email estiver definido como "0x00000001" (pessoal) ou "0x00000002" (privado), essa propriedade deverá ser definida como "0x01" para impedir a adição de destinatários adicionais ou diferentes desse email através de encaminhamento. 
