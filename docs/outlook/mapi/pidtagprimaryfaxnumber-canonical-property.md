...
Contém o número de telefone do aparelho de fax principal do destinatário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_PRIMARY_FAX_NUMBER, PR_PRIMARY_FAX_NUMBER_A, PR_PRIMARY_FAX_NUMBER_W  <br/> |
|Identificador:  <br/> |0x3A23  <br/> |
