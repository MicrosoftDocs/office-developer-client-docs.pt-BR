...
O servidor deve preservar o valor dessa propriedade se tiver sido definido pelo cliente. O servidor deve ignorá-lo durante a avaliação e o processamento da regra.
