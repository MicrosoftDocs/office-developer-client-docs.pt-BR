...
Essa propriedade é usada para mensagens de encaminhamento automático. Ele contém uma estrutura [FLATENTRYLIST](flatentrylist.md) de destinatários alternativos. Se o encaminhamento não for permitido ou se nenhum destinatário alternativo tiver sido designado, um relatório de não entrega será gerado. 
