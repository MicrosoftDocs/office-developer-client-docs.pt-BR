...
Contém a nova senha a ser usada para acesso futuro ao armazenamento de pastas pessoais.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_PST_PW_SZ_NEW, PR_PST_PW_SZ_NEW_A, PR_PST_PW_SZ_NEW_W  <br/> |
|Identificador:  <br/> |0x6704  <br/> |
