...
Contém uma lista delimitada por ponto-e-vírgula de endereços de email e domínios que representam os destinatários confiáveis.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_SPAM_TRUSTED_RECIPIENTS_W  <br/> |
