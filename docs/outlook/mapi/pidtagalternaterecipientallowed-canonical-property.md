...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_ALTERNATE_RECIPIENT_ALLOWED  <br/> |
...
Se o encaminhamento automático não for permitido ou se nenhum destinatário alternativo tiver sido designado, um relatório de não entrega deverá ser gerado. 
