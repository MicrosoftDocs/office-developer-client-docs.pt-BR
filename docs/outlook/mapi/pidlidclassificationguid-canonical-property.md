...
Especifica um identificador global exclusivo (GUID) de uma classificação de mensagem existente.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidClassGuid  <br/> |
|Propriedade definida:  <br/> |PSETID_Common  <br/> |
|ID de longo (LID):  <br/> |0x000085B8  <br/> |
