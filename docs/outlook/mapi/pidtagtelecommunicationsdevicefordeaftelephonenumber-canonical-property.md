...
---
# <a name="pidtagtelecommunicationsdevicefordeaftelephonenumber-canonical-property"></a>Propriedade canônico de PidTagTelecommunicationsDeviceForDeafTelephoneNumber

  
  
**Aplica-se a**: Outlook 
  
Contém os dispositivos de telecomunicações de mensagens do usuário para o número de telefone auditiva (TTYTDD).
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_TTYTDD_PHONE_NUMBER, PR_TTYTDD_PHONE_NUMBER_A, PR_TTYTDD_PHONE_NUMBER_W  <br/> |
|Identificador:  <br/> |0x3A4B  <br/> |
