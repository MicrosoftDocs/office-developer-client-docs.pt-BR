...
Contém a URL do protocolo de transferência de arquivo (FTP) do contato. O FTP é um protocolo usado para transferir dados, conforme especificado em [RFC959].
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_FTP_SITE, PR_FTP_SITE_A, PR_FTP_SITE_W  <br/> |
|Identificador:  <br/> |0x3A4C  <br/> |
