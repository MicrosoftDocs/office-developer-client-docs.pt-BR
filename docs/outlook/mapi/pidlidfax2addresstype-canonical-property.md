---
title: Propriedade canônico de PidLidFax2AddressType
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "19768410"
---
# <a name="pidlidfax2addresstype-canonical-property"></a>Propriedade canônico de PidLidFax2AddressType

  
  
**Aplica-se a**: Outlook 
  
Especifica o tipo de endereço para o endereço de fax residencial do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidFax2AddrType  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x000080C2  <br/> |
