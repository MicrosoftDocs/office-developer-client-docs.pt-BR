...
Contém TRUE se o cliente solicita um campo de header X-MS-Exchange-Organization-AutoForwarded.
...
Se essa propriedade for definida como FALSE ou não for usada, nenhum campo de header X-MS-Exchange-Organization-AutoForwarded será criado.
