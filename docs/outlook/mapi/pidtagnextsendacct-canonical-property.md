...
Especifica o servidor que um cliente está tentando usar no momento para enviar emails.
...
O formato dessa propriedade depende da implementação. Essa propriedade pode ser usada pelo cliente para determinar para qual servidor direcionar o email, mas é opcional e o valor não tem significado para o servidor.
