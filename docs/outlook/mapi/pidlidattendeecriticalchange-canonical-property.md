...
Especifica a data e a hora em que o objeto relacionado à reunião foi enviado.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |LID_ATTENDEE_CRITICAL_CHANGE  <br/> |
...
O valor deve ser especificado em UTC (Tempo Universal Coordenado).
