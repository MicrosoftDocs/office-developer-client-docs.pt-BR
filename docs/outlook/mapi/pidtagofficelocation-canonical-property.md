...
---
# <a name="pidtagofficelocation-canonical-property"></a>Propriedade canônica PidTagOfficeLocation

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém o local do escritório do destinatário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_OFFICE_LOCATION, PR_OFFICE_LOCATION_A, PR_OFFICE_LOCATION_W  <br/> |
|Identificador:  <br/> |0x3A19  <br/> |
