...
Contém o identificador de entrada da pasta que contém uma pasta ou uma mensagem.
...
Esta propriedade é calculada por repositórios de mensagens para todas as pastas e mensagens.
  
Para uma pasta raiz do repositório de mensagens, essa propriedade contém o próprio identificador de entrada da pasta.
  
 **PR_PARENT_DISPLAY** ([PidTagParentDisplay](pidtagparentdisplay-canonical-property.md)) e essa propriedade não está relacionada entre si. Eles pertencem a contextos totalmente diferentes.
...
> Especifica o método de fornecimento de dados do catálogo de endereços offline (OAB) do servidor para o cliente.
