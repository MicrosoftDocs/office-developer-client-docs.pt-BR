...
Contém uma cópia dos tipos de informações codificadas originais (EITs) para o texto da mensagem.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_ORIGINAL_EITS  <br/> |
|Identificador:  <br/> |0x0021  <br/> |
