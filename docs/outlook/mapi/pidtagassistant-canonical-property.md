...
ms.locfileid: "22574913"
---
# <a name="pidtagassistant-canonical-property"></a>Propriedade canônica PidTagAssistant

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém o nome do assistente administrativo do destinatário. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_ASSISTANT, PR_ASSISTANT_A, PR_ASSISTANT_W  <br/> |
|Identificador:  <br/> |0x3A30  <br/> |
...
[Propriedade canônica PidTagAssistantTelephoneNumber](pidtagassistanttelephonenumber-canonical-property.md)
