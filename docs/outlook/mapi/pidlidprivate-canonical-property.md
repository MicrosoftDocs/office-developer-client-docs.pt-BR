...
Indica se o usuário final deseja que esse objeto de mensagem fique oculto de outros usuários que têm acesso ao objeto Message.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidPrivate  <br/> |
