...
As regras são avaliadas em sequência de acordo com a ordem crescente desse valor. A ordem de avaliação para regras que têm o mesmo valor nessa propriedade é indefinida.
