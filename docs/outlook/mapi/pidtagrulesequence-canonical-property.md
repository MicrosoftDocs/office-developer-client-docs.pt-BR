...
Regras são avaliadas na sequência de acordo com a ordem crescente desse valor. A ordem de avaliação de regras que têm o mesmo valor desta propriedade é indefinida.
