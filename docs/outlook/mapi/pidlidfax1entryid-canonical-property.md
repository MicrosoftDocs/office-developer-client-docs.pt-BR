...
---
# <a name="pidlidfax1entryid-canonical-property"></a>Propriedade canônica PidLidFax1EntryId

  
  
**Aplica-se a**: Outlook 
  
Especifica a EntryID do endereço de fax comercial do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidFax1EntryID  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x000080B1  <br/> |
