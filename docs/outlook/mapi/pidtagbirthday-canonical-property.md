...
Essa propriedade é uma das propriedades que fornece acesso a informações sobre um contato e identificação. Essas propriedades são definidas pelo usuário e a organização do usuário. 
