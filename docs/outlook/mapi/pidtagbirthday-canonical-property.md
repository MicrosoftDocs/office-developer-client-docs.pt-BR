...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_BIRTHDAY  <br/> |
|Identificador:  <br/> |0x3A42  <br/> |
|Tipo de dados:  <br/> |PT_SYSTIME  <br/> |
|Área:  <br/> |Contato  <br/> |
   
## <a name="remarks"></a>Comentários

Esta propriedade é uma das propriedades que fornece informações de identificação e acesso sobre um contato. Essas propriedades são definidas pelo usuário e pela organização do usuário. 
