...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_RECEIPT_TIME  <br/> |
...
Essa propriedade deve ser definida pelo provedor de armazenamento de mensagens que recebe a mensagem original e gera o relatório. 
