...
Contém o identificador de entrada original de uma entrada copiada de um livro de endereços para um livro de endereços pessoal ou outro livro de endereços que pode ser escrito.
