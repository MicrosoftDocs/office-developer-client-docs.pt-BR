...
Especifica se uma solicitação de reunião deverá ser enviada como uma mensagem iCal.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidSendMtgAsICAL  <br/> |
|Conjunto de propriedades:  <br/> |PSETID_Appointment  <br/> |
|Long ID (LID):  <br/> |0x00008200  <br/> |
|Tipo de dados:  <br/> |PT_BOOLEAN  <br/> |
|Área:  <br/> |Conferências  <br/> |
