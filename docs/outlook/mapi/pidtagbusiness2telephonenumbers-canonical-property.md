...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_BUSINESS2_TELEPHONE_NUMBER_A_MV  <br/> |
|Identificador:  <br/> |0x3A1B  <br/> |
|Tipo de dados:  <br/> |PT_MV_STRING8  <br/> |
|Área:  <br/> |Contato  <br/> |
   
## <a name="remarks"></a>Comentários

Essa propriedade pode ser usada para listar números de telefone alternativos ou uma lista de extensões para uma empresa.
