...
---
# <a name="pidlidtaskglobalid-canonical-property"></a>Propriedade canônica PidLidTaskGlobalId

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Localiza uma tarefa existente, usando um GUID, mediante o recebimento de uma resposta de tarefa ou atualização de tarefa.
...
Essa propriedade é deixada sem atribuições para tarefas não atribuídas.
