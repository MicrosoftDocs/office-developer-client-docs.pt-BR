...
|ID de longo (LID):  <br/> |0x00008A03  <br/> |
|Tipo de dados:  <br/> |PT_UNICODE  <br/> |
|Área:  <br/> |Sharing  <br/> |
   
## <a name="remarks"></a>Comentários

Essa propriedade é geralmente usada para fornecer mais informações sobre o provedor de compartilhamento, mas deve ser ignorada.
