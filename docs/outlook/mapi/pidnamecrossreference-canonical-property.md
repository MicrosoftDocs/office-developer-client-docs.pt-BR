...
Contém um valor de campo de header Xref [RFC3282].
...
Para definir o valor dessa propriedade, os clientes MIME (Multipurpose Internet Message Extensions) devem gravar o valor desejado em um campo de header XRef. Os leitores MIME devem copiar o valor de um campo de header XRef para o valor dessa propriedade.
