...
---
# <a name="pidtagproofofdelivery-canonical-property"></a>Propriedade canônico de PidTagProofOfDelivery
...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_PROOF_OF_DELIVERY  <br/> |
|Identificador:  <br/> |0x0C11  <br/> |
