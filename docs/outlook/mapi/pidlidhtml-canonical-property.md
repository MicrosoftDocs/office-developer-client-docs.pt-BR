...
Especifica a URL da página da Web comercial do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidHTML  <br/> |
...
O valor dessa propriedade, se presente, deve ser o mesmo que o valor da propriedade **PR_BUSINESS_HOME_PAGE** ([PidTagBusinessHomePage](pidtagbusinesshomepage-canonical-property.md)) .
