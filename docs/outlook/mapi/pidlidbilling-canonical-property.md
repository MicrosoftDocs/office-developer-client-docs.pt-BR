...
---
# <a name="pidlidbilling-canonical-property"></a>Propriedade canônica PidLidBilling

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém as informações de cobrança associadas a um item.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidBilling  <br/> |
