...
Essas propriedades são exemplos das propriedades de endereço base comuns a todos os usuários de mensagens. Ele especifica qual sistema de mensagens MAPI usa para lidar com uma determinada mensagem.
  
Essa propriedade também determina o formato da cadeia de caracteres de endereço no **PR_EMAIL_ADRESS** ([PidTagEmailAddress](pidtagemailaddress-canonical-property.md)). A cadeia de caracteres que ele fornece pode conter somente os caracteres alfabéticos em maiúsculas de A a Z e os números de 0 a 9.
  
Exemplos válidos para a cadeia de caracteres incluem: 
