...
Especifica o nome para exibição do endereço de fax comercial de um contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidFax1DisplayName  <br/> |
|Conjunto de propriedades:  <br/> |PSETID_Address  <br/> |
|Long ID (LID):  <br/> |0x000080B0  <br/> |
