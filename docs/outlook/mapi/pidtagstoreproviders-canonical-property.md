...
Contém uma lista de identificadores de provedores de armazenamento de mensagens no perfil atual.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_STORE_PROVIDERS  <br/> |
|Identificador:  <br/> |0x3D00  <br/> |
