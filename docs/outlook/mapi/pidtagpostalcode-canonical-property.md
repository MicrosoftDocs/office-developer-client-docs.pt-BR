...
Contém o código postal do endereço postal do destinatário.
...
O código postal é específico para o país/região do destinatário. Nos Estados Unidos da América, esta propriedade contém o CEP.
