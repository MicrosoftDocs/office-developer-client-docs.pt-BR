...
A [função RTFSync](rtfsync.md) calcula a contagem de caracteres no texto usando apenas aqueles que considera significativos para a mensagem. Por exemplo, alguns espaços em branco e outros caracteres ignoráveis são omitidos da contagem. 
