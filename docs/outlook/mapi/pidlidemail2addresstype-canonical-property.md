...
---
# <a name="pidlidemail2addresstype-canonical-property"></a>Propriedade canônico de PidLidEmail2AddressType
...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidEmail2AddrType  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x00008092  <br/> |
