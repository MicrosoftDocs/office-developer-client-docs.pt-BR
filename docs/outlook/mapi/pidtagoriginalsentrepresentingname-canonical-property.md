...
Estes exemplos de propriedades das propriedades de endereço para o remetente original representado de uma mensagem. Ele é usado em um thread de conversa.
  
Um aplicativo cliente enviando uma mensagem em nome de outro cliente deve definir essas propriedades com o valor da propriedade **PR_SENT_REPRESENTING_NAME** ([PidTagSentRepresentingName](pidtagsentrepresentingname-canonical-property.md)) no primeiro envio da mensagem. Uma vez definido, ele nunca deve ser alterado.
