...
O conteúdo específico de cada campo do BLOB (objeto binário grande) contido nessa propriedade depende do ID de modelo especificado na propriedade **PidTagSearchFolderTemplateId** ([PidTagSearchFolderTemplateId](pidtagsearchfoldertemplateid-canonical-property.md)). Para obter informações sobre a estrutura de BLOB e modelos de pesquisa, consulte [[MS-OXOSRCH]](https://msdn.microsoft.com/library/c72e49b8-78c7-4483-ad65-e46e9133673b%28Office.15%29.aspx). 
