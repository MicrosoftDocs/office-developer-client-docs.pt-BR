...
---
# <a name="pidtagisdnnumber-canonical-property"></a>Propriedade canônica PidTagIsdnNumber

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém o número de telefone com capacidade para ISDN do destinatário. 
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_ISDN_NUMBER, PR_ISDN_NUMBER_A, PR_ISDN_NUMBER_W  <br/> |
|Identificador:  <br/> |0x3A2D  <br/> |
