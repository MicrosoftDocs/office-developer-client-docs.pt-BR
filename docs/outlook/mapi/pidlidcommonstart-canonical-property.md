...
Essa propriedade indica a hora de início de um item. Ele deve ser menor ou igual ao valor da **propriedade dispidCommonEnd** ([PidLidCommonEnd](pidlidcommonend-canonical-property.md)).
  
O valor dessa propriedade deve ser equivalente ao Tempo Universal Coordenado (UTC) da propriedade **dispidTaskStartDate** ([PidLidTaskStartDate](pidlidtaskstartdate-canonical-property.md)).
