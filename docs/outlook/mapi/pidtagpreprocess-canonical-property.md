...
---
# <a name="pidtagpreprocess-canonical-property"></a>Propriedade canônica PidTagPreprocess

  
  
**Aplica-se a**: Outlook 2013 | Outlook 2016 
  
Contém TRUE se a mensagem requer pré-processamento.
...
[Propriedade canônica PidTagSubmitFlags](pidtagsubmitflags-canonical-property.md)
