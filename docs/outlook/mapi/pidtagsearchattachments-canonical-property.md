...
Contém uma cadeia de caracteres Unicode que está sendo consultada no conteúdo do anexo no armazenamento.
...
> [!NOTE]
> Essa marca de restrição MAPI, usada quando você está procurando conteúdo de anexo, pode não ser definida no arquivo de título baixável que você tem no momento. Você pode adicioná-lo ao seu código usando o seguinte valor: >  `#define PR_SEARCH_ATTACHMENTS_W PROP_TAG(PT_UNICODE, 0x0EA5)`
