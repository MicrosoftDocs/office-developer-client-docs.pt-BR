---
title: Propriedade canônica PidTagHomeAddressStreet
manager: soliver
ms.date: 03/09/2015
...
Contém a parte da rua do endereço de um usuário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_HOME_ADDRESS_STREET, PR_HOME_ADDRESS_STREET_A, PR_HOME_ADDRESS_STREET_W  <br/> |
|Identificador:  <br/> |0x3A5D  <br/> |
