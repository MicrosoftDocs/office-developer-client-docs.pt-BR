...
Obtém o identificador de entrada de longo prazo de um item.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_LONGTERM_ENTRYID_FROM_TABLE  <br/> |
|Identificador:  <br/> |0x6670  <br/> |
|Tipo de dados:  <br/> |PT_BINARY  <br/> |
|Área:  <br/> |Propriedades da tabela  <br/> |
