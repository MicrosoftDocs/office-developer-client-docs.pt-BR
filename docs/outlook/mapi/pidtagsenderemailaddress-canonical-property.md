...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_SENDER_EMAIL_ADDRESS, PR_SENDER_EMAIL_ADDRESS_A, PR_SENDER_EMAIL_ADDRESS_W  <br/> |
|Identificador:  <br/> |0x0C1F  <br/> |
|Tipo de dados:  <br/> |PT_UNICOIDE, PT_STRING8  <br/> |
|Área:  <br/> |Endereço  <br/> |
   
## <a name="remarks"></a>Comentários

Essas propriedades são exemplos das propriedades de endereço do remetente da mensagem. Eles devem ser definidos pelo provedor de transporte de saída, que nunca deve propagar valores existentes anteriormente.
