...
MAPI espera que todos os clientes possam exibir, criar, modificar e excluir pastas em uma subárvore IPM. Suporte para trabalhar com pastas em outras árvores será considerado opcional. No entanto, todos os repositórios de mensagem que pode ser usado como o armazenamento padrão e que podem enviar e receber mensagens totalmente devem oferecer suporte a pastas ocultas.
