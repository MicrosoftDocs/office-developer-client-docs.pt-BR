...
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |LID_WHERE  <br/> |
|Propriedade definida:  <br/> |PSETID_Meeting  <br/> |
|ID de longo (LID):  <br/> |0x00000002  <br/> |
|Tipo de dados:  <br/> |PT_UNICODE  <br/> |
|Área:  <br/> |Reuniões  <br/> |
   
## <a name="remarks"></a>Comentários

O valor dessa propriedade deve ser o mesmo que o valor da propriedade **dispidLocation** ([PidLidLocation](pidlidlocation-canonical-property.md)) da reunião associada.
