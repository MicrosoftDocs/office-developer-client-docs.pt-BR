...
Contém TRUE se um agente de transferência de mensagem (MTA) estiver proibido de expandir listas de distribuição.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |PR_DL_EXPANSION_PROHIBITED  <br/> |
