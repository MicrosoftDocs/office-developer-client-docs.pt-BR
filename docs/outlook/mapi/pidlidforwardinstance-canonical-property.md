...
Indica que a solicitação de reunião representa uma exceção a uma série recorrente e foi encaminhada (mesmo quando encaminhada pelo organizador) em vez de ser um convite enviado pelo organizador.
...
Um valor FALSE para esta propriedade indica que a solicitação de reunião não é uma instância encaminhada. Esta propriedade não é obrigatória.
