...
2. Se * * IMsgStore:: GetReceiveFolder * * for bem-sucedido, use a referência à EntryID **** da caixa de entrada e [IMsgStore:: OpenEntry](imsgstore-openentry.md) para abrir a caixa de entrada e obter uma referência a um objeto **IMAPIFolder** . 
