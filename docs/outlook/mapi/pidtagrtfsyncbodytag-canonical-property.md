...
A [função RTFSync](rtfsync.md) usa a marca de texto para indicar o início do texto da mensagem. Quando o texto é modificado, a marca é usada para encontrar o início do texto anterior. 
  
Essas propriedades são propriedades auxiliares do Formato Rich Text. Eles são usados pela **função RTFSync** e não se destinam a ser usados diretamente por aplicativos cliente. 
