...
ms.locfileid: "19768504"
---
# <a name="pidlidinstantmessagingaddress-canonical-property"></a>Propriedade canônica PidLidInstantMessagingAddress

  
  
**Aplica-se a**: Outlook 
  
Especifica o endereço de mensagens instantâneas do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidInstMsg  <br/> |
|Propriedade definida:  <br/> |PSETID_Address  <br/> |
|ID de longo (LID):  <br/> |0x00008062  <br/> |
