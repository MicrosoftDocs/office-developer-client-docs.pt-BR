...
Contém metadados sobre o diário.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidLogFlags  <br/> |
...
O campo de bits que contém metadados sobre o diário deve ser zero ou "0x40000000".
