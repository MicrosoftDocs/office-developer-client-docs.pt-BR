...
Contém TRUE se um armazenamento de mensagens é o armazenamento de mensagens padrão na tabela do armazenamento de mensagens. 
...
Essa propriedade aparece como uma coluna na tabela do armazenamento de mensagens. O valor é baseado **em PR_RESOURCE_FLAGS** ([PidTagResourceFlags](pidtagresourceflags-canonical-property.md)). 
