...
Especifica a pronúncia phoneética do nome da empresa do contato.
  
|||
|:-----|:-----|
|Propriedades associadas:  <br/> |dispidYomiCompanyName  <br/> |
|Conjunto de propriedades:  <br/> |PSETID_Address  <br/> |
|Long ID (LID):  <br/> |0x0000802E  <br/> |
