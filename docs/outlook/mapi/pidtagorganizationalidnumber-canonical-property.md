...
Contém um número de identificação organizacional do contato, como um número de ID de funcionário.
...
São propriedades opcionais. O uso é determinado pelo usuário de mensagens ou pela organização.
