...
No exemplo de código a seguir, o procedimento GetDefaultMessageClass usa o **PropertyAccessor** para determinar o formulário padrão de uma pasta. Se a propriedade de pasta **PR \_ DEF \_ POST \_ MSGCLASS** [(PidTagDefaultPostMessageClass)](https://msdn.microsoft.com/library/cc815305\(v=office.15\)) não for encontrada e o Outlook criar um erro, **tente... catch** block returns the **DefaultMessageClass** property for the **Folder**.
