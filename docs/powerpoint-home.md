...
> [!NOTE]
> Interessado em desenvolver soluções que ampliem a experiência do Office em [várias plataformas](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-in-availability)? Confira o novo [modelo de Suplementos do Office](https://docs.microsoft.com/office/dev/add-ins/). 
  
### <a name="viewed-most"></a>Mais vistos
  
- [Referência do VBA do PowerPoint](https://docs.microsoft.com/office/vba/api/overview/powerpoint)
...
- [Introdução aos suplementos do PowerPoint](https://docs.microsoft.com/office/dev/add-ins/quickstarts/powerpoint-quickstart?tabs=visual-studio)
  
- [Visão geral da plataforma](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Exemplos de código
  
- [Exemplos de código do PowerPoint no Centro de Desenvolvimento do Office](https://developer.microsoft.com/office/gallery/?filterBy=Samples,PowerPoint)
