...
<span data-ttu-id="4f1a4-111">A ID de classe está atualmente definida responda apenas a OneDrive.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-111">The class ID is currently set to respond only to OneDrive.</span></span>
...
##### <a name="return-values"></a><span data-ttu-id="4f1a4-140">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-140">Return values</span></span>
...
<span data-ttu-id="4f1a4-164">Identifica qual evento última foi processado pelo consumidor.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-164">Identifies which event was last processed by the consumer.</span></span> 
 ...
 <span data-ttu-id="4f1a4-165">_pnCurrentChangesToken_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-165">_pnCurrentChangesToken_</span></span>
...
##### <a name="parameters"></a><span data-ttu-id="4f1a4-206">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-206">Parameters</span></span>
 ...
 <span data-ttu-id="4f1a4-207">_bstrResourceID_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-207">_bstrResourceID_</span></span>
...
|<span data-ttu-id="4f1a4-234">E_LSC_NOTINITIALIZED</span><span class="sxs-lookup"><span data-stu-id="4f1a4-234">E_LSC_NOTINITIALIZED</span></span>  <br/> |<span data-ttu-id="4f1a4-235">[ILSCLocalSyncClient::Initialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) não tiver sido chamado com êxito no passado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-235">[ILSCLocalSyncClient::Initialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) has not been successfully called in the past.</span></span>  <br/> |
...
#### <a name="ilsclocalsyncclientinitialize"></a><span data-ttu-id="4f1a4-258">ILSCLocalSyncClient::Initialize</span><span class="sxs-lookup"><span data-stu-id="4f1a4-258">ILSCLocalSyncClient::Initialize</span></span>
...
<span data-ttu-id="4f1a4-270">Identifica o objeto de COM do consumidor para comunicação bidirecional.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-270">Identifies the consumer's COM object for two-way communication.</span></span> <span data-ttu-id="4f1a4-271">Deve ser não vazias com um máximo de 39 caracteres.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-271">Must be non-empty with a maximum of 39 characters.</span></span> <span data-ttu-id="4f1a4-272">Consulte [ \<ProgID\> chave](https://docs.microsoft.com/windows/desktop/com/-progid--key) para obter mais informações sobre ProgIDs.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-272">See [\<ProgID\> Key](https://docs.microsoft.com/windows/desktop/com/-progid--key) for more information about ProgIDs.</span></span> 
 ...
 <span data-ttu-id="4f1a4-273">_bstrFileSystemDirectoryHint_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-273">_bstrFileSystemDirectoryHint_</span></span>
...
<span data-ttu-id="4f1a4-313">Uma cadeia de caracteres que identifica o ResourceID do arquivo.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-313">A string which identifies the ResourceID of the file.</span></span> <span data-ttu-id="4f1a4-314">Este valor deve ser não vazias com um máximo de 128 caracteres.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-314">This value must be non-empty with a maximum of 128 characters.</span></span> 
 ...
 <span data-ttu-id="4f1a4-315">_bstrWebPath_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-315">_bstrWebPath_</span></span>
...
|<span data-ttu-id="4f1a4-340">E_LSC_NOTINITIALIZED</span><span class="sxs-lookup"><span data-stu-id="4f1a4-340">E_LSC_NOTINITIALIZED</span></span>  <br/> |<span data-ttu-id="4f1a4-341">[ILSCLocalSyncClient::Initialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) não tiver sido chamado com êxito no passado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-341">[ILSCLocalSyncClient::Initialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) has not been successfully called in the past.</span></span>  <br/> |
...
<span data-ttu-id="4f1a4-363">Uma cadeia de caracteres que especifica a nova URL para o arquivo.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-363">A string which specifies the new URL for the file.</span></span> <span data-ttu-id="4f1a4-364">Este valor deve ser um URL válido do não vazias, mas não tenha mais de INTERNET_MAX_URL_LENGTH, conforme definido pela https://support.microsoft.com/kb/208427.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-364">This value must be non-empty valid URL, but no longer than INTERNET_MAX_URL_LENGTH, as defined by https://support.microsoft.com/kb/208427.</span></span> 
...
|<span data-ttu-id="4f1a4-438">E_LSC_LOCALPATHNOTMAPPED</span><span class="sxs-lookup"><span data-stu-id="4f1a4-438">E_LSC_LOCALPATHNOTMAPPED</span></span>  <br/> |<span data-ttu-id="4f1a4-439">O FileSystemPath determinado não está sob o diretório raiz especificado pelo FileSystemDirectoryHint quando a chamada para inicializar foi feita.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-439">The given FileSystemPath is not under the directory root specified by the FileSystemDirectoryHint when the call to Initialize was made.</span></span>  <br/> |
...
|:-----|:-----|
|<span data-ttu-id="4f1a4-460">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="4f1a4-460">E_FAIL</span></span>  <br/> |<span data-ttu-id="4f1a4-461">Falha para definir o estado de conectividade do cache.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-461">Failure to set the cache connectivity state.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-462">E_INVALIDARG</span><span class="sxs-lookup"><span data-stu-id="4f1a4-462">E_INVALIDARG</span></span>  <br/> |<span data-ttu-id="4f1a4-463">Um ou mais parâmetros são inválidos.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-463">One or more parameters are invalid.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-464">E_LSC_NOINITIALIZED</span><span class="sxs-lookup"><span data-stu-id="4f1a4-464">E_LSC_NOINITIALIZED</span></span>  <br/> |<span data-ttu-id="4f1a4-465">[ILSCLocalSyncClient::Initialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) não tiver sido chamado com êxito no passado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-465">[ILSCLocalSyncClient::Initialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) has not been successfully called in the past.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-466">S_OK</span><span class="sxs-lookup"><span data-stu-id="4f1a4-466">S_OK</span></span>  <br/> |<span data-ttu-id="4f1a4-467">A chamada foi bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-467">The call succeeded.</span></span>  <br/> |
   
#### <a name="ilsclocalsyncclientsetclientnetworksyncpermission"></a><span data-ttu-id="4f1a4-468">ILSCLocalSyncClient::SetClientNetworkSyncPermission</span><span class="sxs-lookup"><span data-stu-id="4f1a4-468">ILSCLocalSyncClient::SetClientNetworkSyncPermission</span></span>
<span data-ttu-id="4f1a4-469"><a name="ILSCLocalSyncClient_ServerFileChange"> </a></span><span class="sxs-lookup"><span data-stu-id="4f1a4-469"></span></span>

<span data-ttu-id="4f1a4-470">SetClientNetworkSyncPermission é usado para qualquer substituição ou heurística de sincronização do restoreOffice para uso de custo e alimentação de rede.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-470">SetClientNetworkSyncPermission is used to either override or restoreOffice's synchronizing heuristics for network cost and power usage.</span></span> <span data-ttu-id="4f1a4-471">Quando em um 3G ou outra rede de alto custo, ou quando executando em bateria versus sendo conectado, o Office pode optar por bloquear o tráfego de rede até um momento mais oportunidade.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-471">When on a 3G or other high cost network, or when running on battery versus being plugged in, Office may choose to block network traffic until a more opportune time.</span></span> <span data-ttu-id="4f1a4-472">O consumidor desse API pode ser usada para substituir heurística do Office e forçar sincronizando para que ela ocorra.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-472">The consumer of this API can use it to override Office's heuristics and force synchronizing to occur.</span></span>
  
`HRESULT ILSCLocalSyncClient::SetClientNetworkSyncPermission ([in] LSCNetworkSyncPermissionType nspType, [in] VARIANT_BOOL fEnableSync)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-473">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-473">Parameters</span></span>

 <span data-ttu-id="4f1a4-474">_nspType_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-474">_nspType_</span></span>
  
<span data-ttu-id="4f1a4-475">Um sinalizador que define qual heurístico custo substituir.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-475">A flag which defines which cost heuristic to override.</span></span> <span data-ttu-id="4f1a4-476">Consulte [Enum LSCNetworkSyncPermissionType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCNetworkSyncPermissionType).</span><span class="sxs-lookup"><span data-stu-id="4f1a4-476">See [Enum LSCNetworkSyncPermissionType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCNetworkSyncPermissionType).</span></span>
  
 <span data-ttu-id="4f1a4-477">_fEnableSync_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-477">_fEnableSync_</span></span>
  
<span data-ttu-id="4f1a4-478">Especifica se é para forçar a sincronização on, substituindo assim que heurístico custo ou não são mais substituí-la.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-478">Specifies whether to force synchronizing on, thus overriding that cost heuristic, or to no longer override it.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-479">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-479">Return values</span></span>

|<span data-ttu-id="4f1a4-480">Valor</span><span class="sxs-lookup"><span data-stu-id="4f1a4-480">Value</span></span>|<span data-ttu-id="4f1a4-481">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-481">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-482">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="4f1a4-482">E_FAIL</span></span>  <br/> |<span data-ttu-id="4f1a4-483">Falha ao substituir heurísticos de sincronização.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-483">Failure to override synchronizing heuristics.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-484">E_LSC_NOINITIALIZED</span><span class="sxs-lookup"><span data-stu-id="4f1a4-484">E_LSC_NOINITIALIZED</span></span>  <br/> |<span data-ttu-id="4f1a4-485">[ILSCLocalSyncClient::Initialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) não tiver sido chamado com êxito no passado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-485">[ILSCLocalSyncClient::Initialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) has not been successfully called in the past.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-486">S_OK</span><span class="sxs-lookup"><span data-stu-id="4f1a4-486">S_OK</span></span>  <br/> |<span data-ttu-id="4f1a4-487">A chamada foi bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-487">The call succeeded.</span></span>  <br/> |
   
#### <a name="ilsclocalsyncclientuninitialize"></a><span data-ttu-id="4f1a4-488">ILSCLocalSyncClient::Uninitialize</span><span class="sxs-lookup"><span data-stu-id="4f1a4-488">ILSCLocalSyncClient::Uninitialize</span></span>
<span data-ttu-id="4f1a4-489"><a name="ILSCLocalSyncClient_Uninitialize"> </a></span><span class="sxs-lookup"><span data-stu-id="4f1a4-489"></span></span>

<span data-ttu-id="4f1a4-490">Descarrega o cache do objeto COM e realizar operações de fechamento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-490">Unloads the cache from the COM object and perform closing operations.</span></span> <span data-ttu-id="4f1a4-491">[ILSCLocalSyncClient::Uninitialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Uninitialize) DEVE ser chamado antes destruir o objeto COM.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-491">[ILSCLocalSyncClient::Uninitialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Uninitialize) MUST be called before destroying the COM object.</span></span> <span data-ttu-id="4f1a4-492">Depois que a chamada, outras APIs não pode ser chamados, o objeto COM deve ser destruído e um novo criada se você desejar operações contínuas.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-492">Once called, no other APIs can be called, the COM object MUST be destroyed and a new one created if you wish to continue operations.</span></span> 
  
`HRESULT ILSCLocalSyncClient::Uninitialize ()`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-493">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-493">Parameters</span></span>

<span data-ttu-id="4f1a4-494">Nenhum.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-494">None.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-495">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-495">Return values</span></span>

|<span data-ttu-id="4f1a4-496">Valor</span><span class="sxs-lookup"><span data-stu-id="4f1a4-496">Value</span></span>|<span data-ttu-id="4f1a4-497">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-497">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-498">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="4f1a4-498">E_FAIL</span></span>  <br/> |<span data-ttu-id="4f1a4-499">Falha para reverter a.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-499">Failure to uninitialize.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-500">E_LSC_NOINITIALIZED</span><span class="sxs-lookup"><span data-stu-id="4f1a4-500">E_LSC_NOINITIALIZED</span></span>  <br/> |<span data-ttu-id="4f1a4-501">[ILSCLocalSyncClient::Initialize](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) não tiver sido chamado com êxito no passado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-501">[ILSCLocalSyncClient::Initialize ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_Initialize) has not been successfully called in the past.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-502">S_OK</span><span class="sxs-lookup"><span data-stu-id="4f1a4-502">S_OK</span></span>  <br/> |<span data-ttu-id="4f1a4-503">A chamada foi bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-503">The call succeeded.</span></span>  <br/> |
   
### <a name="interface-ienumlscevent"></a><span data-ttu-id="4f1a4-504">Interface IEnumLSCEvent</span><span class="sxs-lookup"><span data-stu-id="4f1a4-504">Interface IEnumLSCEvent</span></span>

<span data-ttu-id="4f1a4-505">Essa interface representa uma lista de eventos ILSCEvent.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-505">This interface represents a list of ILSCEvent events.</span></span>
  
<span data-ttu-id="4f1a4-506">**Funções de membro público**</span><span class="sxs-lookup"><span data-stu-id="4f1a4-506">**Public member functions**</span></span>

#### <a name="ienumlsceventfnext"></a><span data-ttu-id="4f1a4-507">IEnumLSCEvent::FNext</span><span class="sxs-lookup"><span data-stu-id="4f1a4-507">IEnumLSCEvent::FNext</span></span>

<span data-ttu-id="4f1a4-508">Recupera o próximo evento da lista de eventos.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-508">Retrieves the next event from the list of events.</span></span>
  
`HRESULT IEnumLSCEvent::FNext ([out] ILSCEvent ** ppiLSCEvent)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-509">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-509">Parameters</span></span>

 <span data-ttu-id="4f1a4-510">_ppiLSCEvent_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-510">_ppiLSCEvent_</span></span>
  
<span data-ttu-id="4f1a4-511">Um ponteiro para uma interface ILSCEvent.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-511">A pointer to an ILSCEvent interface.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-512">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-512">Return values</span></span>

|<span data-ttu-id="4f1a4-513">Valor</span><span class="sxs-lookup"><span data-stu-id="4f1a4-513">Value</span></span>|<span data-ttu-id="4f1a4-514">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-514">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-515">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="4f1a4-515">E_FAIL</span></span>  <br/> |<span data-ttu-id="4f1a4-516">Não existem mais eventos.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-516">There are no more events.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-517">S_OK</span><span class="sxs-lookup"><span data-stu-id="4f1a4-517">S_OK</span></span>  <br/> |<span data-ttu-id="4f1a4-518">A chamada foi bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-518">The call was successful.</span></span>  <br/> |
   
#### <a name="ienumlsceventreset"></a><span data-ttu-id="4f1a4-519">IEnumLSCEvent::Reset</span><span class="sxs-lookup"><span data-stu-id="4f1a4-519">IEnumLSCEvent::Reset</span></span>

<span data-ttu-id="4f1a4-520">Redefine o enumerador para o primeiro evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-520">Resets the enumerator to the first event.</span></span>
  
`HRESULT IEnumLSCEvent::Reset ()`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-521">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-521">Parameters</span></span>

<span data-ttu-id="4f1a4-522">Nenhum.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-522">None.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-523">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-523">Return values</span></span>

<span data-ttu-id="4f1a4-524">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-524">Always returns S_OK.</span></span> 
  
### <a name="interface-ilscevent"></a><span data-ttu-id="4f1a4-525">Interface ILSCEvent</span><span class="sxs-lookup"><span data-stu-id="4f1a4-525">Interface ILSCEvent</span></span>

<span data-ttu-id="4f1a4-526">Essa interface representa um evento de sincronização.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-526">This interface represents a synchronizing event.</span></span> <span data-ttu-id="4f1a4-527">Todas as informações sobre o evento podem ser recuperadas da interface.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-527">All information about the event can be retrieved from the interface.</span></span>
  
<span data-ttu-id="4f1a4-528">**Funções de membro público**</span><span class="sxs-lookup"><span data-stu-id="4f1a4-528">**Public member functions**</span></span>

#### <a name="ilsceventgetconflictstatus"></a><span data-ttu-id="4f1a4-529">ILSCEvent::GetConflictStatus</span><span class="sxs-lookup"><span data-stu-id="4f1a4-529">ILSCEvent::GetConflictStatus</span></span>

<span data-ttu-id="4f1a4-530">Observe que esse valor é preenchido quando [ILSCLocalSyncClient::GetChanges](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetChanges) é chamado, não quando o evento tiver sido criado, portanto você terá somente o status atual do arquivo, não o status do arquivo quando o status de conflito alterado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-530">Note that this value is populated when [ILSCLocalSyncClient::GetChanges ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetChanges) is called, not when the event was created, so you will only have the current status of the file, not the status of the file when the conflict status changed.</span></span> 
  
<span data-ttu-id="4f1a4-531">Esse valor é preenchido somente quando o [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) do evento é LSCEventType_OnLocalConflictStateChanged.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-531">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnLocalConflictStateChanged.</span></span> 
  
`HRESULT ILSCEvent::GetConflictStatus ([out] VARIANT_BOOL * pfIsInConflict)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-532">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-532">Parameters</span></span>

 <span data-ttu-id="4f1a4-533">_pfIsInConflict_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-533">_pfIsInConflict_</span></span>
  
<span data-ttu-id="4f1a4-534">O status atual de conflito do arquivo associado ao evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-534">The current conflict status of the file associated with the event.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-535">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-535">Return values</span></span>

<span data-ttu-id="4f1a4-536">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-536">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgeterror"></a><span data-ttu-id="4f1a4-537">ILSCEvent::GetError</span><span class="sxs-lookup"><span data-stu-id="4f1a4-537">ILSCEvent::GetError</span></span>

<span data-ttu-id="4f1a4-538">Esse valor é preenchido somente quando o [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) do evento é LSCEventType_OnServerChangesDownloaded ou LSCEventType_OnLocalChangesUploaded.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-538">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnServerChangesDownloaded or LSCEventType_OnLocalChangesUploaded.</span></span> 
  
`HRESULT ILSCEvent::GetError ([out] LONG * pnError)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-539">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-539">Parameters</span></span>

 <span data-ttu-id="4f1a4-540">_pnError_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-540">_pnError_</span></span>
  
<span data-ttu-id="4f1a4-541">O erro associado ao evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-541">The error associated with this event.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-542">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-542">Return values</span></span>

<span data-ttu-id="4f1a4-543">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-543">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgetetag"></a><span data-ttu-id="4f1a4-544">ILSCEvent::GetETag</span><span class="sxs-lookup"><span data-stu-id="4f1a4-544">ILSCEvent::GetETag</span></span>

<span data-ttu-id="4f1a4-545">Esse valor é preenchido somente quando o [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) do evento é LSCEventType_OnServerChangesDownloaded ou LSCEventType_OnLocalChangesUploaded.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-545">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnServerChangesDownloaded or LSCEventType_OnLocalChangesUploaded.</span></span> 
  
`HRESULT ILSCEvent::GetETag ([out] BSTR * pbstrETag)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-546">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-546">Parameters</span></span>

 <span data-ttu-id="4f1a4-547">_pbstrETag_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-547">_pbstrETag_</span></span>
  
<span data-ttu-id="4f1a4-548">A ETag associada ao evento</span><span class="sxs-lookup"><span data-stu-id="4f1a4-548">The ETag associated with this event</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-549">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-549">Return values</span></span>

<span data-ttu-id="4f1a4-550">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-550">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgeteventtype"></a><span data-ttu-id="4f1a4-551">ILSCEvent::GetEventType</span><span class="sxs-lookup"><span data-stu-id="4f1a4-551">ILSCEvent::GetEventType</span></span>

<span data-ttu-id="4f1a4-552">Obtém o tipo para este evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-552">Gets the type for this event.</span></span>
  
`HRESULT ILSCEvent::GetEventType ([out] LSCEventType * pnEventType)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-553">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-553">Parameters</span></span>

 <span data-ttu-id="4f1a4-554">_pnEventType_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-554">_pnEventType_</span></span>
  
<span data-ttu-id="4f1a4-555">O tipo de evento desse evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-555">The event type of this event.</span></span> <span data-ttu-id="4f1a4-556">Consulte [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) para valores válidos.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-556">See [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) for valid values.</span></span> <span data-ttu-id="4f1a4-557">Não deve ser nula.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-557">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-558">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-558">Return values</span></span>

|<span data-ttu-id="4f1a4-559">Valor</span><span class="sxs-lookup"><span data-stu-id="4f1a4-559">Value</span></span>|<span data-ttu-id="4f1a4-560">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-560">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-561">E_INVALIDARG</span><span class="sxs-lookup"><span data-stu-id="4f1a4-561">E_INVALIDARG</span></span>  <br/> |<span data-ttu-id="4f1a4-562">Um ou mais parâmetros são inválidos.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-562">One or more parameters are invalid.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-563">S_OK</span><span class="sxs-lookup"><span data-stu-id="4f1a4-563">S_OK</span></span>  <br/> |<span data-ttu-id="4f1a4-564">A chamada foi bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-564">The call was successful.</span></span>  <br/> |
   
#### <a name="ilsceventgetlocalworkingpath"></a><span data-ttu-id="4f1a4-565">ILSCEvent::GetLocalWorkingPath</span><span class="sxs-lookup"><span data-stu-id="4f1a4-565">ILSCEvent::GetLocalWorkingPath</span></span>

<span data-ttu-id="4f1a4-566">Obtém o caminho local de trabalho para este evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-566">Gets the local working path for this event.</span></span>
  
`HRESULT ILSCEvent::GetLocalWorkingPath ([out] BSTR * pbstrLocalWorkingPath)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-567">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-567">Parameters</span></span>

 <span data-ttu-id="4f1a4-568">_pbstrLocalWorkingPath_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-568">_pbstrLocalWorkingPath_</span></span>
  
<span data-ttu-id="4f1a4-569">O caminho local do arquivo para o qual esse evento pertence.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-569">The local path of the file to which this event pertains.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-570">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-570">Return values</span></span>

<span data-ttu-id="4f1a4-571">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-571">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgetresourceid"></a><span data-ttu-id="4f1a4-572">ILSCEvent::GetResourceID</span><span class="sxs-lookup"><span data-stu-id="4f1a4-572">ILSCEvent::GetResourceID</span></span>

<span data-ttu-id="4f1a4-573">Obtém a identificação do recurso para o evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-573">Gets the resource ID for the event.</span></span>
  
`HRESULT ILSCEvent::GetResourceID ([out] BSTR * pbstrResourceID)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-574">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-574">Parameters</span></span>

 <span data-ttu-id="4f1a4-575">_pbstrResourceID_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-575">_pbstrResourceID_</span></span>
  
<span data-ttu-id="4f1a4-576">ResourceID do arquivo associado ao evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-576">The ResourceID of the file associated with this event.</span></span>
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-577">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-577">Return values</span></span>

<span data-ttu-id="4f1a4-578">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-578">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgetresourceidattempted"></a><span data-ttu-id="4f1a4-579">ILSCEvent::GetResourceIDAttempted</span><span class="sxs-lookup"><span data-stu-id="4f1a4-579">ILSCEvent::GetResourceIDAttempted</span></span>

<span data-ttu-id="4f1a4-580">Esse valor é preenchido somente quando o [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) do evento é LSCEventType_OnFilePathConflict.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-580">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnFilePathConflict.</span></span> <span data-ttu-id="4f1a4-581">Quando uma chamada para [ILSCLocalSyncClient::LocalFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_LocalFileChange), [ILSCLocalSyncClient::ServerFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_ServerFileChange)ou [ILSCLocalSyncClient::RenameFile](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_RenameFile) pode causar um conflito de caminho da Web ou caminho Local com outro arquivo no cache de arquivo do Office, isso evento ser gerado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-581">When a call to [ILSCLocalSyncClient::LocalFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_LocalFileChange), [ILSCLocalSyncClient::ServerFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_ServerFileChange), or [ILSCLocalSyncClient::RenameFile ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_RenameFile) would cause a Web Path or Local Path collision with another file in the Office file cache, this event is generated.</span></span> 
  
`HRESULT ILSCEvent::GetResourceIDAttempted ([out] BSTR * pbstrResourceIDAttempted)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-582">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-582">Parameters</span></span>

 <span data-ttu-id="4f1a4-583">_pbstrResourceIDAttempted_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-583">_pbstrResourceIDAttempted_</span></span>
  
<span data-ttu-id="4f1a4-584">O ResourceID que gerou esse evento obter gerado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-584">The ResourceID that caused this event to get generated.</span></span> <span data-ttu-id="4f1a4-585">Não deve ser nula.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-585">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-586">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-586">Return values</span></span>

<span data-ttu-id="4f1a4-587">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-587">Always returns S_OK.</span></span> 
  
#### <a name="ilsceventgetsyncerrortype"></a><span data-ttu-id="4f1a4-588">ILSCEvent::GetSyncErrorType</span><span class="sxs-lookup"><span data-stu-id="4f1a4-588">ILSCEvent::GetSyncErrorType</span></span>

<span data-ttu-id="4f1a4-589">Esse valor é preenchido somente quando o [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) do evento é LSCEventType_OnServerChangesDownloaded ou LSCEventType_OnLocalChangesUploaded.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-589">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnServerChangesDownloaded or LSCEventType_OnLocalChangesUploaded.</span></span> 
  
`HRESULT ILSCEvent::GetSyncErrorType ([out] LSCEventSyncErrorType * pnSyncErrorType)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-590">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-590">Parameters</span></span>

 <span data-ttu-id="4f1a4-591">_pnSyncErrorType_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-591">_pnSyncErrorType_</span></span>
  
<span data-ttu-id="4f1a4-592">O tipo de erro associado ao evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-592">The error type associated with this event.</span></span> <span data-ttu-id="4f1a4-593">Consulte [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) para os valores possíveis.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-593">See [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) for potential values.</span></span> <span data-ttu-id="4f1a4-594">Não deve ser nula.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-594">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-595">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-595">Return values</span></span>

|<span data-ttu-id="4f1a4-596">Valor</span><span class="sxs-lookup"><span data-stu-id="4f1a4-596">Value</span></span>|<span data-ttu-id="4f1a4-597">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-597">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-598">E_INVALIDARG</span><span class="sxs-lookup"><span data-stu-id="4f1a4-598">E_INVALIDARG</span></span>  <br/> |<span data-ttu-id="4f1a4-599">Um ou mais parâmetros são inválidos.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-599">One or more parameters are invalid.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-600">S_OK</span><span class="sxs-lookup"><span data-stu-id="4f1a4-600">S_OK</span></span>  <br/> |<span data-ttu-id="4f1a4-601">A chamada foi bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-601">The call was successful.</span></span>  <br/> |
   
#### <a name="ilsceventgetwebpath"></a><span data-ttu-id="4f1a4-602">ILSCEvent::GetWebPath</span><span class="sxs-lookup"><span data-stu-id="4f1a4-602">ILSCEvent::GetWebPath</span></span>

<span data-ttu-id="4f1a4-603">Esse valor é preenchido somente quando o [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) do evento é LSCEventType_OnFilePathConflict.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-603">This value is only populated when the [Enum LSCEventType](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventType) of the event is LSCEventType_OnFilePathConflict.</span></span> 
  
`HRESULT ILSCEvent::GetWebPath ([out] BSTR * pbstrWebPath)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-604">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-604">Parameters</span></span>

 <span data-ttu-id="4f1a4-605">_pbstrWebPath_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-605">_pbstrWebPath_</span></span>
  
<span data-ttu-id="4f1a4-606">Especifica o caminho da Web associado ao evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-606">Specifies the Web Path associated with this event.</span></span> <span data-ttu-id="4f1a4-607">Não deve ser nula.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-607">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-608">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-608">Return values</span></span>

<span data-ttu-id="4f1a4-609">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-609">Always returns S_OK.</span></span> 
  
### <a name="interface-ilscevent2"></a><span data-ttu-id="4f1a4-610">Interface ILSCEvent2</span><span class="sxs-lookup"><span data-stu-id="4f1a4-610">Interface ILSCEvent2</span></span>

<span data-ttu-id="4f1a4-611">Essa interface contém informações adicionais sobre um evento de sincronização.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-611">This interface holds additional information about a synchronizing event.</span></span>
  
<span data-ttu-id="4f1a4-612">**Funções de membro público**</span><span class="sxs-lookup"><span data-stu-id="4f1a4-612">**Public member functions**</span></span>

#### <a name="ilscevent2geterrorchain"></a><span data-ttu-id="4f1a4-613">ILSCEvent2::GetErrorChain</span><span class="sxs-lookup"><span data-stu-id="4f1a4-613">ILSCEvent2::GetErrorChain</span></span>

<span data-ttu-id="4f1a4-614">Obtém as informações de cadeia de erro sobre um evento de sincronização.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-614">Gets the error chain information about a synchronizing event.</span></span>
  
`HRESULT ILSCEvent2::GetErrorChain ([out] BSTR * pbstrErrorChain)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-615">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-615">Parameters</span></span>

 <span data-ttu-id="4f1a4-616">_pbstrErrorChain_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-616">_pbstrErrorChain_</span></span>
  
<span data-ttu-id="4f1a4-617">Uma cadeia de caracteres para armazenar as informações de cadeia de erro.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-617">A string to hold the error chain information.</span></span> <span data-ttu-id="4f1a4-618">Não deve ser nula.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-618">Must not be null.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-619">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-619">Return values</span></span>

|<span data-ttu-id="4f1a4-620">Valor</span><span class="sxs-lookup"><span data-stu-id="4f1a4-620">Value</span></span>|<span data-ttu-id="4f1a4-621">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-621">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-622">E_NOTIMPL</span><span class="sxs-lookup"><span data-stu-id="4f1a4-622">E_NOTIMPL</span></span>  <br/> |<span data-ttu-id="4f1a4-623">A versão instalada do Office não oferece suporte a essa interface</span><span class="sxs-lookup"><span data-stu-id="4f1a4-623">The installed version of Office does not support this interface</span></span>  <br/> |
|<span data-ttu-id="4f1a4-624">E_INVALIDARG</span><span class="sxs-lookup"><span data-stu-id="4f1a4-624">E_INVALIDARG</span></span>  <br/> |<span data-ttu-id="4f1a4-625">Um ou mais dos valores de parâmetro são inválidos.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-625">One or more of the parameter values are invalid.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-626">E_FAIL</span><span class="sxs-lookup"><span data-stu-id="4f1a4-626">E_FAIL</span></span>  <br/> |<span data-ttu-id="4f1a4-627">As informações de cadeia de erro não estão disponíveis.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-627">The error chain information is not available.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-628">S_OK</span><span class="sxs-lookup"><span data-stu-id="4f1a4-628">S_OK</span></span>  <br/> |<span data-ttu-id="4f1a4-629">A chamada foi bem-sucedida.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-629">The call was successful.</span></span>  <br/> |
   
### <a name="interface-ipartneractivitycallback"></a><span data-ttu-id="4f1a4-630">Interface IPartnerActivityCallback</span><span class="sxs-lookup"><span data-stu-id="4f1a4-630">Interface IPartnerActivityCallback</span></span>

<span data-ttu-id="4f1a4-631">Essa interface fornece uma função de retorno de chamada para o objeto COM CSISyncClient.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-631">This interface provides a callback function to the CSISyncClient COM object.</span></span>
  
<span data-ttu-id="4f1a4-632">**Funções de membro público**</span><span class="sxs-lookup"><span data-stu-id="4f1a4-632">**Public member functions**</span></span>

#### <a name="ipartneractivitycallbackeventoccurred"></a><span data-ttu-id="4f1a4-633">IPartnerActivityCallback::EventOccurred</span><span class="sxs-lookup"><span data-stu-id="4f1a4-633">IPartnerActivityCallback::EventOccurred</span></span>

<span data-ttu-id="4f1a4-634">Essa é uma função de retorno de chamada no objeto dado ao objeto CsiSyncClient COM.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-634">This is a callback function on the object given to the CsiSyncClient COM object.</span></span> <span data-ttu-id="4f1a4-635">Espera-se que, quando ocorre um evento (consulte [Enum LSCEventTypeOccurred](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventTypeOccurred) para tipos de evento válidos), o objeto CsiSyncClient COM chamará este método, o consumidor de sinalização.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-635">It's expected that when an Event occurs (see [Enum LSCEventTypeOccurred](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventTypeOccurred) for valid event types), the CsiSyncClient COM object will call this method, signalling the consumer.</span></span> 
  
`HRESULT IPartnerActivityCallback::EventOccurred ([in] LSCEventTypeOccurred eEventTypeOccurred)`

##### <a name="parameters"></a><span data-ttu-id="4f1a4-636">Parâmetros</span><span class="sxs-lookup"><span data-stu-id="4f1a4-636">Parameters</span></span>

 <span data-ttu-id="4f1a4-637">_eEventTypeOccurred_</span><span class="sxs-lookup"><span data-stu-id="4f1a4-637">_eEventTypeOccurred_</span></span>
  
<span data-ttu-id="4f1a4-638">O tipo de evento desse evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-638">The event type of this event.</span></span> <span data-ttu-id="4f1a4-639">Consulte [Enum LSCEventTypeOccurred](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventTypeOccurred) para valores válidos.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-639">See [Enum LSCEventTypeOccurred](using-csisyncclient-to-control-the-office-document-cache-odc.md#Enum_LSCEventTypeOccurred) for valid values.</span></span> 
  
##### <a name="return-values"></a><span data-ttu-id="4f1a4-640">Valores de retorno</span><span class="sxs-lookup"><span data-stu-id="4f1a4-640">Return values</span></span>

<span data-ttu-id="4f1a4-641">Sempre retorna S_OK.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-641">Always returns S_OK.</span></span>
  
## <a name="enumerations"></a><span data-ttu-id="4f1a4-642">Enumerações</span><span class="sxs-lookup"><span data-stu-id="4f1a4-642">Enumerations</span></span>

<span data-ttu-id="4f1a4-643">CSISyncClient usa as enumerações a seguir.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-643">CSISyncClient uses the following enumerations.</span></span>
  
### <a name="enum-lsceventsyncerrortype"></a><span data-ttu-id="4f1a4-644">Enumeração LSCEventSyncErrorType</span><span class="sxs-lookup"><span data-stu-id="4f1a4-644">Enum LSCEventSyncErrorType</span></span>
<span data-ttu-id="4f1a4-645"><a name="Enum_LSCEventSyncErrorType"> </a></span><span class="sxs-lookup"><span data-stu-id="4f1a4-645"></span></span>

<span data-ttu-id="4f1a4-646">Essa enumeração Especifica as categorias de erros que podem ocorrer durante a sincronização de um arquivo.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-646">This enumeration specifies the categories of errors that can occur while synchronizing a file.</span></span>
  
|<span data-ttu-id="4f1a4-647">Enumerador</span><span class="sxs-lookup"><span data-stu-id="4f1a4-647">Enumerator</span></span>|<span data-ttu-id="4f1a4-648">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-648">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-649">LSCEventSyncErrorType_UserInterventionRequiredUnexpected</span><span class="sxs-lookup"><span data-stu-id="4f1a4-649">LSCEventSyncErrorType_UserInterventionRequiredUnexpected</span></span>  <br/> |<span data-ttu-id="4f1a4-650">O erro de sincronização desse evento era esperado e pode exigir uma consideração especial.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-650">The synchronizing error of this event was unexpected, and may require special consideration.</span></span> <span data-ttu-id="4f1a4-651">Por padrão, o usuário pode ter de intervir.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-651">By default, the user may have to intervene.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-652">LSCEventSyncErrorType_NoInterventionRequired</span><span class="sxs-lookup"><span data-stu-id="4f1a4-652">LSCEventSyncErrorType_NoInterventionRequired</span></span>  <br/> |<span data-ttu-id="4f1a4-653">O erro de sincronização desse evento não precisa consideração especial.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-653">The synchronizing error of this event does not need special consideration.</span></span> <span data-ttu-id="4f1a4-654">Office manipulará-lo automaticamente.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-654">Office will handle it automatically.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-655">LSCEventSyncErrorType_UserInterventionRequired</span><span class="sxs-lookup"><span data-stu-id="4f1a4-655">LSCEventSyncErrorType_UserInterventionRequired</span></span>  <br/> |<span data-ttu-id="4f1a4-656">O erro de sincronização desse evento exige que um usuário resolvê-lo.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-656">The synchronizing error of this event requires a user to resolve it.</span></span> <span data-ttu-id="4f1a4-657">Por exemplo, o erro de conflito de mesclagem requer um usuário abrir o documento e mesclar a ele.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-657">For example, merge conflict error requires a user to open the document and merge it.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-658">LSCEventSyncErrorType_WaitingOnClient</span><span class="sxs-lookup"><span data-stu-id="4f1a4-658">LSCEventSyncErrorType_WaitingOnClient</span></span>  <br/> |<span data-ttu-id="4f1a4-659">O erro de sincronização desse evento exige que o consumidor intervir, mas não deve exigir uma consideração especial pelo usuário.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-659">The synchronizing error of this event requires the consumer to intervene, but should not require special consideration by the user.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-660">LSCEventSyncErrorType_ClientInterventionRequired</span><span class="sxs-lookup"><span data-stu-id="4f1a4-660">LSCEventSyncErrorType_ClientInterventionRequired</span></span>  <br/> |<span data-ttu-id="4f1a4-661">O erro de sincronização desse evento requer o consumidor intervir como um caso especial.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-661">The synchronizing error of this event requires the consumer to intervene as a special case.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-662">LSCEventSyncErrorType_Max</span><span class="sxs-lookup"><span data-stu-id="4f1a4-662">LSCEventSyncErrorType_Max</span></span>  <br/> ||
   
### <a name="enum-lsceventtype"></a><span data-ttu-id="4f1a4-663">Enumeração LSCEventType</span><span class="sxs-lookup"><span data-stu-id="4f1a4-663">Enum LSCEventType</span></span>
<span data-ttu-id="4f1a4-664"><a name="Enum_LSCEventType"> </a></span><span class="sxs-lookup"><span data-stu-id="4f1a4-664"></span></span>

<span data-ttu-id="4f1a4-665">Essa enumeração Especifica o tipo de eventos que podem ocorrer para um arquivo específico.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-665">This enumeration specifies the type of events that can occur for a particular file.</span></span>
  
|<span data-ttu-id="4f1a4-666">Enumerador</span><span class="sxs-lookup"><span data-stu-id="4f1a4-666">Enumerator</span></span>|<span data-ttu-id="4f1a4-667">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-667">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-668">LSCEventType_None</span><span class="sxs-lookup"><span data-stu-id="4f1a4-668">LSCEventType_None</span></span>  <br/> ||
|<span data-ttu-id="4f1a4-669">LSCEventType_OnLocalChanges</span><span class="sxs-lookup"><span data-stu-id="4f1a4-669">LSCEventType_OnLocalChanges</span></span>  <br/> |<span data-ttu-id="4f1a4-670">Foram feitas alterações em um arquivo local.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-670">Changes were made to a local file.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-671">LSCEventType_OnOpenedByUser</span><span class="sxs-lookup"><span data-stu-id="4f1a4-671">LSCEventType_OnOpenedByUser</span></span>  <br/> |<span data-ttu-id="4f1a4-672">Um usuário abre um arquivo.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-672">A user opened a file.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-673">LSCEventType_OnServerChangesDownloaded</span><span class="sxs-lookup"><span data-stu-id="4f1a4-673">LSCEventType_OnServerChangesDownloaded</span></span>  <br/> |<span data-ttu-id="4f1a4-674">Download de alterações no arquivo do servidor concluído.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-674">Finished downloading file changes from the server.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-675">LSCEventType_OnLocalChangesUploaded</span><span class="sxs-lookup"><span data-stu-id="4f1a4-675">LSCEventType_OnLocalChangesUploaded</span></span>  <br/> |<span data-ttu-id="4f1a4-676">Concluir a carregar alterações no arquivo para o servidor.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-676">Finished uploading file changes to the server.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-677">LSCEventType_OnLocalConflictStateChanged</span><span class="sxs-lookup"><span data-stu-id="4f1a4-677">LSCEventType_OnLocalConflictStateChanged</span></span>  <br/> |<span data-ttu-id="4f1a4-678">O estado de conflito de mesclagem de um arquivo foi alterada.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-678">The merge conflict state of a file has changed.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-679">LSCEventType_OnFileAdded</span><span class="sxs-lookup"><span data-stu-id="4f1a4-679">LSCEventType_OnFileAdded</span></span>  <br/> |<span data-ttu-id="4f1a4-680">Um arquivo foi adicionado.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-680">A file was added.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-681">LSCEventType_OnFileDeleted</span><span class="sxs-lookup"><span data-stu-id="4f1a4-681">LSCEventType_OnFileDeleted</span></span>  <br/> |<span data-ttu-id="4f1a4-682">Um arquivo foi excluído.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-682">A file was deleted.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-683">LSCEventType_OnSyncEnabled</span><span class="sxs-lookup"><span data-stu-id="4f1a4-683">LSCEventType_OnSyncEnabled</span></span>  <br/> |<span data-ttu-id="4f1a4-684">Sincronizando foi habilitado para arquivos do usuário.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-684">Synchronizing was enabled for a user's files.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-685">LSCEventType_OnServerChangesDownloadStarted</span><span class="sxs-lookup"><span data-stu-id="4f1a4-685">LSCEventType_OnServerChangesDownloadStarted</span></span>  <br/> |<span data-ttu-id="4f1a4-686">Iniciado o download de alterações de arquivo do servidor.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-686">Started downloading file changes from the server.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-687">LSCEventType_OnLocalChangesUploadStarted</span><span class="sxs-lookup"><span data-stu-id="4f1a4-687">LSCEventType_OnLocalChangesUploadStarted</span></span>  <br/> |<span data-ttu-id="4f1a4-688">Iniciado carregar alterações no arquivo para o servidor.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-688">Started uploading file changes to the server.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-689">LSCEventType_OnFilePathConflict</span><span class="sxs-lookup"><span data-stu-id="4f1a4-689">LSCEventType_OnFilePathConflict</span></span>  <br/> |<span data-ttu-id="4f1a4-690">Esse evento é gerado quando uma chamada para [ILSCLocalSyncClient::LocalFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_LocalFileChange), [ILSCLocalSyncClient::ServerFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_ServerFileChange), ou [ILSCLocalSyncClient::RenameFile](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_RenameFile) faz com que um conflito de caminho da Web ou caminho Local com outro arquivo no Cache de arquivos do Office.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-690">This event is generated when a call to [ILSCLocalSyncClient::LocalFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_LocalFileChange), [ILSCLocalSyncClient::ServerFileChange ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_ServerFileChange), or [ILSCLocalSyncClient::RenameFile ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_RenameFile) causes a Web Path or Local Path collision with another file in the Office file cache.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-691">LSCEventType_OnFileForked</span><span class="sxs-lookup"><span data-stu-id="4f1a4-691">LSCEventType_OnFileForked</span></span>  <br/> ||
|<span data-ttu-id="4f1a4-692">LSCEventType_Max</span><span class="sxs-lookup"><span data-stu-id="4f1a4-692">LSCEventType_Max</span></span>  <br/> ||
   
### <a name="enum-lsceventtypeoccurred"></a><span data-ttu-id="4f1a4-693">Enumeração LSCEventTypeOccurred</span><span class="sxs-lookup"><span data-stu-id="4f1a4-693">Enum LSCEventTypeOccurred</span></span>
<span data-ttu-id="4f1a4-694"><a name="Enum_LSCEventTypeOccurred"> </a></span><span class="sxs-lookup"><span data-stu-id="4f1a4-694"></span></span>

<span data-ttu-id="4f1a4-695">Essa enumeração Especifica o tipo de eventos que podem ocorrer.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-695">This enumeration specifies the type of events that can occur.</span></span> <span data-ttu-id="4f1a4-696">O consumidor precisa chamar funções específicas de ILSCLocalSyncClient com base no tipo de evento.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-696">The consumer needs to call specific ILSCLocalSyncClient functions based on the event type.</span></span>
  
|<span data-ttu-id="4f1a4-697">Enumerador</span><span class="sxs-lookup"><span data-stu-id="4f1a4-697">Enumerator</span></span>|<span data-ttu-id="4f1a4-698">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-698">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-699">LSCEventTypeOccurred_GetChanges</span><span class="sxs-lookup"><span data-stu-id="4f1a4-699">LSCEventTypeOccurred_GetChanges</span></span>  <br/> |<span data-ttu-id="4f1a4-700">Ocorreu uma ILSCEvent.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-700">An ILSCEvent has occurred.</span></span> <span data-ttu-id="4f1a4-701">O consumidor deve chamar [ILSCLocalSyncClient::GetChanges](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetChanges) para recuperar os dados.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-701">The consumer should call [ILSCLocalSyncClient::GetChanges ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetChanges) to retrieve the data.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-702">LSCEventTypeOccurred_GetSupportedFileExtensions</span><span class="sxs-lookup"><span data-stu-id="4f1a4-702">LSCEventTypeOccurred_GetSupportedFileExtensions</span></span>  <br/> |<span data-ttu-id="4f1a4-703">As extensões de arquivo com suporte foram alteradas.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-703">The supported file extensions have changed.</span></span> <span data-ttu-id="4f1a4-704">O consumidor deve chamar [ILSCLocalSyncClient::GetSupportedFileExtensions](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetSupportedFileExtensions) para recuperar a nova lista de extensões aceitas.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-704">The consumer should call [ILSCLocalSyncClient::GetSupportedFileExtensions ](using-csisyncclient-to-control-the-office-document-cache-odc.md#ILSCLocalSyncClient_GetSupportedFileExtensions) to retrieve the new list of supported extensions.</span></span>  <br/> |
   
### <a name="enum-lscnetworksyncpermissiontype"></a><span data-ttu-id="4f1a4-705">Enumeração LSCNetworkSyncPermissionType</span><span class="sxs-lookup"><span data-stu-id="4f1a4-705">Enum LSCNetworkSyncPermissionType</span></span>
<span data-ttu-id="4f1a4-706"><a name="Enum_LSCNetworkSyncPermissionType"> </a></span><span class="sxs-lookup"><span data-stu-id="4f1a4-706"></span></span>

<span data-ttu-id="4f1a4-707">Essa enumeração Especifica os sinalizadores usados para uma heurística de custo de rede.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-707">This enumeration specifies the flags used for a network cost heuristic.</span></span> 

|<span data-ttu-id="4f1a4-708">Enumerador</span><span class="sxs-lookup"><span data-stu-id="4f1a4-708">Enumerator</span></span>|<span data-ttu-id="4f1a4-709">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-709">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-710">LSCNetworkSyncPermissionType_HighCost</span><span class="sxs-lookup"><span data-stu-id="4f1a4-710">LSCNetworkSyncPermissionType_HighCost</span></span>  <br/> |<span data-ttu-id="4f1a4-711">True se o heurístico custo para redes caros (por exemplo, 3G) será substituído.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-711">True if the cost heuristic for expensive networks (such as 3G) is overridden.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-712">LSCNetworkSyncPermissionType_HighPowerUsage</span><span class="sxs-lookup"><span data-stu-id="4f1a4-712">LSCNetworkSyncPermissionType_HighPowerUsage</span></span>  <br/> |<span data-ttu-id="4f1a4-713">True se o heurístico custo para o uso de energia (por exemplo, uma bateria) será substituído.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-713">True if the cost heuristic for power usage (such as a battery) is overridden.</span></span>  <br/> |
   
### <a name="enum-lscstatusflag"></a><span data-ttu-id="4f1a4-714">Enumeração LSCStatusFlag</span><span class="sxs-lookup"><span data-stu-id="4f1a4-714">Enum LSCStatusFlag</span></span>
<span data-ttu-id="4f1a4-715"><a name="Enum_LSCStatusFlag"> </a></span><span class="sxs-lookup"><span data-stu-id="4f1a4-715"></span></span>

<span data-ttu-id="4f1a4-716">Esta enumeração é usada para representar o status de sincronização de um arquivo.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-716">This enumeration is used to represent the synchronize status of a file.</span></span> 
  
|<span data-ttu-id="4f1a4-717">Enumerador</span><span class="sxs-lookup"><span data-stu-id="4f1a4-717">Enumerator</span></span>|<span data-ttu-id="4f1a4-718">Descrição</span><span class="sxs-lookup"><span data-stu-id="4f1a4-718">Description</span></span>|
|:-----|:-----|
|<span data-ttu-id="4f1a4-719">LCSStatusFlag_None</span><span class="sxs-lookup"><span data-stu-id="4f1a4-719">LCSStatusFlag_None</span></span>  <br/> ||
|<span data-ttu-id="4f1a4-720">LSCStatusFlag_UploadPending</span><span class="sxs-lookup"><span data-stu-id="4f1a4-720">LSCStatusFlag_UploadPending</span></span>  <br/> |<span data-ttu-id="4f1a4-721">True se não houver pendentes dados a serem enviados para o arquivo do servidor.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-721">True if there is pending data to send to the server file.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-722">LSCStatusFlag_DownloadPending</span><span class="sxs-lookup"><span data-stu-id="4f1a4-722">LSCStatusFlag_DownloadPending</span></span>  <br/> |<span data-ttu-id="4f1a4-723">True se não houver dados para fazer o download do arquivo server pendentes.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-723">True if there is pending data to download from the server file.</span></span>  <br/> |
|<span data-ttu-id="4f1a4-724">LSCStatusFlag_LocalFileUnchanged</span><span class="sxs-lookup"><span data-stu-id="4f1a4-724">LSCStatusFlag_LocalFileUnchanged</span></span>  <br/> |<span data-ttu-id="4f1a4-725">True se os dados do Office tem no arquivo no seu cache é a cópia mais recente dos dados no disco.</span><span class="sxs-lookup"><span data-stu-id="4f1a4-725">True if the data Office has on the file in its cache is the most recent copy of the data on disk.</span></span>  <br/> |
