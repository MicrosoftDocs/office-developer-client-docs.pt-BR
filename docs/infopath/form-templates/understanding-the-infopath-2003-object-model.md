...
Esta seção discute o modelo de objeto para soluções de código gerenciado do InfoPath e descreve tarefas de programação comuns.
  
## <a name="in-this-section"></a>Nesta seção

[Modelos de objeto compatíveis com o InfoPath 2003](infopath-2003-compatible-object-models.md)
  
> Fornece uma visão geral dos modelos de objeto usados nos projetos de código gerenciado do InfoPath.
...
> Descreve como acessar informações sobre o aplicativo InfoPath, o documento XML subjacente do formulário e o arquivo de definição de formulário (. xsf).
