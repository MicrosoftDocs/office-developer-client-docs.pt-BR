...
Esta seção fornece informações sobre tarefas e conceitos adicionais de desenvolvimento do InfoPath.
  
## <a name="in-this-section"></a>Nesta seção

[Sobre componentes de modelo de formulário](about-form-template-components.md)
...
> Descreve o uso de tecnologias XML em formulários do InfoPath.
...
> Descreve como trabalhar com arquivos de esquema XML em formulários do InfoPath.
    
[Usando XSLT personalizado em modelos de formulário do InfoPath](using-custom-xslt-in-infopath-form-templates.md)
  
> Descreve como modificar a XSL Transformation (XSLT) que o InfoPath usa para gerar um visualização em um formulário.
...
> Descreve como vincular um controle de caixa rich text a um elemento XML recuperado de um serviço Web.
...
[Criar um controle ActiveX que possa se vincular a dados de formulário do InfoPath](create-an-activex-control-that-can-bind-to-infopath-form-data.md)
  
> Fornece informações sobre como criar controles ActiveX que podem se vincular a dados de formulário do InfoPath.
    
[Habilitar a mesclaização personalizada de formulários do InfoPath](enable-custom-merging-of-infopath-forms.md)
