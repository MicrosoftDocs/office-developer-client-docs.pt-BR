...
---
# <a name="infopath-developer-reference-for-form-templates"></a><span data-ttu-id="97cf1-105">Referência do desenvolvedor do InfoPath para modelos de formulário</span><span class="sxs-lookup"><span data-stu-id="97cf1-105">InfoPath developer reference for form templates</span></span>

<span data-ttu-id="97cf1-p102">Bem-vindo à referência do desenvolvedor do InfoPath 2013 para modelos de formulário. Esta documentação fornece visões gerais, tarefas de programação e informações de referência da biblioteca de classes que foram concebidas para ajudar você a compilar modelos de formulários do InfoPath que contêm lógica corporativa escrita em Visual Basic ou Visual C#.</span><span class="sxs-lookup"><span data-stu-id="97cf1-p102">Welcome to the InfoPath 2013 developer reference for form templates. This documentation provides overviews, programming tasks, and class library reference information that is designed to help you build InfoPath form templates that contain business logic written in Visual Basic or Visual C#.</span></span>
  
<span data-ttu-id="97cf1-108">Data de publicação desta referência: Outubro 2012</span><span class="sxs-lookup"><span data-stu-id="97cf1-108">Publish date of this reference: October 2012</span></span>
...
[<span data-ttu-id="97cf1-114">Aviso de Privacidade do Microsoft Online</span><span class="sxs-lookup"><span data-stu-id="97cf1-114">Microsoft Online Privacy Notice</span></span>](http://privacy.microsoft.com/en-us/default.mspx)
