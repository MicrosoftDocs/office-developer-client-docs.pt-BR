...
O Microsoft InfoPath fornece automação de aplicativo do código escrito usando COM e script usando métodos do objeto **Application** e da **coleção XDocuments.** 
...
|**Method**|**Descrição**|
|:-----|:-----|
|**CacheSolution** <br/> |Examina o arquivo no cache e, se necessário, atualiza-o do local publicado do modelo de formulário.  <br/> |
|**Quit** <br/> |Sai do aplicativo Microsoft Office InfoPath.  <br/> |
