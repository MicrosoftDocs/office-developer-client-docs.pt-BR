...
---
# <a name="page-element-pages_type-complextype-visio-xml"></a>Elemento Page (Pages_Type complexType) (XML do Visio)
...
|:-----|:-----|:-----|
|[Pages](pages-elementvisio-xml.md) <br/> |[Pages_Type](pages_type-complextypevisio-xml.md) <br/> |Contém os **elementos Page** do documento.  <br/> |
   
### <a name="child-elements"></a>Elementos filho

|**Elemento**|**Tipo**|**Descrição**|
|:-----|:-----|:-----|
|[PageSheet](pagesheet-element-page_type-complextypevisio-xml.md) <br/> |[PageSheet_Type](pagesheet_type-complextypevisio-xml.md) <br/> |Contém elementos que definem a folha de página para um **elemento Page.**  <br/> |
   
### <a name="attributes"></a>Atributos

|**Atributo**|**Tipo**|**Obrigatório**|**Descrição**|**Valores possíveis**|
|:-----|:-----|:-----|:-----|:-----|
|Histórico  <br/> |xsd:boolean  <br/> |opcional  <br/> |Um sinalizador que indica se a página é uma página de plano de fundo.  <br/> |Valores do tipo xsd:boolean.  <br/> |
...
|ReviewerID  <br/> |xsd:unsignedInt  <br/> |opcional  <br/> |A ID do revistor associado à sobreposição de marcação.  <br/> |Valores do tipo xsd:unsignedInt.  <br/> |
...
|ViewCenterY  <br/> |xsd:double  <br/> |opcional  <br/> |**ViewCenterX** e **ViewCenterY** especificam um ponto central em uma página que um novo ponto de exibição (janela) assume quando ele é aberto inicialmente.  <br/> |Valores do tipo xsd:double.  <br/> |
