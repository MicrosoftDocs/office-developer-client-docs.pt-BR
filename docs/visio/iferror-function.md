...
Retorna o resultado avaliado de uma expressão primária, se ela não for avaliada como um erro. Caso contrário, retornará o valor avaliado de uma expressão alternativa.
...
SEERRO (* * *expressão primária* * *, * * *expressão alternativa* * *) 
