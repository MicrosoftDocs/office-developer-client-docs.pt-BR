...
---
# <a name="publishsettings-element-visiodocument_type-complextype-visio-xml"></a>Elemento PublishSettings (VisioDocument_Type complexType) (XML do Visio)
...
|**Elemento**|**Tipo**|**Descrição**|
|:-----|:-----|:-----|
|[PublishedPage](publishedpage-element-publishsettings_type-complextypevisio-xml.md) <br/> |[PublishedPage_Type](publishedpage_type-complextypevisio-xml.md) <br/> |Especifica se uma página de desenho pode ser visualizada no navegador usando o Serviços do Visio.  <br/> |
