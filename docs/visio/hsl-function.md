...
Retorna um valor que representa um índice na paleta de cores do documento. Ele especifica uma cor por seus componentes de matiz, saturação e luminosidade.
...
|:-----|:-----|:-----|:-----|
| _hue_ <br/> |Obrigatório  <br/> |**Número** <br/> |A matiz da cor, expressa como um número entre 0 e 239, inclusive, ou uma expressão que é avaliada neste número.  <br/> |
