...
---
# <a name="character_type-complextype-visio-xml"></a>Character_Type complexType (XML do Visio)
...
|:-----|:-----|:-----|
|[Linha](row-element-character-sectionvisio-xml.md) <br/> |[CharacterRow_Type](characterrow_type-complextypevisio-xml.md) <br/> ||
