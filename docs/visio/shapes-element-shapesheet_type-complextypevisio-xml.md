...
---
# <a name="shapes-element-shapesheettype-complextype-visio-xml"></a>Elemento de formas (ShapeSheet_Type complexType) ('Visio XML')
...
|:-----|:-----|:-----|
|[Shape](shape-element-shapes_type-complextypevisio-xml.md) <br/> |[ShapeSheet_Type](shapesheet_type-complextypevisio-xml.md) <br/> |Especifica um conjunto de propriedades associadas a uma forma.  <br/> |
