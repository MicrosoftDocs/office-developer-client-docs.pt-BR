...
|duas  <br/> |Número. Inclui valores de data, hora, duração e moeda, bem como grandezas escalares, dimensões e ângulos. Especifique uma figura de formatação na célula Format.  <br/> |**visPropTypeNumber** <br/> |
|3D  <br/> |Booliano. Exibe FALSE e TRUE como itens que podem ser selecionados pelo usuário na caixa de lista suspensa da caixa de diálogo **Definir Dados da Forma**.<br/> |**visPropTypeBool** <br/> |
...
|0,5  <br/> |Valor de data ou hora. Exibe dias, meses e anos ou segundos, minutos e horas ou, ainda, um valor combinado de data e hora. Especifique uma figura de formatação na célula Format.  <br/> |**visPropTypeDate** <br/> |
...
|178  <br/> |Valor de moeda. Utiliza as configurações regionais de moeda do sistema. Especifique uma figura de formatação na célula Format.  <br/> |**visPropTypeCurrency** <br/> |
...
|||
|:-----|:-----|
|Nome da célula:  <br/> |Hélice. *Nome* . Digite onde prop.  *Name* é o nome da linha  <br/> |
