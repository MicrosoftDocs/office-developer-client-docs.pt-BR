...
---
# <a name="yrulerdensity-cell-ruler-amp-grid-section"></a>Célula YRulerDensity (seção Ruler &amp; seção grade)
...
Para obter uma referência para a célula YRulerDensity pelo nome, a partir de outra fórmula ou programa que usa a propriedade **CellsU** , utilize: 
