...
---
# <a name="windows_type-complextype-visio-xml"></a>Windows_Type complexType (XML do Visio)
...
|:-----|:-----|:-----|:-----|:-----|
|ClientHeight  <br/> |xsd:unsignedShort  <br/> |opcional  <br/> ||Valores do tipo xsd:unsignedShort.  <br/> |
