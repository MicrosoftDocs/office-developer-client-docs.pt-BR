...
Retorna as  _coordenadas x,y_ de um ponto no sistema de coordenadas do pai da forma. 
...
|:-----|:-----|:-----|:-----|
| _point_ <br/> |Obrigatório  <br/> |**Número, Número** <br/> |As coordenadas do ponto do sistema de coordenadas da forma atual.  <br/> |
