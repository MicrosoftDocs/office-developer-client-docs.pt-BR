...
Essa célula corresponde à opção  Colar na caixa de  diálogo Propriedades  da Camada (na guia Início, no grupo Edição, clique em Camadas e em Propriedades da **Camada).**   
...
|Índice de célula:  <br/> |**visLayerGlue** <br/> |
