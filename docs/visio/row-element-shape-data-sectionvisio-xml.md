...
---
# <a name="row-element-shape-data-section-visio-xml"></a>Elemento Row (seção Shape Data) (' Visio XML ')

Especifica uma entrada de dados de forma para associar dados a uma forma.
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Especifica uma entrada de dados de forma para associar dados a uma forma.  <br/> |
   
### <a name="child-elements"></a>Elementos filho

|**Elemento**|**Tipo**|**Descrição**|
|:-----|:-----|:-----|
|[Cell](cell-element-shape-data-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |Especifica uma propriedade dos dados de forma.  <br/> |
