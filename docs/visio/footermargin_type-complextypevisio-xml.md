...
---
# <a name="footermargintype-complextype-visio-xml"></a>FooterMargin_Type complexType (' Visio XML ')
...
|:-----|:-----|:-----|:-----|:-----|
|Unit  <br/> |xsd:string  <br/> |opcional  <br/> ||Valores do tipo xsd:string.  <br/> |
