---
title: HeaderLeft_Type complexType (XML do Visio)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "34541054"
---
# <a name="headerleft_type-complextype-visio-xml"></a>HeaderLeft_Type complexType (XML do Visio)
