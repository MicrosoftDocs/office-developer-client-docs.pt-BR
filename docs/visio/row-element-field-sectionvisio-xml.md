...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Exibe as funções e fórmulas inseridas no texto da forma usando a caixa de diálogo Campo.  <br/> |
