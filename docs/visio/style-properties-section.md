...
---
# <a name="style-properties-section"></a>Seção Style Properties

Inclui as células que controlam o comportamento de estilo, como se o estilo inclui atributos de texto, de linha e de preenchimento.
