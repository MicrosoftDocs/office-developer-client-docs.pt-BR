...
---
# <a name="cell-element-lineto-row-visio-xml"></a>Elemento de célula (linha LineTo) ('Visio XML')

Contém x- ou coordenadas y do vértice final de um segmento de linha reta.
...
|:-----|:-----|:-----|
|[Elemento de linha (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[LineTo_Type](lineto_type-complextypevisio-xml.md) <br/> |Contém x- ou coordenadas y do vértice final de um segmento de linha reta.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |A coordenada x do vértice final de um segmento de linha reta.  <br/> |[Linha LineTo (Seção Geometry)](lineto-row-geometry-section.md) <br/> |
|Y  <br/> |A coordenada y do vértice final de um segmento de linha reta.  <br/> |[Linha LineTo (Seção Geometry)](lineto-row-geometry-section.md) <br/> |
