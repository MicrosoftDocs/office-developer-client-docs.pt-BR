...
---
# <a name="cell-element-lineto-row-visio-xml"></a>Elemento Cell (Linha LineTo) (XML do Visio)

Contém as coordenadas x ou y do vértice final de um segmento de linha reta.
...
|:-----|:-----|:-----|
|[Elemento Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[LineTo_Type](lineto_type-complextypevisio-xml.md) <br/> |Contém as coordenadas x ou y do vértice final de um segmento de linha reta.  <br/> |
...
|S  <br/> |A coordenada y do vértice final de um segmento de linha reta.  <br/> |[Linha LineTo (Seção Geometry)](lineto-row-geometry-section.md) <br/> |
