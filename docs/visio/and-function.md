...
Retorna VERDADEIRO (1) se todas as expressões lógicas fornecidas são VERDADEIRO. Se qualquer uma das expressões lógicas for FALSO ou 0, a função AND retornará FALSO (0).
