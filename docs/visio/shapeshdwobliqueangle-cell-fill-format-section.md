...
---
# <a name="shapeshdwobliqueangle-cell-fill-format-section"></a>Célula ShapeShdwObliqueAngle (Seção Fill Format)

Especifica o ângulo de direção oblíqua da sombra de uma forma.
