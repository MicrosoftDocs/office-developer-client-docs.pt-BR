...
description: Especifica se uma página de desenho pode ser visualizada no navegador usando os Serviços do Visio no Microsoft SharePoint Server 2013.
...
---
# <a name="publishedpage-element-publishsettings_type-complextype-visio-xml"></a>Elemento PublishedPage (PublishSettings_Type complexType) (XML do Visio)

Especifica se uma página de desenho pode ser visualizada no navegador usando os Serviços do Visio no Microsoft SharePoint Server 2013.
