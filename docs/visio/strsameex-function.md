...
| _localeID_ <br/> |Obrigatório  <br/> |**Numeric** <br/> |O código de identificação de local.  <br/> |
| _sinalizador_ <br/> |Obrigatório  <br/> |**Numeric** <br/> | Um bit que especifica o tipo de comparação.  <br/> |
