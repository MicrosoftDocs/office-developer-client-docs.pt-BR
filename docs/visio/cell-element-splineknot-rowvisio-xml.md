...
---
# <a name="cell-element-splineknot-row-visio-xml"></a>Elemento de célula (Linha SplineKnot) ('Visio XML')

Contém ou y coordenadas x do ponto de controle de uma spline ou o nó de uma spline.
...
|:-----|:-----|:-----|
|[Elemento de linha (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[SplineKot_Type](splineknot_type-complextypevisio-xml.md) <br/> |Contém ou y coordenadas x do ponto de controle de uma spline ou o nó de uma spline.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |A coordenada x de um ponto de controle.  <br/> |[Linha SplineKnot (Seção Geometry)](splineknot-row-geometry-section.md) <br/> |
|Y  <br/> |A coordenada y de um ponto de controle.  <br/> |[Linha SplineKnot (Seção Geometry)](splineknot-row-geometry-section.md) <br/> |
|A  <br/> |Um dos nós da spline (exceto o último ou os dois primeiros).  <br/> |[Linha SplineKnot (Seção Geometry)](splineknot-row-geometry-section.md) <br/> |
