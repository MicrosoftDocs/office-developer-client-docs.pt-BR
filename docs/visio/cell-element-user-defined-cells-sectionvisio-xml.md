...
---
# <a name="cell-element-user-defined-cells-section-visio-xml"></a>Elemento de célula (seção de células definidas pelo usuário) ('Visio XML')

Uma propriedade de uma parte especificada pelo usuário de informações que podem ser referenciadas por outras células e outras ferramentas de complemento.
...
|:-----|:-----|:-----|
|[Elemento Row (Seção User-defined Cells)](row-element-user-defined-cells-sectionvisio-xml.md) <br/> |[UserRow_Type](userrow_type-complextypevisio-xml.md) <br/> |Uma propriedade de uma parte especificada pelo usuário de informações que podem ser referenciadas por outras células e outras ferramentas de complemento.  <br/> |
...
|:-----|:-----|:-----|
|Prompt  <br/> |Especifica um comentário ou prompt descritivo para a célula definida pelo usuário.  <br/> |[Célula Prompt (Seção User-Defined Cells)](prompt-cell-user-defined-cells-section.md) <br/> |
|Value  <br/> |Especifica um valor para a célula definida pelo usuário correspondente.  <br/> |[Célula Value (Seção User-Defined Cells)](value-cell-user-defined-cells-section.md) <br/> |
