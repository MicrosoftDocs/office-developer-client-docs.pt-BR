...
Determina o componente  *x*  para o vetor de alinhamento necessário de um ponto de conexão correspondente. A célula DirX / A é também utilizada para orientar o segmento anexado de um conector dinâmico. Essa célula assume um valor de ponto flutuante. 
...
| Índice de célula:  <br/> |**visCnnctDirX** (linhas não estendidas)           **visCnnctA** (linhas estendidas)  <br/> |
