...
Determina o espaço vazio vertical entre todos os conectores na página de desenho.
...
|||
|:-----|:-----|
|Nome da célula:  <br/> |LineToLineY  <br/> |
   
Para obter uma referência para a célula LineToLineY pelo índice a partir de um programa, use a propriedade **CellsSRC** com os seguintes argumentos: 
