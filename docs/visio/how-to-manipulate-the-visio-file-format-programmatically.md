...
### <a name="to-create-a-new-solution-in-visual-studio-2012"></a><span data-ttu-id="6dac7-161">Para criar uma nova solução no Visual Studio 2012</span><span class="sxs-lookup"><span data-stu-id="6dac7-161">To create a new solution in Visual Studio 2012</span></span>
...
### <a name="to-select-a-specific-package-part-in-the-package-by-relationship"></a><span data-ttu-id="6dac7-212">Para selecionar uma parte específica do pacote no pacote por relação</span><span class="sxs-lookup"><span data-stu-id="6dac7-212">To select a specific package part in the package by relationship</span></span>
...
### <a name="to-select-a-specific-package-part-through-its-relationship-to-another-package-part"></a><span data-ttu-id="6dac7-222">Para selecionar uma parte específica do pacote através de sua relação com outra parte do pacote</span><span class="sxs-lookup"><span data-stu-id="6dac7-222">To select a specific package part through its relationship to another package part</span></span>
...
<span data-ttu-id="6dac7-231">Use o procedimento a seguir para abrir um **PackagePart** como um documento XML em um objeto**XDocument**.</span><span class="sxs-lookup"><span data-stu-id="6dac7-231">Use the following procedure to open a **PackagePart** as an XML document in an **XDocument** object.</span></span> 
...
## <a name="select-and-change-xml-data-in-a-package-part"></a><span data-ttu-id="6dac7-235">Selecionar e alterar dados XML em uma parte do pacote</span><span class="sxs-lookup"><span data-stu-id="6dac7-235">Select and change XML data in a package part</span></span>
...
3. <span data-ttu-id="6dac7-315">Substitua o código do exemplo anterior dentro do bloco **using** no método **Main** da classe **Program** (o bloco **Using** do método **Main** no **Module1** no Visual Basic) com o seguinte código.</span><span class="sxs-lookup"><span data-stu-id="6dac7-315">Replace the code from the previous example in the **using** block in the **Main** method of the **Program** class (the **Using** block of the **Main** method in **Module1** in Visual Basic), with the following code.</span></span> 
...
4. <span data-ttu-id="6dac7-316">Escolha a tecla F5 para a solução de depuração.</span><span class="sxs-lookup"><span data-stu-id="6dac7-316">Choose the F5 key to debug the solution.</span></span> <span data-ttu-id="6dac7-317">Quando o programa estiver concluído, escolha qualquer tecla para sair.</span><span class="sxs-lookup"><span data-stu-id="6dac7-317">When the program has completed running, choose any key to exit.</span></span>
    
5. <span data-ttu-id="6dac7-318">Abra o arquivo do Visio Package.vsdx no Visio 2013.</span><span class="sxs-lookup"><span data-stu-id="6dac7-318">Open the Visio Package.vsdx file in Visio 2013.</span></span> 
    
<span data-ttu-id="6dac7-319">Agora a forma Início/Fim deve ser de 2 polegadas da borda inferior do desenho.</span><span class="sxs-lookup"><span data-stu-id="6dac7-319">The Start/End shape should now be 2 inches from the bottom edge of the drawing.</span></span> <span data-ttu-id="6dac7-320">O conector entre a forma Início/Fim e a forma Processo deve ter sido reencaminhado para acomodar a alteração no layout.</span><span class="sxs-lookup"><span data-stu-id="6dac7-320">The connector between the Start/End shape and the Process shape should have rerouted to accommodate the change in layout.</span></span> <span data-ttu-id="6dac7-321">Se a propriedade **RecalcDocument** não tivesse sido adicionada ao arquivo, a posição da forma teria sido alterada, mas o conector não teria sido reencaminhado para o novo local da forma.</span><span class="sxs-lookup"><span data-stu-id="6dac7-321">If the **RecalcDocument** property had not been added to the file, the shape position would have been changed, but the connector would not have rerouted to the new location of the shape.</span></span> 
  
## <a name="add-a-new-package-part-to-a-package"></a><span data-ttu-id="6dac7-322">Adicionar uma nova parte do pacote para um pacote</span><span class="sxs-lookup"><span data-stu-id="6dac7-322">Add a new package part to a package</span></span>
<span data-ttu-id="6dac7-323"><a name="vis15_ManipulateFF_AddNewPart"> </a></span><span class="sxs-lookup"><span data-stu-id="6dac7-323"><a name="vis15_ManipulateFF_AddNewPart"> </a></span></span>

<span data-ttu-id="6dac7-324">Um dos cenários mais comuns para modificar um pacote de arquivos é adicionar uma nova parte do documento ao pacote.</span><span class="sxs-lookup"><span data-stu-id="6dac7-324">One of the most common scenarios for modifying a file package is adding a new document part to the package.</span></span> <span data-ttu-id="6dac7-325">Por exemplo, se você quiser adicionar uma página ao desenho do Visio adicionando conteúdo ao pacote, precisará adicionar uma parte do Conteúdo da Página ao pacote.</span><span class="sxs-lookup"><span data-stu-id="6dac7-325">For example, if you want to add a page to the Visio drawing by adding content to the package, you need to add a Page Contents part to the package.</span></span> 
  
<span data-ttu-id="6dac7-326">O processo para adicionar uma nova parte para o pacote é simples:</span><span class="sxs-lookup"><span data-stu-id="6dac7-326">The process for adding a new part to the package is straightforward:</span></span> 
  
1. <span data-ttu-id="6dac7-327">Criar o documento XML com os dados para o **PackagePart**.</span><span class="sxs-lookup"><span data-stu-id="6dac7-327">You create the XML document with the data for the **PackagePart**.</span></span> <span data-ttu-id="6dac7-328">Você precisa prestar atenção especial aos namespaces XML que controlam o esquema para o tipo específico de documento XML que você cria.</span><span class="sxs-lookup"><span data-stu-id="6dac7-328">You need to pay special attention to the XML namespaces that govern the schema for the specific type of XML document that you create.</span></span>
    
2. <span data-ttu-id="6dac7-329">Crie um novo arquivo para conter o XML e salvar o arquivo em um local no **Package**.</span><span class="sxs-lookup"><span data-stu-id="6dac7-329">You create a new file to contain the XML and save the file to a location in the **Package**.</span></span>
    
3. <span data-ttu-id="6dac7-330">Crie as relações necessárias entre o novo objeto **PackagePart** e o objeto**Package** ou outros objetos **PackagePart**.</span><span class="sxs-lookup"><span data-stu-id="6dac7-330">You create the necessary relationships between the new **PackagePart** and the **Package** or other **PackagePart** objects.</span></span> 
    
4. <span data-ttu-id="6dac7-331">Atualize todas as peças existentes que precisam referenciar a nova peça.</span><span class="sxs-lookup"><span data-stu-id="6dac7-331">You update any existing parts that need to reference the new part.</span></span> <span data-ttu-id="6dac7-332">Por exemplo, se você adicionar uma nova parte do Conteúdo da Página (uma nova página) ao arquivo, também precisará atualizar a parte do Índice de Página (arquivo /visio/pages/pages.xml) para incluir as informações corretas sobre a nova página.</span><span class="sxs-lookup"><span data-stu-id="6dac7-332">For example, if you add a new Page Contents part (a new page) to the file, you also need to update the Page Index part (/visio/pages/pages.xml file) to include the correct information about the new page.</span></span>
    
<span data-ttu-id="6dac7-333">Use o procedimento a seguir para criar uma nova parte de extensibilidade de faixa de opções no arquivo do Visio.</span><span class="sxs-lookup"><span data-stu-id="6dac7-333">Use the following procedure to create a new Ribbon Extensibility part in the Visio file.</span></span> <span data-ttu-id="6dac7-334">A nova Extensibilidade da Faixa de Opções adiciona à faixa de opções uma nova guia com um único grupo que contém um único botão.</span><span class="sxs-lookup"><span data-stu-id="6dac7-334">The new Ribbon Extensibility part adds to the ribbon a new tab with a single group that contains a single button.</span></span>
  
### <a name="to-create-a-new-package-part"></a><span data-ttu-id="6dac7-335">Para criar uma nova parte do pacote</span><span class="sxs-lookup"><span data-stu-id="6dac7-335">To create a new package part</span></span>

1. <span data-ttu-id="6dac7-336">Após o método `CheckForRecalc` na classe **Programa** classe (ou **Module1** no Visual Basic) do procedimento anterior, adicione o seguinte método.</span><span class="sxs-lookup"><span data-stu-id="6dac7-336">After the  `CheckForRecalc` method in the **Program** class (or **Module1** in Visual Basic) from the previous procedure, add the following method.</span></span> 
...
2. <span data-ttu-id="6dac7-337">Após o método`CreateCustomUI` na classe **Programa** (ou **Module1** no Visual Basic),da etapa anterior, adicione o seguinte método.</span><span class="sxs-lookup"><span data-stu-id="6dac7-337">After the  `CreateCustomUI` method in the **Program** class (or **Module1** in Visual Basic) from the previous step, add the following method.</span></span> 
...
3. <span data-ttu-id="6dac7-338">Substitua todos os códigos dentro do bloco **using** no método **Main** da classe **Program** (o bloco **Using** do método **Main** no **Module1** no Visual Basic) com o seguinte código.</span><span class="sxs-lookup"><span data-stu-id="6dac7-338">Replace all the code in the **using** block in the **Main** method of the **Program** class (the **Using** block of the **Main** method in **Module1** in Visual Basic), with the following code.</span></span> 
...
4. <span data-ttu-id="6dac7-339">Escolha a tecla F5 para a solução de depuração.</span><span class="sxs-lookup"><span data-stu-id="6dac7-339">Choose the F5 key to debug the solution.</span></span> <span data-ttu-id="6dac7-340">Quando o programa estiver concluído, escolha qualquer tecla para sair.</span><span class="sxs-lookup"><span data-stu-id="6dac7-340">When the program has completed running, choose any key to exit.</span></span>
    
5. <span data-ttu-id="6dac7-341">Abra o arquivo do Visio Package.vsdx no Visio 2013 e, em seguida, escolha a guia **CUSTOM**.</span><span class="sxs-lookup"><span data-stu-id="6dac7-341">Open the Visio Package.vsdx file in Visio 2013, and then choose the **CUSTOM** tab.</span></span> 
    
<span data-ttu-id="6dac7-342">A faixa de opções personalizada se parece com a Figura 2 quando o arquivo é aberto no Visio 2013.</span><span class="sxs-lookup"><span data-stu-id="6dac7-342">The custom ribbon looks like Figure 2 when the file is opened in Visio 2013.</span></span>
  
 <span data-ttu-id="6dac7-343">**Figura 2. Guia personalizada na faixa de opções do Visio 2013**</span><span class="sxs-lookup"><span data-stu-id="6dac7-343">**Figure 2. Custom tab in the Visio 2013 ribbon**</span></span>
  
![A custom tab in the ribbon](media/vis15_CustomRibbonTab.PNG)
  
<span data-ttu-id="6dac7-345">O XML criado pelo método `CreateCustomUI` é semelhante ao seguinte.</span><span class="sxs-lookup"><span data-stu-id="6dac7-345">The XML created by the  `CreateCustomUI` method looks like the following.</span></span> 
...
## <a name="acknowledgements"></a><span data-ttu-id="6dac7-346">Reconhecimento</span><span class="sxs-lookup"><span data-stu-id="6dac7-346">Acknowledgements</span></span>
<span data-ttu-id="6dac7-347"><a name="vis15_ManipulateFF_Ackn"> </a></span><span class="sxs-lookup"><span data-stu-id="6dac7-347"><a name="vis15_ManipulateFF_Ackn"> </a></span></span>

<span data-ttu-id="6dac7-348">Gostaríamos de reconhecer a contribuição e o auxílio do Visio MVP **Al Edlund** na criação dos exemplos de código contidos neste artigo técnico.</span><span class="sxs-lookup"><span data-stu-id="6dac7-348">We would like to recognize the contribution and input of Visio MVP **Al Edlund** in creating the code examples contained in this technical article.</span></span> <span data-ttu-id="6dac7-349">Al é um especialista reconhecido na manipulação do formato de arquivo do Visio, incluindo o formato de desenho de XML do Visio (.vdx) eo novo formato de arquivo do Visio (.vsdx).</span><span class="sxs-lookup"><span data-stu-id="6dac7-349">Al is a recognized expert in manipulating the Visio file format, including both the Visio XML Drawing format (.vdx) and the new Visio file format (.vsdx).</span></span> <span data-ttu-id="6dac7-350">Al criou projetos que exploram os formatos de arquivo do Visio programaticamente e expõem as estruturas internas.</span><span class="sxs-lookup"><span data-stu-id="6dac7-350">Al has created projects that explore the Visio file formats programmatically and exposes the structures inside.</span></span> 
  
<span data-ttu-id="6dac7-351">Para obter mais informações sobre o trabalho do Al com o formato de arquivo do Visio, consulte os links na seção Recursos Adicionais a seguir.</span><span class="sxs-lookup"><span data-stu-id="6dac7-351">For more information about Al's work with the Visio file format, see the links in the Additional Resources section that follows.</span></span>
  
## <a name="see-also"></a><span data-ttu-id="6dac7-352">Confira também</span><span class="sxs-lookup"><span data-stu-id="6dac7-352">See also</span></span>
<span data-ttu-id="6dac7-353"><a name="vis15_ManipulateFF_Additional"> </a></span><span class="sxs-lookup"><span data-stu-id="6dac7-353"><a name="vis15_ManipulateFF_Additional"> </a></span></span>

- <span data-ttu-id="6dac7-354">Por Al Edlund:</span><span class="sxs-lookup"><span data-stu-id="6dac7-354">By Al Edlund:</span></span>
    
  - <span data-ttu-id="6dac7-355">[pkgVisio - manipulação do projeto Visio 2013 XML](https://pkgvisio.codeplex.com/documentation) no CodePlex.</span><span class="sxs-lookup"><span data-stu-id="6dac7-355">[pkgVisio - Visio 2013 XML manipulation](https://pkgvisio.codeplex.com/documentation) project on CodePlex.</span></span> 
    
  - <span data-ttu-id="6dac7-356">[pkgVisio_pt1 ](https://www.youtube.com/watch?v=7LvDKJuP9oQ&amp;feature=youtu.be) vídeo no YouTube.</span><span class="sxs-lookup"><span data-stu-id="6dac7-356">[pkgVisio_pt1 ](https://www.youtube.com/watch?v=7LvDKJuP9oQ&amp;feature=youtu.be) video on YouTube.</span></span> 
    
  - <span data-ttu-id="6dac7-357">[pkgVisio_pt2 ](https://www.youtube.com/watch?v=ZIWSXhNSkG8&amp;feature=youtu.be) vídeo no YouTube.</span><span class="sxs-lookup"><span data-stu-id="6dac7-357">[pkgVisio_pt2 ](https://www.youtube.com/watch?v=ZIWSXhNSkG8&amp;feature=youtu.be) video on YouTube.</span></span> 
    
- [<span data-ttu-id="6dac7-358">Centro do desenvolvedor do Visio</span><span class="sxs-lookup"><span data-stu-id="6dac7-358">Visio Developer Center</span></span>](https://developer.microsoft.com/visio)
    
- <span data-ttu-id="6dac7-359">[Manipular documentos de formatos Open XML do Office](https://docs.microsoft.com/previous-versions/office/developer/office-2007/aa982683(v=office.12))</span><span class="sxs-lookup"><span data-stu-id="6dac7-359">[Manipulate Office Open XML Formats Documents](https://docs.microsoft.com/previous-versions/office/developer/office-2007/aa982683(v=office.12))</span></span>
    
- <span data-ttu-id="6dac7-360">[Criar um documento com Namespaces (C#) (LINQ XML)](https://docs.microsoft.com/previous-versions/bb387075(v=vs.140))</span><span class="sxs-lookup"><span data-stu-id="6dac7-360">[Create a Document with Namespaces (C#) (LINQ to XML)](https://docs.microsoft.com/previous-versions/bb387075(v=vs.140))</span></span>
    
- <span data-ttu-id="6dac7-361">[Adicionar partes XML personalizadas em documentos sem iniciar o Microsoft Office](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/bb608597(v=vs.90))</span><span class="sxs-lookup"><span data-stu-id="6dac7-361">[Add Custom XML Parts to Documents Without Starting Microsoft Office](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/bb608597(v=vs.90))</span></span>
