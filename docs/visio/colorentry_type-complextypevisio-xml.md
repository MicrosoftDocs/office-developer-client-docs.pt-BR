...
---
# <a name="colorentry_type-complextype-visio-xml"></a>ColorEntry_Type complexType (XML do Visio)
...
|RGB  <br/> |xsd:string  <br/> |obrigatório  <br/> ||Valores do tipo xsd:string.  <br/> |
