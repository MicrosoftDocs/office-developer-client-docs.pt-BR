...
---
# <a name="connection_type-complextype-visio-xml"></a>Connection_Type complexType (XML do Visio)
...
|:-----|:-----|:-----|
|[Linha](row-element-connection-sectionvisio-xml.md) <br/> |[ConnectionRow_Type](connectionrow_type-complextypevisio-xml.md) <br/> ||
