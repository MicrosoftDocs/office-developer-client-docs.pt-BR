...
Controla o tipo de comportamento no *x* -coordenadas da alça de controle irá exibir depois da alça ser movida. 
...
|||
|:-----|:-----|
| Nome da célula:  <br/> | Controles.  *nome* . Controles de XConwhere.  *nome* é o nome da linha controles.  <br/> |
