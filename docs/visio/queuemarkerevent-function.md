...
Faz com que o aplicativo dispare um evento de marcador para seu complemento, o código do Microsoft Visual Basic for Applications (VBA) ou suplemento de COM. 
...
|:-----|:-----|:-----|:-----|
| _event_string_ <br/> |Obrigatório  <br/> |**Cadeia de caracteres** <br/> | A cadeia de caracteres a ser passada para o manipulador de eventos.  <br/> |
...
Para obter mais informações sobre eventos de marcador, consulte o método **QueueMarkerEvent** e os tópicos de evento **MarkerEvent** na referência de automação do Microsoft Visio. 
