...
---
# <a name="headermargin-element-headerfooter_type-complextype-visio-xml"></a>Elemento HeaderMargin (HeaderFooter_Type complexType) (XML do Visio)

Especifica a margem do header de um documento.
...
|:-----|:-----|:-----|:-----|:-----|
|Unidade  <br/> |xsd:string  <br/> |opcional  <br/> |Representa uma unidade de medida. O padrão é DP.  <br/> |Valores do tipo xsd:string.  <br/> |
