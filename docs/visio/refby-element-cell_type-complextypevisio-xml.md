...
---
# <a name="refby-element-cell_type-complextype-visio-xml"></a>Elemento RefBy (Cell_Type complexType) (XML do Visio)
...
|[Elemento Cell (Linha RelLineTo)](cell-element-rellineto-rowvisio-xml.md)[Cell](cell-element-rellineto-rowvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |Contém as coordenadas x ou y do vértice final de um segmento de linha reta relativa à largura e altura da forma.  <br/> |
