---
title: RuleSetFlags_Type complexType (XML do Visio)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "34541607"
---
# <a name="rulesetflags_type-complextype-visio-xml"></a>RuleSetFlags_Type complexType (XML do Visio)
