...
Para obter uma referência para a célula BlockSizeY pelo nome, a partir de outra fórmula ou programa que use a propriedade **CellsU**, utilize: 
  
|||
|:-----|:-----|
| Nome da célula:  <br/> | BlockSizeY  <br/> |
   
Para obter uma referência para a célula BlockSizeY pelo índice a partir de um programa, use a propriedade **CellsSRC** com os seguintes argumentos: 
