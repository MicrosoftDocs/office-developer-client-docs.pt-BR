...
ms.locfileid: "19772964"
---
# <a name="showguides-element-windowtype-complextype-visio-xml"></a>Elemento ShowGuides (Window_Type complexType) ('Visio XML')

Especifica se as guias são exibidos na janela de desenho.
