...
Encontre conteúdo de instruções, exemplos de código, documentação SDK e API, referências VBA, treinamento e artigos técnicos para desenvolver soluções e personalizar o Visio.
...
- [Referência do ShapeSheet do Visio](visio-shapesheet-reference.md)
