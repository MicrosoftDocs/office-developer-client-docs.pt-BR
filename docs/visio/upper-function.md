...
---
# <a name="upper-function"></a>Função UPPER

Retorna uma cadeia de caracteres convertida em maiusculas.
...
|:-----|:-----|:-----|:-----|
| _expressão_ <br/> |Obrigatório  <br/> |**Varia** <br/> | Uma cadeia de caracteres, uma referência de célula ou uma expressão: o resultado é convertido em uma cadeia, que é depois convertida em maiúsculas.  <br/> |
