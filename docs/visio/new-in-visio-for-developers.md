...
Este documento fornece uma visão de alto nível das melhorias e adições para desenvolvedores no Visio 2013. Para os desenvolvedores que estão prontos para começar a trabalhar na plataforma Visio, ele fornece detalhes suficientes para começar a codificar no Visio 2013.
  
## <a name="introduction"></a>Introdução
<a name="vis15_WhatsNew_Intro"> </a>

O Visio 2013 fornece uma plataforma única e avançada para suas soluções de desenho personalizadas. Novos objetos, coleções, propriedades, métodos, enumerações e eventos, junto com novas células e funções ShapeSheet, oferecem a você mais opções para a definição do comportamento dos elementos em suas soluções.
  
Entre os novos recursos de interesse para desenvolvedores no Visio 2013 estão o novo formato de arquivo; atualizações robustas para temas; recurso alterar forma (permitindo que você substitua formas por outra); novos efeitos de forma; Aprimoramentos de comentários; coautoria no SharePoint Server 2013; recorte de imagem personalizável; geometria relativa; suporte para dados de serviços corporativos de conectividade (BCS); atualizações para os serviços do Visio no Microsoft SharePoint Server 2013; e um recurso de página duplicada. Este tópico oferece um breve resumo de cada um desses recursos e menciona alguns dos novos objetos e membros do Visio associados aos recursos e expostos no Visual Basic for Applications (VBA). Para obter informações sobre esses recursos e exemplos de código de acompanhamento, consulte o [Visio developEr Center](https://msdn.microsoft.com/office/aa905478.aspx).
  
> [!NOTE]
> O Visio 2013 inclui muitas novas células, linhas e funções do ShapeSheet para suportar os novos recursos no Visio. Para obter mais informações sobre o que há de novo no ShapeSheet para o Visio 2013, consulte o artigo [What ' s New for Visio ShapeSheet Developers](what-s-new-for-visio-shapesheet-developers.md). 
  
## <a name="new-file-format"></a>Novo formato de arquivo
<a name="vis15_WhatsNew_NewFF"> </a>

O Visio 2013 apresenta um novo formato de arquivo, com base no padrão Open Packaging Conventions (OPC) (ISO 29500, Parte 2) e os elementos XML do formato de arquivo anterior XML do Visio (.vdx). É um formato de arquivo zipado baseado em XML semelhante aos formatos de arquivo usados em outros aplicativos.
  
Como o novo formato de arquivo é compatível com o Visio 2013 e os serviços do Visio no Microsoft SharePoint Server 2013, você pode salvar um desenho do Visio diretamente em uma biblioteca do SharePoint Server, sem precisar publicar o arquivo como um desenho da Web do Visio (. vdw). Mesmo assim, os serviços do Visio ainda podem ler e exibir arquivos de desenho da Web do Visio.
...
O Visio 2013 mantém a capacidade de ler os formatos de arquivo antigos (. vsd,. VSS,. VST,. vdx,. vsx,. vtx,. vdw,. VWI). O Visio 2013 não salva no formato de arquivo XML anterior do Visio (. vdx). Soluções ou ferramentas que consumam os arquivos de formato de arquivo XML do Visio (. vdx) anteriores podem precisar ser refatorado para ler o novo formato de arquivo e seus esquemas.
...
Para obter uma lista detalhada das novas APIs no Visio 2013, consulte a seção [alterações no modelo de objeto do Visio](#vis15_WhatsNew_NewOM) neste artigo. Para obter mais informações sobre as novas células do ShapeSheet no Visio 2013, consulte o artigo [What ' s New for Visio ShapeSheet Developers](what-s-new-for-visio-shapesheet-developers.md).
...
Para obter mais informações sobre as novas células do ShapeSheet no Visio 2013, consulte o artigo [What ' s New for Visio ShapeSheet Developers](what-s-new-for-visio-shapesheet-developers.md).
  
## <a name="commenting"></a>Comentários
<a name="vis15_WhatsNew_Commenting"> </a>

Visio 2013 inclui uma nova estrutura de comentário. Comentários agora podem ser associados uma determinada forma ou página. O Visio 2013 inclui dois novos objetos, [comentários](https://msdn.microsoft.com/library/f028cc03-0ef1-8017-a936-d30d45211864%28Office.15%29.aspx) e [comentários](https://msdn.microsoft.com/library/7cd0ee53-6b8d-a03b-ecd6-f6f6dda0f2d4%28Office.15%29.aspx). As novas APIs para acessar comentários programaticamente incluem as propriedades [Document.Comments](https://msdn.microsoft.com/library/15a322ad-70eb-1487-701d-76e2fde73309%28Office.15%29.aspx), [Page.Comments](https://msdn.microsoft.com/library/9618c86c-96c0-be95-ee20-5d1b99f4d5e8%28Office.15%29.aspx), [Shape.Comments](https://msdn.microsoft.com/library/498eca91-beb9-b764-0262-a935e5205710%28Office.15%29.aspx) e [Page.ShapeComments](https://msdn.microsoft.com/library/b7d86594-ba1f-627b-222f-905da1b1201e%28Office.15%29.aspx). 
  
O serviços do Visio inclui APIs JavaScript para ler os comentários de uma página ou forma em um diagrama.
  
Para obter uma lista detalhada das novas APIs no Visio 2013, consulte a seção [alterações no modelo de objeto do Visio](#vis15_WhatsNew_NewOM) neste artigo. 
...
Nas versões anteriores do Visio, a geometria da forma foi definida por fórmulas que dependem da altura ou largura da forma. Por exemplo, no Visio 2010 os vértices de várias formas internas do Visio foram definidos multiplicando a altura ou a largura da forma por uma constante. Essas formas tinham seções de **geometria** que incluíam linhas [MoveTo](moveto-row-geometry-section.md) ou lineTo (por exemplo) com `Width*1` fórmulas como e `Height*0`. [](lineto-row-geometry-section.md)
...
Para obter mais informações sobre as novas linhas da ShapeSheet no Visio 2013, consulte o artigo [What ' s New for Visio ShapeSheet Developers](what-s-new-for-visio-shapesheet-developers.md).
...
Os diagramas do Visio 2013 agora podem ser conectados a listas externas nos servidores do SharePoint Server 2013. Uma lista externa é uma fonte de conteúdo externa ao SharePoint (por exemplo, uma tabela do SQL Server) que foi conectada a uma lista do SharePoint usando o Microsoft serviços corporativos de conectividade (BCS). Visio Services suporta a capacidade de atualizar os diagramas do Visio como as atualizações de dados.
  
Para obter mais informações sobre o que há de novo nos serviços do Visio, consulte o artigo sobre os [Serviços do Visio no SharePoint 2013](https://msdn.microsoft.com/library/jj164027%28office.15%29.aspx). Para obter mais informações sobre o BCS (serviços corporativos de conectividade), consulte [serviços corporativos de conectividade no SharePoint 2013](https://msdn.microsoft.com/library/jj163782%28office.15%29.aspx).
  
## <a name="improvements-in-visio-services"></a>Aprimoramentos nos serviços do Visio
<a name="vis15_WhatsNew_VisioServices"> </a>

Os serviços do Visio no Microsoft SharePoint Server 2013 incluem vários aprimoramentos. Como mencionado anteriormente, os serviços do Visio dão suporte ao novo formato de arquivo do Visio (. vsdx e. vsdm). Os serviços do Visio expandiram a atualização e o recálculo de dados, incluindo a capacidade de Recalcular fórmulas em todo o diagrama. 
  
Para obter mais informações sobre o que há de novo nos serviços do Visio, consulte o artigo sobre os [Serviços do Visio no SharePoint 2013](https://msdn.microsoft.com/library/jj164027%28office.15%29.aspx).
  
## <a name="duplicate-page"></a>Duplicar página
<a name="vis15_WhatsNew_DuplicatePage"> </a>

Agora você pode copiar uma página e todas as suas formas no mesmo documento no Visio 2013. Da mesma forma, o objeto **Page** tem um novo método, [Duplicate](https://msdn.microsoft.com/library/394be23b-997d-0da1-b3bd-8278564fb4e0%28Office.15%29.aspx), que duplica a página e retorna um novo objeto **Page**. 
  
## <a name="visio-object-model-changes"></a>Alterações no modelo de objeto do Visio
<a name="vis15_WhatsNew_NewOM"> </a>

Novos objetos, propriedades, métodos e eventos foram adicionados ao modelo de objeto do Visio para fornecer suporte à programação para novos recursos do Visio 2013. Além disso, os aprimoramentos do modelo de objeto atendem às solicitações frequentes de desenvolvedores para alterações na plataforma do Visio.
  
### <a name="new-members"></a>Novos membros

Os seguintes membros foram adicionados aos objetos existentes no modelo de objeto do Visio.
...
|[Objeto Replaceshapeevent (Visio)](https://msdn.microsoft.com/library/26c4e7cb-6618-6d2f-a4be-515584f8cd10%28Office.15%29.aspx) <br/> |[Propriedade Replaceshapeevent. ObjectType (Visio)](https://msdn.microsoft.com/library/bcc442f0-aa4e-cd5a-d116-f3fb74459927%28Office.15%29.aspx) <br/> [Propriedade Replaceshapeevent. ReplaceFlags (Visio)](https://msdn.microsoft.com/library/d0d00891-c794-bd0c-d37e-1ab98c92beab%28Office.15%29.aspx) <br/> [Propriedade Replaceshapeevent. rePlacement (Visio)](https://msdn.microsoft.com/library/326a1889-8952-b4ac-c5c0-ac4470257c06%28Office.15%29.aspx) <br/> [Propriedade Replaceshapeevent. Selectionname (Visio)](https://msdn.microsoft.com/library/f81c0b66-b63b-fc7c-1769-d56a17d5cf78%28Office.15%29.aspx) <br/> [Propriedade Replaceshapeevent. stat (Visio)](https://msdn.microsoft.com/library/96f3d382-5dda-7f93-088d-96edc831cd7c%28Office.15%29.aspx) <br/> |Nenhum  <br/> |
...
|:-----|:-----|
|[Enumeração de VisQuickStyleColors (Visio)](https://msdn.microsoft.com/library/c19d91f3-a9a4-e31e-ed7a-eef15553fbf4%28Office.15%29.aspx) <br/> |Especifica nomes designados para cores contidas em um tema.  <br/> |
|[Enumeração de VisQuickStyleMatrixIndices (Visio)](https://msdn.microsoft.com/library/0fb0b448-85ba-4fc4-d933-21d574cefa2a%28Office.15%29.aspx) <br/> |Especifica nomes designados para os temas e variações fornecidos com o Visio 2013.  <br/> |
|[Enumeração de VisReplaceFlags (Visio)](https://msdn.microsoft.com/library/cf270178-f939-7eb4-b8e1-3b4153aff221%28Office.15%29.aspx) <br/> |Especifica comportamentos para uma operação Alterar Forma.  <br/> |
|[Enumeração de VisSVGExportFormat (Visio)](https://msdn.microsoft.com/library/d8ca8c3f-41d9-4e9d-8f6d-f5567361b14e%28Office.15%29.aspx) <br/> |Especifica a inclusão e a exclusão de marcação do Visio durante a exportação de um diagrama para o SVG.  <br/> |
...
- [O que há de novo no Visio (Office.com)](https://office.com/redir/HA102749364.aspx)
