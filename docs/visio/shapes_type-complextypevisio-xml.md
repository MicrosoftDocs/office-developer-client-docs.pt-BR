...
---
# <a name="shapes_type-complextype-visio-xml"></a>Shapes_Type complexType (XML do Visio)
...
|:-----|:-----|:-----|
|[Forma](shape-element-shapes_type-complextypevisio-xml.md) <br/> |[ShapeSheet_Type](shapesheet_type-complextypevisio-xml.md) <br/> ||
