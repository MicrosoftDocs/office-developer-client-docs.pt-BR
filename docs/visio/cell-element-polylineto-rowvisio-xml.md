...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>Elemento de célula (linha PolyLineTo) ('Visio XML')

Contém ou y coordenadas x do último ponto de uma polilinha ou uma fórmula de polilinha.
...
|:-----|:-----|:-----|
|[Elemento de linha (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Contém ou y coordenadas x do último ponto de uma polilinha ou uma fórmula de polilinha.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |A coordenada x de um vértice final de uma polilinha.  <br/> |[Linha PolylineTo (Seção Geometry)](polylineto-row-geometry-section.md) <br/> |
|Y  <br/> |A coordenada y de um vértice final de uma polilinha.  <br/> |[Linha PolylineTo (Seção Geometry)](polylineto-row-geometry-section.md) <br/> |
|A  <br/> |A fórmula da polilinha.  <br/> |[Linha PolylineTo (Seção Geometry)](polylineto-row-geometry-section.md) <br/> |
