...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>Elemento Cell (Linha PolyLineTo) (XML do Visio)

Contém as coordenadas x ou y do último ponto de uma polilinha ou uma fórmula de polilinha.
...
|:-----|:-----|:-----|
|[Elemento Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Contém as coordenadas x ou y do último ponto de uma polilinha ou uma fórmula de polilinha.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |A coordenada x do vértice final de uma linha múltipla.  <br/> |[Linha PolylineTo (Seção Geometry)](polylineto-row-geometry-section.md) <br/> |
|S  <br/> |A coordenada y do vértice final de uma linha múltipla.  <br/> |[Linha PolylineTo (Seção Geometry)](polylineto-row-geometry-section.md) <br/> |
|A  <br/> |A fórmula da linha múltipla.  <br/> |[Linha PolylineTo (Seção Geometry)](polylineto-row-geometry-section.md) <br/> |
