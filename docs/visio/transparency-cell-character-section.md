...
Você também pode definir esse valor usando o controle  deslizante na guia  Fonte da caixa de diálogo Texto (na guia Página Início, clique na **seta** Fonte).  
...
|Índice de célula:  <br/> |**visCharacterColorTrans** <br/> |
