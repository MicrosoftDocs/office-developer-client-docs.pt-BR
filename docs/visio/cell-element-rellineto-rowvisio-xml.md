...
---
# <a name="cell-element-rellineto-row-visio-xml"></a>Elemento Cell (Linha RelLineTo) ('Visio XML')
...
|:-----|:-----|:-----|
|[Elemento Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |Contém as coordenadas x ou y do vértice final de um segmento de linha reta relativa à largura e altura da forma.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |A coordenada x do vértice final de um segmento de linha reta relativa à largura da forma.  <br/> |[Linha RelLineTo (Seção Geometry)](rellineto-row-geometry-section.md) <br/> |
|S  <br/> |A coordenada x do vértice final de um segmento de linha reta relativa à altura da forma.  <br/> |[Linha RelLineTo (Seção Geometry)](rellineto-row-geometry-section.md) <br/> |
