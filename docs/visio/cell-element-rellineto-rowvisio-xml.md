...
---
# <a name="cell-element-rellineto-row-visio-xml"></a>Elemento de célula (RelLineTo linha) ('Visio XML')

Contém x- ou coordenadas y do vértice final de um segmento de linha reta em relação à largura e altura de uma forma.
...
|:-----|:-----|:-----|
|[Elemento de linha (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |Contém x- ou coordenadas y do vértice final de um segmento de linha reta em relação à largura e altura de uma forma.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |A coordenada x do vértice final de um segmento de linha reta em relação à largura da forma.  <br/> |[Linha RelLineTo (Seção Geometry)](rellineto-row-geometry-section.md) <br/> |
|Y  <br/> |A coordenada y do vértice final de um segmento de linha reta em relação à altura da forma.  <br/> |[Linha RelLineTo (Seção Geometry)](rellineto-row-geometry-section.md) <br/> |
