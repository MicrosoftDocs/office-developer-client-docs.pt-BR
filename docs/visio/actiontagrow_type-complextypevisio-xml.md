...
---
# <a name="actiontagrowtype-complextype-visio-xml"></a>ActionTagRow_Type complexType ('Visio XML')
...
|**Extensão de base** <br/> |NamedRow_Type  <br/> |
...
|:-----|:-----|:-----|
|[Célula](cell-element-action-tag-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> ||
