...
---
# <a name="headerfooter_type-complextype-visio-xml"></a>HeaderFooter_Type complexType (XML do Visio)
...
|:-----|:-----|:-----|:-----|:-----|
|HeaderFooterColor  <br/> |xsd:string  <br/> |opcional  <br/> ||Valores do tipo xsd:string.  <br/> |
