...
---
# <a name="master-element-masters_type-complextype-visio-xml"></a>Elemento Master (Masters_Type complexType) (XML do Visio)
...
|[Icon](icon-element-master_type-complextypevisio-xml.md) <br/> |[Icon_Type](icon_type-complextypevisio-xml.md) <br/> |Especifica um ícone binário codificado mime (Multipurpose Internet Mail Extensions) (no formato .ico) para um elemento **Master** ou **MasterShortcut** em um documento.  <br/> |
|[PageSheet](pagesheet-element-master_type-complextypevisio-xml.md) <br/> |[PageSheet_Type](pagesheet_type-complextypevisio-xml.md) <br/> |Contém elementos que definem a folha de página para **um elemento Page** ou **Master.**  <br/> |
...
|:-----|:-----|:-----|:-----|:-----|
|AlignName  <br/> |xsd:unsignedShort  <br/> |opcional  <br/> |Especifica se o texto do mestre na janela de estêncil está alinhado à esquerda, à direita ou ao centro.  <br/> |Valores do tipo xsd:unsignedShort.  <br/> |
|BaseID  <br/> |xsd:string  <br/> |opcional  <br/> |Um GUID (identificador global exclusivo) que identifica o mestre entre documentos.  <br/> |Valores do tipo xsd:string.  <br/> |
...
|MatchByName  <br/> |xsd:boolean  <br/> |opcional  <br/> |Determina como o Microsoft Visio decide se um mestre de documento já está presente quando uma instância de um mestre é descartado na página de desenho.  <br/> |Valores do tipo xsd:boolean.  <br/> |
