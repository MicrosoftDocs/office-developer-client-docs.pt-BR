...
Mostra os atributos de formatação do texto da forma, como fonte, cor, estilo de texto, diferenciação entre maiúsculas e minúsculas, posição em relação à linha de base e tamanho do ponto.
