...
---
# <a name="cell-element-infiniteline-row-visio-xml"></a>Elemento de célula (linha InfiniteLine) ('Visio XML')
...
|:-----|:-----|:-----|
|[Elemento de linha (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[InfiniteLine_Type](infiniteline_type-complextypevisio-xml.md) <br/> |Contém as coordenadas x ou y de dois pontos em uma linha infinita.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |Uma coordenada x de um ponto em uma linha infinita, juntamente com uma coordenada y representada pela célula Y.  <br/> |[Linha InfiniteLine (Seção Geometry)](infiniteline-row-geometry-section.md) <br/> |
|Y  <br/> |Uma coordenada y de um ponto em uma linha infinita, juntamente com uma coordenada xrepresentada pela célula X.  <br/> |[Linha InfiniteLine (Seção Geometry)](infiniteline-row-geometry-section.md) <br/> |
|A  <br/> |Uma coordenada x de um ponto em uma linha infinita, juntamente com uma coordenada y representada pela célula B.  <br/> |[Linha InfiniteLine (Seção Geometry)](infiniteline-row-geometry-section.md) <br/> |
