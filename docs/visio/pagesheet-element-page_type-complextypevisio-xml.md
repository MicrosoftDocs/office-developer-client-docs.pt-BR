...
---
# <a name="pagesheet-element-pagetype-complextype-visio-xml"></a>Elemento PageSheet (Page_Type complexType) (XML do Visio)

Especifica as propriedades da página de desenho associada à página de desenho.
