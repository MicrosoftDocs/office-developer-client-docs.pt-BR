...
|**Valor**|**Descrição**|
|:-----|:-----|
|TRUE  <br/> | O texto da forma mestre substitui o texto na forma antiga. Além disso, a forma mestre substitui os valores das células nas seções a seguir durante uma operação de substituição de forma:  <br/> Seção **Text Fields**  <br/> Seção **Text Block Format**  <br/> |
