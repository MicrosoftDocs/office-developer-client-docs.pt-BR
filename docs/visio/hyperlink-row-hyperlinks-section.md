...
As linhas Hyperlink são denominadas Hyperlink. *nome* e contém as células a seguir. Para obter mais detalhes, consulte os tópicos específicos das células. 
...
|[NewWindow](newwindow-cell-hyperlinks-section.md) <br/> |Especifica quando abrir o hiperlink em uma nova janela. Se TRUE, abre a página vinculada, o documento ou o site em uma nova janela. O padrão é FALSO.  <br/> |
|[Default](default-cell-hyperlinks-section.md) <br/> |O hiperlink padrão para uma forma ou página.  <br/> |
|[Invisible](invisible-cell-hyperlinks-section.md) <br/> |Indica se o hiperlink é exibido no menu de atalho.  <br/> |
   
## <a name="remarks"></a>Comentários

 É possível adicionar tantas linhas Hyperlink.  *nomear* linhas conforme necessário, atribuir nomes significativos às linhas e definir valores de célula. Para adicionar hiperlinks a uma seção Hyperlinks existente, clique com o botão direito do mouse em uma linha e clique em **Inserir Linha** no menu de atalho. 
  
É possível fazer referência a essas células pelo nome da linha, exibido na janela ShapeSheet em texto vermelho. Para atribuir nomes significativos às linhas Hyperlink. *nomear* linhas, clique na linha e digite um nome como *marketing* , por exemplo, para criar o nome da linha Hyperlink. marketing. Você pode fazer referência à célula Description usando Hyperlink.Marketing.Description. 
