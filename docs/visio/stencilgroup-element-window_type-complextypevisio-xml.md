...
---
# <a name="stencilgroup-element-windowtype-complextype-visio-xml"></a>Elemento de estêncil (Window_Type complexType) (XML do Visio)

Especifica o grupo de janelas de estêncil mesclado da qual a janela é membro.
