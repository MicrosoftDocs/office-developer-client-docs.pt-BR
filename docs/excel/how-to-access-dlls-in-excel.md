...
> [!NOTE]
> <span data-ttu-id="3f77a-p112">[!OBSERVA��O] A **Variant** armazena **True** como �1 e **False** como 0. Os n�meros n�o s�o formatados como datas ou valores monet�rios s�o convertidos em Variants do tipo **VT_R8**.</span><span class="sxs-lookup"><span data-stu-id="3f77a-p112">The **Variant** stores **True** as -1 and **False** as 0. Numbers not formatted as dates or currency amounts are converted to Variants of type **VT_R8**.</span></span> 
