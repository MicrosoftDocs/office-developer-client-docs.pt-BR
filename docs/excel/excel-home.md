...
- [Introdução aos suplementos do Excel](https://docs.microsoft.com/en-us/office/dev/add-ins/excel/excel-add-ins-get-started-overview)
...
- [Dicas para otimizar as obstruções de desempenho do Excel](https://msdn.microsoft.com/en-us/library/office/mt709003.aspx)
